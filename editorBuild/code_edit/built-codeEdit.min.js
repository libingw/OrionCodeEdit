...
/^(?:([^:\/?#]+):)?(?:\/\/([^\/?#]*))?([^?#]*)(?:\?([^#]*))?(?:#(.*))?$/,u=/^(?:(.*)@)?(\[[^\]]*\]|[^:]*)(?::(.*))?$/,t=/^([a-zA-Z](?:[a-zA-Z0-9+-.])*)$/,v=/^\d*$/,A=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)$/,F=/^(\[[^\]\/?#\s]*\]|[^:\/?#\s]*)(?::(\d*))?$/,z=/^([^?#\s]*)$/,D=/^([^\s]*)$/,B=/^\S*$/,C=/([^:]*):?(.*)/,q="undefined"!==typeof StopIteration?StopIteration:Error("Stop Iteration"),w={"ftp:":"21","gopher:":"70","http:":"80","https:":"443","ws:":"80","wss:":"443"};Object.defineProperties(b.prototype,
...
return decodeURIComponent(q[2]||"")},set:function(q){l(q);if(this._url){var c=[C.exec(this._userinfo)[1]||""];q&&c.push(encodeURIComponent(q));this._userinfo=c.join(":")}},enumerable:!0},host:{get:function(){var q="";this._url&&this._url.host&&(q+=this._url.host,this._url.port&&(q+=":"+this._url.port));return q},set:function(q){l(q);if(this._url&&(q=F.exec(q)))this._url.host=q[1],this._url.port=k(q[2])},enumerable:!0},hostname:{get:function(){return this._url?this._url.host:""},set:function(q){l(q);
...
a.__plugin__=c;q=q.names||q.type||[];Array.isArray(q)||(q=[q]);a.objectClass=q;return a}function q(q){var c=p(q),a=C(q),a=e.registerService(q.names||q.type,c,a);K[q.serviceId]={registration:a,proxy:c}}function w(){e.persist(c,{created:E,headers:J,services:M,autostart:G,lastModified:I})}var x=this;a=a||{};var E=a.created||(new Date).getTime(),J=a.headers||{},M=a.services||[],G=a.autostart,I=a.lastModified||0,H="installed",P,L,N,S,K={},V=0,$=0,y={},W={},X={},aa={},Y;this._default=!1;this._persist=w;
this._resolve=function(){H="resolved";e.dispatchEvent(new m("resolved",x))};this._getAutostart=function(){return G};this._getCreated=function(){return E};this.getLocation=function(){return c};this.getHeaders=function(){return JSON.parse(JSON.stringify(J))};this.getName=function(){var q=this.getHeaders();return q?q.name||"":null};this.getVersion=function(){var q=this.getHeaders();return q?q.version||"0.0.0":null};this.getLastModified=function(){return I};this.getServiceReferences=function(){var q=
...
m?null:m,pretendDefaultActionId:!0===m,children:{},extraClasses:q},c.sortedContributions=null)},_createEntryForPath:function(c,a){a&&a.split("/").forEach(function(a){1<a.length&&(c[a]||(c[a]={position:0,children:{}},c.sortedContributions=null),c=c[a].children)});return c},registerSelectionService:function(c,a){this._contributionsByScopeId[c]||(this._contributionsByScopeId[c]={});this._contributionsByScopeId[c].localSelectionService=a},registerCommandContribution:function(c,a,e,b,g,n,d,s){this._contributionsByScopeId[c]||
(this._contributionsByScopeId[c]={});c=this._contributionsByScopeId[c];b&&(c=this._createEntryForPath(c,b));c[a]={position:e,handler:s};n&&((e=this._commandList[a])?this._addBinding(e,"key",n,g):this._addPendingBinding(a,"key",n,g));d&&((e=this._commandList[a])?this._addBinding(e,"url",d,g):this._addPendingBinding(a,"url",d,g));c.sortedContributions=null},unregisterCommandContribution:function(c,a,e){if(this._contributionsByScopeId[c]){delete this._commandList[a];delete this._activeBindings[a];delete this._urlBindings[a];
delete this._pendingBindings[a];var b=this._contributionsByScopeId[c];e&&e.split("/").forEach(function(a){1<a.length&&b[a]&&(b=b[a].children)});delete b[a];b.sortedContributions=null}},_addBinding:function(a,e,b,g){if(!a.id)throw Error("No command id: "+a);"key"===e?this._activeBindings[a.id]={command:a,keyBinding:b,bindingOnly:g}:"url"===e&&(this._urlBindings[a.id]={command:a,urlBinding:b,bindingOnly:g})},_addPendingBinding:function(a,e,b,g){this._pendingBindings[a]=this._pendingBindings[a]||[];
...
e.appendChild(m),q=l.createCommandItem(m,p,c,a,null,"button"===d,q)):(a=d+p.id+w,q=l.createCommandItem(e,p,c,a,null,"tool"===d,q)),r.generateNavGrid(f,q),c.domNode=q,w++))}})},_createDropdownMenu:function(a,e,g,n,s,m,h,p,r,C,q){a=f.node(a);if(!a||!f.contains(document.body,a))return null;var w,x,E=a;if(g)x=document.createRange(),x.selectNode(a),x=x.createContextualFragment(k),f.processTextNodes(x,{ButtonText:e}),a.appendChild(x),x=a.lastChild,s=x.lastChild,e=s.previousSibling,e.dropdown=new d.Dropdown({dropdown:s,
populate:n,parentDropdown:a.dropdown}),s.dropdown=e.dropdown;else{"ul"===a.nodeName.toLowerCase()&&(E=document.createElement("li"),a.appendChild(E),x=E);a=null;s&&(a="dropdownButtonWithIcon",m=m||e);m=s?m||e:m;var J=l.createDropdownMenu(E,e,n,a,s,!1,h,p,r||C,q);w=J.dropdownArrow;e=J.menuButton;if(w){r&&(r.domNode=J.menuButton);var M=this;e.onclick=function(q){var a=f.bounds(w);(q.clientX>=a.left||!0===C)&&J.dropdown?J.dropdown.toggle(q):M._invoke(r)};J.dropdown&&(e.onkeydown=function(q){f.KEY.DOWN===
...
this.statusReporter(a):this.editor&&this.editor.reportStatus(a)},save:function(a){function e(a){var q=d._savingDeferred;q.resolve(a);d._savingDeferred=null;d._saving=!1;return q}function b(q){F===t.getInput()&&(d.ETag=q.ETag,f.setInput(F,null,z,!0));t.reportStatus("");m&&E&&E.setProgressResult({Message:l.Saved,Severity:"Normal"});t.postSave&&t.postSave(a);return e(q)}function c(a){t.reportStatus("");a=g(E,a);k.logEvent("status","exception",(t._autoSaveActive?"Auto-save: ":"Save: ")+a.Message);t._errorSaving=
...
a[g].getProperty("top").replace(/([.*+?^=!:${}()|\[\]\/\\])/g,"\\$1");Array.isArray(s)||(s=[s]);for(var v=[],h=0;h<s.length;h++){var F=s[h];"^"!==F[0]&&(F="^"+F);v.push(RegExp(F))}e[g]=v;n[g]=b.getService(a[g]);c[g]=a[g].getProperty("Name")||a[g].getProperty("NameKey")}this._getServiceIndex=function(a){if("/"===a)return-1;if(!a||a.length&&0===a.length)return n[0]?0:-1;for(var c=0;c<e.length;++c)for(var b=0;b<e[c].length;b++)if(e[c][b].test(a))return c;throw Error(p.formatMessage(l.NoFileSrv,a));};
...
linkedModeExited:"Linked Mode exited",syntaxError:"Syntax Error",contentAssist:"Content Assist",noProposals:"No proposals found",computingProposals:"Computing content assist proposals...",lineColumn:"Line ${0} : Column ${1}",multiSelections:"${0} selection regions",vi:"vi",vimove:"(Move)",viyank:"(Yank)",videlete:"(Delete)",vichange:"(Change)",viLeft:"${0} Left",viRight:"${0} Right",viUp:"${0} Up",viDown:"${0} Down",viw:"${0} Next Word",vib:"${0} Beginning of Word",viW:"${0} Next Word (ws stop)",
viB:"${0} Beginning of Word (ws stop)",vie:"${0} End of Word",viE:"${0} End of Word (ws stop)",vi$:"${0} End of the line","vi^_":"${0} First non-blank Char Current Line","vi+":"${0} First Char Next Line","vi-":"${0} First Char Previous Line","vi|":"${0} nth Column in Line",viH:"${0} Top of Page",viM:"${0} Middle of Page",viL:"${0} Bottom of Page","vi/":"${0} Search Forward","vi?":"${0} Search Backward",vin:"${0} Next Search",viN:"${0} Previous Search",vif:"${0} Search Char Fwd",viF:"${0} Search Char Bckwd",
vit:"${0} Search Before Char Fwd",viT:"${0} Search Before Char Bckwd","vi,":"${0} Repeat Reverse Char Search","vi;":"${0} Repeat Char Search",viG:"${0} Go to Line",viycd:"${0} Current Line",via:"Append After Cursor",viA:"Append to End of Line",vii:"Insert Before Cursor",viI:"Insert at Beginning of Line",viO:"Insert Line Above",vio:"Insert Line Below",viR:"Begin Overwriting Text",vis:"Substitute a Character",viS:"Substitute Entire Line",viC:"Change Text Until Line End",vip:"Paste After Char or Line",
viP:"Paste Before Char or Line",viStar:"Search Word Under Cursor",next:"Next",previous:"Previous",replace:"Replace",replaceAll:"Replace All",findWith:"Find With",replaceWith:"Replace With",caseInsensitive:"Aa",regex:"/.*/",wholeWord:"\\b",caseInsensitiveTooltip:"Toggle Case Insensitive",regexTooltip:"Toggle Regex",wholeWordTooltip:"Toggle Whole Word",closeTooltip:"Close",replacingAll:"Replacing all...",replacedMatches:"Replaced ${0} matches",nothingReplaced:"Nothing replaced",notFound:"Not found"});
y("orion/keyBinding",["orion/util"],function(l){function r(h,f,d,b,k,m){this.type=m||"keydown";this.keyCode="string"===typeof h&&"keydown"===this.type?h.toUpperCase().charCodeAt(0):h;this.mod1=void 0!==f&&null!==f?f:!1;this.mod2=void 0!==d&&null!==d?d:!1;this.mod3=void 0!==b&&null!==b?b:!1;this.mod4=void 0!==k&&null!==k?k:!1}function p(h){this.keys=h}r.prototype={getKeys:function(){return[this]},match:function(h,f){if(void 0!==f){if(0!==f)return!1}else if(h instanceof Array){if(1<h.length)return!1;
...
match:function(h,f){var d=this.keys;if(void 0!==f)return f>d.length?!1:d[f].match(h)?f===d.length-1?!0:f+1:!1;h instanceof Array||(h=[h]);if(h.length>d.length)return!1;var b;for(b=0;b<h.length;b++)if(!d[b].match(h[b]))return!1;return b===d.length?!0:b},equals:function(h){if(!h.keys||h.keys.length!==this.keys.length)return!1;for(var f=0;f<h.keys.length;f++)if(!h.keys[f].equals(this.keys[f]))return!1;return!0}};return{KeyBinding:r,KeyStroke:r,KeySequence:p}});y("orion/editor/keyModes",["orion/keyBinding",
"orion/util"],function(l,r){function p(f){f&&(this._view=f,this._keyBindings=this.createKeyBindings(),this._keyBindingIndex=0)}function h(f){p.call(this,f)}p.prototype={createKeyBindings:function(){return[]},getKeyBindings:function(f){for(var d=[],b=this._keyBindings,k=0;k<b.length;k++)b[k].actionID===f&&d.push(b[k].keyBinding);return d},getView:function(){return this._view},isActive:function(){return-1!==this._view.getKeyModes().indexOf(this)},match:function(f){if("keydown"===f.type)switch(f.keyCode){case 16:case 17:case 18:case 91:return}for(var d=
this._keyBindingIndex,b=this._matchingKeyBindings||this._keyBindings,k=[],m=0;m<b.length;m++){var g=b[m],a=g.keyBinding.match(f,d);if(!0===a)return this._keyBindingIndex=0,this._matchingKeyBindings=null,g.actionID;"number"===typeof a&&k.push(g)}if(0===k.length)this._keyBindingIndex=0,this._matchingKeyBindings=null;else return this._keyBindingIndex++,this._matchingKeyBindings=k,"noop"},setKeyBinding:function(f,d){for(var b=this._keyBindings,k=0;k<b.length;k++){var m=b[k];if(m.keyBinding.equals(f)){d?
m.actionID=d:m.predefined?m.actionID="noop":b.splice(k,1);return}}d&&b.push({keyBinding:f,actionID:d})},setView:function(f){this._view=f}};h.prototype=new p;h.prototype.createKeyBindings=function(){var f=l.KeyBinding,d=[];d.push({actionID:"lineUp",keyBinding:new f(38),predefined:!0});d.push({actionID:"lineDown",keyBinding:new f(40),predefined:!0});d.push({actionID:"charPrevious",keyBinding:new f(37),predefined:!0});d.push({actionID:"charNext",keyBinding:new f(39),predefined:!0});r.isMac?(d.push({actionID:"scrollPageUp",
keyBinding:new f(33),predefined:!0}),d.push({actionID:"scrollPageDown",keyBinding:new f(34),predefined:!0}),d.push({actionID:"pageUp",keyBinding:new f(33,null,null,!0),predefined:!0}),d.push({actionID:"pageDown",keyBinding:new f(34,null,null,!0),predefined:!0}),d.push({actionID:"lineStart",keyBinding:new f(37,!0),predefined:!0}),d.push({actionID:"lineEnd",keyBinding:new f(39,!0),predefined:!0}),d.push({actionID:"wordPrevious",keyBinding:new f(37,null,null,!0),predefined:!0}),d.push({actionID:"wordNext",
keyBinding:new f(39,null,null,!0),predefined:!0}),d.push({actionID:"scrollTextStart",keyBinding:new f(36),predefined:!0}),d.push({actionID:"scrollTextEnd",keyBinding:new f(35),predefined:!0}),d.push({actionID:"textStart",keyBinding:new f(38,!0),predefined:!0}),d.push({actionID:"textEnd",keyBinding:new f(40,!0),predefined:!0}),d.push({actionID:"scrollPageUp",keyBinding:new f(38,null,null,null,!0),predefined:!0}),d.push({actionID:"scrollPageDown",keyBinding:new f(40,null,null,null,!0),predefined:!0}),
...
predefined:!0}),d.push({actionID:"lineEnd",keyBinding:new f(35),predefined:!0}),d.push({actionID:"wordPrevious",keyBinding:new f(37,!0),predefined:!0}),d.push({actionID:"wordNext",keyBinding:new f(39,!0),predefined:!0}),d.push({actionID:"textStart",keyBinding:new f(36,!0),predefined:!0}),d.push({actionID:"textEnd",keyBinding:new f(35,!0),predefined:!0}));r.isFirefox&&r.isLinux&&(d.push({actionID:"lineUp",keyBinding:new f(38,!0),predefined:!0}),d.push({actionID:"lineDown",keyBinding:new f(40,!0),predefined:!0}));
r.isWindows&&(d.push({actionID:"scrollLineUp",keyBinding:new f(38,!0),predefined:!0}),d.push({actionID:"scrollLineDown",keyBinding:new f(40,!0),predefined:!0}));d.push({actionID:"selectLineUp",keyBinding:new f(38,null,!0),predefined:!0});d.push({actionID:"selectLineDown",keyBinding:new f(40,null,!0),predefined:!0});d.push({actionID:"selectCharPrevious",keyBinding:new f(37,null,!0),predefined:!0});d.push({actionID:"selectCharNext",keyBinding:new f(39,null,!0),predefined:!0});d.push({actionID:"selectPageUp",
keyBinding:new f(33,null,!0),predefined:!0});d.push({actionID:"selectPageDown",keyBinding:new f(34,null,!0),predefined:!0});r.isMac?(d.push({actionID:"selectLineStart",keyBinding:new f(37,!0,!0),predefined:!0}),d.push({actionID:"selectLineEnd",keyBinding:new f(39,!0,!0),predefined:!0}),d.push({actionID:"selectWordPrevious",keyBinding:new f(37,null,!0,!0),predefined:!0}),d.push({actionID:"selectWordNext",keyBinding:new f(39,null,!0,!0),predefined:!0}),d.push({actionID:"selectTextStart",keyBinding:new f(36,
null,!0),predefined:!0}),d.push({actionID:"selectTextEnd",keyBinding:new f(35,null,!0),predefined:!0}),d.push({actionID:"selectTextStart",keyBinding:new f(38,!0,!0),predefined:!0}),d.push({actionID:"selectTextEnd",keyBinding:new f(40,!0,!0),predefined:!0}),d.push({actionID:"selectLineStart",keyBinding:new f(37,null,!0,null,!0),predefined:!0}),d.push({actionID:"selectLineEnd",keyBinding:new f(39,null,!0,null,!0),predefined:!0}),d.push({actionID:"selectLineStart",keyBinding:new f(38,null,!0,!0),predefined:!0}),
d.push({actionID:"selectLineEnd",keyBinding:new f(40,null,!0,!0),predefined:!0})):(r.isLinux&&(d.push({actionID:"selectWholeLineUp",keyBinding:new f(38,!0,!0),predefined:!0}),d.push({actionID:"selectWholeLineDown",keyBinding:new f(40,!0,!0),predefined:!0})),d.push({actionID:"selectLineStart",keyBinding:new f(36,null,!0),predefined:!0}),d.push({actionID:"selectLineEnd",keyBinding:new f(35,null,!0),predefined:!0}),d.push({actionID:"selectWordPrevious",keyBinding:new f(37,!0,!0),predefined:!0}),d.push({actionID:"selectWordNext",
keyBinding:new f(39,!0,!0),predefined:!0}),d.push({actionID:"selectTextStart",keyBinding:new f(36,!0,!0),predefined:!0}),d.push({actionID:"selectTextEnd",keyBinding:new f(35,!0,!0),predefined:!0}));d.push({actionID:"undo",keyBinding:new l.KeyBinding("z",!0),predefined:!0});r.isMac?d.push({actionID:"redo",keyBinding:new l.KeyBinding("z",!0,!0),predefined:!0}):d.push({actionID:"redo",keyBinding:new l.KeyBinding("y",!0),predefined:!0});d.push({actionID:"deletePrevious",keyBinding:new f(8),predefined:!0});
d.push({actionID:"deletePrevious",keyBinding:new f(8,null,!0),predefined:!0});d.push({actionID:"deleteNext",keyBinding:new f(46),predefined:!0});d.push({actionID:"deleteWordPrevious",keyBinding:new f(8,!0),predefined:!0});d.push({actionID:"deleteWordPrevious",keyBinding:new f(8,!0,!0),predefined:!0});d.push({actionID:"deleteWordNext",keyBinding:new f(46,!0),predefined:!0});d.push({actionID:"tab",keyBinding:new f(9),predefined:!0});d.push({actionID:"shiftTab",keyBinding:new f(9,null,!0),predefined:!0});
d.push({actionID:"enter",keyBinding:new f(13),predefined:!0});d.push({actionID:"enter",keyBinding:new f(13,null,!0),predefined:!0});d.push({actionID:"escape",keyBinding:new f(27),predefined:!0});d.push({actionID:"selectAll",keyBinding:new f("a",!0),predefined:!0});d.push({actionID:"toggleTabMode",keyBinding:new f("m",!0),predefined:!0});r.isMac&&(d.push({actionID:"deleteNext",keyBinding:new f(46,null,!0),predefined:!0}),d.push({actionID:"deleteWordPrevious",keyBinding:new f(8,null,null,!0),predefined:!0}),
d.push({actionID:"deleteWordNext",keyBinding:new f(46,null,null,!0),predefined:!0}));d.push({actionID:"toggleWrapMode",keyBinding:new l.KeyBinding("w",!0,!1,!0)});d.push({actionID:"toggleOverwriteMode",keyBinding:new l.KeyBinding(45)});if(!r.isFirefox){var b=r.isMac&&r.isChrome;d.push({actionID:"noop",keyBinding:new f("u",!b,!1,!1,b),predefined:!0});d.push({actionID:"noop",keyBinding:new f("i",!b,!1,!1,b),predefined:!0});d.push({actionID:"noop",keyBinding:new f("b",!b,!1,!1,b),predefined:!0})}r.isFirefox&&
(d.push({actionID:"copy",keyBinding:new f(45,!0),predefined:!0}),d.push({actionID:"paste",keyBinding:new f(45,null,!0),predefined:!0}),d.push({actionID:"cut",keyBinding:new f(46,null,!0),predefined:!0}));r.isMac&&(d.push({actionID:"lineStart",keyBinding:new f("a",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"lineEnd",keyBinding:new f("e",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"lineUp",keyBinding:new f("p",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"lineDown",keyBinding:new f("n",!1,!1,
!1,!0),predefined:!0}),d.push({actionID:"charPrevious",keyBinding:new f("b",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"charNext",keyBinding:new f("f",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"deletePrevious",keyBinding:new f("h",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"deleteNext",keyBinding:new f("d",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"deleteLineEnd",keyBinding:new f("k",!1,!1,!1,!0),predefined:!0}),r.isFirefox?(d.push({actionID:"scrollPageDown",keyBinding:new f("v",!1,
!1,!1,!0),predefined:!0}),d.push({actionID:"deleteLineStart",keyBinding:new f("u",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"deleteWordPrevious",keyBinding:new f("w",!1,!1,!1,!0),predefined:!0})):(d.push({actionID:"pageDown",keyBinding:new f("v",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"centerLine",keyBinding:new f("l",!1,!1,!1,!0),predefined:!0}),d.push({actionID:"enterNoCursor",keyBinding:new f("o",!1,!1,!1,!0),predefined:!0})));return d};return{KeyMode:p,DefaultKeyMode:h}});y("orion/editor/textTheme",
["require","orion/editor/eventTarget","orion/util"],function(l,r,p){function h(d){d=d||{};this._document=d.document||document}var f={};h.getTheme=function(d){d=d||"default";var b=f[d];b||(b=f[d]=new h);return b};h.prototype={getThemeClass:function(){return this._themeClass},setThemeClass:function(d,b){var f=this,m=f._themeClass;f._themeClass=d;this._load(d,b,function(){f.onThemeChanged({type:"ThemeChanged",oldValue:m,newValue:f.getThemeClass()})})},onThemeChanged:function(d){return this.dispatchEvent(d)},
buildStyleSheet:function(d,b){var f=function(a){return a.replace(this._capitalRegEx,function(a){return"-"+a}.bind(this)).toLowerCase()}.bind(this),m=function(a,b,e,g,c){var d=[];Object.keys(a).forEach(function(t){var v=a[t];"string"===typeof v?d.push("\t"+f(t)+": "+v+";"):m(v,e===t?b:b+(g?" .":".")+t,e,!1,c)});d.length&&(c.push(b+(g?".textview":"")+" {"),c.push.apply(c,d),c.push("}"))},g=[""];m(b.styles,"."+d,b.className,!0,g);return g.join("\n")},_createStyle:function(d,b,f,m){var g=this._document;
d="orion-theme-"+d;var a=g.getElementById(d);if(a){if(m||a.firstChild.data===b)return;a.removeChild(a.firstChild);a.appendChild(g.createTextNode(b))}else m?(a=p.createElement(g,"link"),a.rel="stylesheet",a.type="text/css",a.href=b,a.addEventListener("load",function(){f()})):(a=p.createElement(g,"style"),a.appendChild(g.createTextNode(b))),a.id=d,(g.getElementsByTagName("head")[0]||g.documentElement).appendChild(a);m||f()},_load:function(d,b,f){if(d)if("string"===typeof b)this._createStyle(d,b,f);
else if(b=b.href,".css"!==b.substring(b.length-4)&&(b+=".css"),/^\//.test(b)||/[a-zA-Z0-9]+:\/\//i.test(b)||!l.toUrl)this._createStyle(d,b,f,!0);else{var m=this;l(["text!"+b],function(b){m._createStyle(d,b,f,!1)})}else f()},_capitalRegEx:/[A-Z]/g};r.EventTarget.addMixin(h.prototype);return{TextTheme:h}});y("orion/editor/util",[],function(){return{contains:function(l,r){if(!r)return!1;if(!l.compareDocumentPosition){for(var p=r;p;){if(l===p)return!0;p=p.parentNode}return!1}return l===r||0!==(l.compareDocumentPosition(r)&
...
l.removeEventListener(r,p,!0===h):l.detachEvent("on"+r,p)},Animation:function(){function l(l){this.options=l}l.prototype.play=function(){var l="number"===typeof this.options.duration?this.options.duration:350,p=this.options.easing||this.defaultEasing,h=this.options.onAnimate||function(){},f=this.options.curve[0],d=this.options.curve[1],b=d-f,k=-1,m,g=this;this.interval=this.options.window.setInterval(function(){k=-1===k?(new Date).getTime():k;var a=((new Date).getTime()-k)/l;1>a?(a=p(a),m=f+a*b,h(m)):
...
d,b,k){function m(a,c,e){if(e){c.className="";e=c.attributes;for(var g=e.length;0<g--;)(!b.isIE||9<=b.isIE||9>b.isIE&&e[g].specified)&&c.removeAttribute(e[g].name)}if(a){a.styleClass&&(c.className=a.styleClass);if(e=a.style)for(var d in e)e.hasOwnProperty(d)&&(c.style[d]=e[d]);if(a=a.attributes)for(var n in a)a.hasOwnProperty(n)&&c.setAttribute(n,a[n])}}function g(a){return a instanceof Array?a.slice(0):a}function a(a,c){if(!a)return c;if(!c)return a;for(var b in c)c.hasOwnProperty(b)&&(a.hasOwnProperty(b)||
(a[b]=c[b]));return a}function s(a,c){if(a===c)return!0;if(a&&!c||!a&&c||a&&a.constructor===String||c&&c.constructor===String)return!1;if(a instanceof Array||c instanceof Array){if(!(a instanceof Array&&c instanceof Array)||a.length!==c.length)return!1;for(var b=0;b<a.length;b++)if(!s(a[b],c[b]))return!1;return!0}if(!(a instanceof Object)||!(c instanceof Object))return!1;for(b in a)if(a.hasOwnProperty(b)&&(!c.hasOwnProperty(b)||!s(a[b],c[b])))return!1;for(b in c)if(!a.hasOwnProperty(b))return!1;return!0}
function e(a,c,b){for(var e=0,g=0,d=0,n=a.length;d<n;){-1!==e&&e<=d&&(e=a.indexOf("\r",d));-1!==g&&g<=d&&(g=a.indexOf("\n",d));var t=d,f;if(-1===g&&-1===e){c(a.substring(d));break}-1!==e&&-1!==g?e+1===g?(f=e,d=g+1):(f=e<g?e:g,d=(e<g?e:g)+1):-1!==e?(f=e,d=e+1):(f=g,d=g+1);c(a.substring(t,f));b?b():d===n&&c("")}}function n(a){var c,b,e,g,d=a.ownerDocument.defaultView||a.ownerDocument.parentWindow;d.getComputedStyle?(a=d.getComputedStyle(a,null),c=a.getPropertyValue("padding-left"),b=a.getPropertyValue("padding-top"),
e=a.getPropertyValue("padding-right"),g=a.getPropertyValue("padding-bottom")):a.currentStyle&&(c=a.currentStyle.paddingLeft,b=a.currentStyle.paddingTop,e=a.currentStyle.paddingRight,g=a.currentStyle.paddingBottom);return{left:parseInt(c,10)||0,top:parseInt(b,10)||0,right:parseInt(e,10)||0,bottom:parseInt(g,10)||0}}function c(a){var c,b,e,g,d=a._trim;if(!d){var d=n(a),t=a.ownerDocument.defaultView||a.ownerDocument.parentWindow;t.getComputedStyle?(g=t.getComputedStyle(a,null),c=g.getPropertyValue("border-left-width"),
b=g.getPropertyValue("border-top-width"),e=g.getPropertyValue("border-right-width"),g=g.getPropertyValue("border-bottom-width")):a.currentStyle&&(c=a.currentStyle.borderLeftWidth,b=a.currentStyle.borderTopWidth,e=a.currentStyle.borderRightWidth,g=a.currentStyle.borderBottomWidth);c=parseInt(c,10)||0;b=parseInt(b,10)||0;e=parseInt(e,10)||0;g=parseInt(g,10)||0;d.left+=c;d.top+=b;d.right+=e;d.bottom+=g;a._trim=d}return d}function u(a,c,b,e){function g(c){if(c.animationName===n){var b=c.target;"function"===
typeof b.__DOMReady&&(a.defaultView||a.parentWindow).setTimeout(function(){b.__DOMReady()},0)}}function d(a,q){for(var c=["","-webkit-","-moz-","-ms-","-o-"],b="",e="body ."+a+" {\n",g=0;g<c.length;g++)b+="@"+c[g]+"keyframes "+q+" {\nfrom { opacity: 0.99; }\nto { opacity: 1; }\n}\n",e+=c[g]+"animation-duration: 0.001s;\n"+c[g]+"animation-name: "+q+";\n";return b+(e+"}")}b="_"+b+"DOMReady";c.className=c.className?c.className+" "+b:b;c.__DOMReady=e;e=b+"Style";if(!a.getElementById(e)){var n=b+"Animation";
D(a,"animationstart",g,!1);D(a,"MSAnimationStart",g,!1);D(a,"webkitAnimationStart",g,!1);c=a.createElement("style");c.id=e;e=a.getElementsByTagName("head")[0]||a.documentElement;c.appendChild(a.createTextNode(d(b,n)));e.insertBefore(c,e.firstChild)}}function t(a,c,b){this.start=a;this.end=c;this.caret=b;this._columnX=-1}function v(a){this._view=a;this._divs=[];for(var c=a._clipDiv||a._rootDiv,b=0;3>b;b++){var e=a._createSelectionDiv();c.appendChild(e);this._divs.push(e)}}function A(a){this.left=a.left;
this.top=a.top;this.right=a.right;this.bottom=a.bottom}function F(a,c,b){this.view=a;this.lineIndex=c;this._lineDiv=b}function z(a){this._init(a||{})}var D=d.addEventListener,B=d.removeEventListener,C=d.Animation;t.compare=function(a,c){if(a.length!==c.length)return!1;for(var b=0;b<a.length;b++)if(!a[b].equals(c[b]))return!1;return!0};t.editing=function(a,c){var b;if(c){for(b=a.length-1;0<=b;b--)if(a[b]._editing)return a[b];return a[a.length-1]}for(b=0;b<a.length;b++)if(a[b]._editing)return a[b];
return a[0]};t.convert=function(a){return 1===a.length?a[0]:a};t.contains=function(a,c){return a.some(function(a){return a.contains(c)})};t.merge=function(a){if(1>=a.length)return a;a.sort(function(a,q){return a.start-q.start});for(var c=[],b=a[0],e=1;e<a.length;e++)a[e].start>=b.end||b._editing||a[e]._editing?(c.push(b),b=a[e]):b.end=Math.max(b.end,a[e].end);c.push(b);return c};t.prototype={clone:function(){var a=new t(this.start,this.end,this.caret);a._columnX=this._columnX;a._editing=this._editing;
...
g=b.getLineAtOffset(a.end),d=c._getLineNext();if(d){var n=c._getLinePrevious(),t;e<d.lineIndex?(e=d,t=b.getLineStart(d.lineIndex)):e>n.lineIndex?(e=n,t=b.getLineStart(n.lineIndex)):(e=c._getLineNode(e),t=a.start);g<d.lineIndex?(c=d,b=b.getLineStart(d.lineIndex)):g>n.lineIndex?(c=n,b=b.getLineStart(n.lineIndex)):(c=c._getLineNode(g),b=a.end);this._setDOMSelection(e,t,c,b,a.caret)}},_setDOMSelection:function(a,c,e,g,d){this._setDOMFullSelection(a,c,e,g);if(this.primary){var n=this._view;a=a._line.getNodeOffset(c);
...
n._ignoreSelect=!1,0<t.rangeCount&&t.removeAllRanges(),t.addRange(g),n._ignoreSelect=!0;n._cursorDiv&&(g=c.createRange(),d?(g.setStart(a.node,a.offset),g.setEnd(a.node,a.offset)):(g.setStart(e.node,e.offset),g.setEnd(e.node,e.offset)),d=g.getClientRects()[0],a=n._cursorDiv.parentNode,e=a.getBoundingClientRect(),d&&e&&(n._cursorDiv.style.top=d.top-e.top+a.scrollTop+"px",n._cursorDiv.style.left=d.left-e.left+a.scrollLeft+"px"))}else c.selection&&n._hasFocus&&(d=c.body,g=b.createElement(c,"div"),d.appendChild(g),
d.removeChild(g),g=d.createTextRange(),g.moveToElementText(a.node.parentNode),g.moveStart("character",a.offset),d=d.createTextRange(),d.moveToElementText(e.node.parentNode),d.moveStart("character",e.offset),g.setEndPoint("EndToStart",d),n._ignoreSelect=!1,g.select(),n._ignoreSelect=!0)}},_setDOMFullSelection:function(a,c,e,g){this._divs.forEach(function(a){a.style.width=a.style.height="0px"});var d=this._view;if(d._fullSelection&&!b.isIOS&&!(a===e&&c===g&&this.primary)){var n=d._getViewPadding(),
t=d._clientDiv.getBoundingClientRect(),f=d._viewDiv.getBoundingClientRect(),u=f.left+n.left,m=t.right,n=f.top+n.top,s=t.bottom,f=t=0;d._clipDiv?(f=d._clipDiv.getBoundingClientRect(),t=f.left-d._clipDiv.scrollLeft):(f=d._rootDiv.getBoundingClientRect(),t=f.left);f=f.top;d._ignoreDOMSelection=!0;var v=new F(d,a.lineIndex,a),k=v.getBoundingClientRect(c,!1),h=k.left;a===e&&c===g?(c=v,g=k):(c=new F(d,e.lineIndex,e),g=c.getBoundingClientRect(g,!1));c=g.left;d._ignoreDOMSelection=!1;var v=this._divs[0],
h=Math.min(m,Math.max(u,h)),A=Math.min(s,Math.max(n,k.top)),l=m,d=Math.min(s,Math.max(n,k.bottom));v.style.left=h-t+"px";v.style.top=A-f+"px";v.style.width=Math.max(0,l-h)+"px";v.style.height=Math.max(0,d-A)+"px";a.lineIndex===e.lineIndex?(l=Math.min(c,m),v.style.width=Math.max(this.primary?0:1,l-h)+"px"):(k=Math.min(s,Math.max(n,g.top)),c=Math.min(m,Math.max(u,c)),n=Math.min(s,Math.max(n,g.bottom)),s=this._divs[2],s.style.left=u-t+"px",s.style.top=k-f+"px",s.style.width=Math.max(0,c-u)+"px",s.style.height=
Math.max(0,n-k)+"px",1<Math.abs(a.lineIndex-e.lineIndex)&&(a=this._divs[1],a.style.left=u-t+"px",a.style.top=d-f+"px",a.style.width=Math.max(0,m-u)+"px",a.style.height=Math.max(0,k-d)+"px"))}}};A.prototype={toString:function(){return"{l\x3d"+this.left+", t\x3d"+this.top+", r\x3d"+this.right+", b\x3d"+this.bottom+"}"}};F.prototype={create:function(a,c){if(!this._lineDiv){var b=this._lineDiv=this._createLine(a,c,this.lineIndex);b._line=this;return b}},_createLine:function(a,c,e){var g=this.view,d=g._model,
n=d.getLine(e),t=d.getLineStart(e),f={type:"LineStyle",textView:g,lineIndex:e,lineText:n,lineStart:t};g.onLineStyle(f);var u=a.ownerDocument,d=c||b.createElement(u,"div");if(!c||!s(c.viewStyle,f.style))m(f.style,d,c),c&&(c._trim=null),d.viewStyle=f.style,d.setAttribute("role","presentation");d.lineIndex=e;if(c&&d.viewLineText===n&&s(f.ranges,d.viewRanges))return d;d.viewRanges=f.ranges;d.viewLineText=n;e=[];this._createRanges(f.ranges,n,0,n.length,t,{tabOffset:0,ranges:e});f=" ";!g._fullSelection&&
9>b.isIE&&(f="\ufeff");g={text:f,style:g._metrics.largestFontStyle,ignoreChars:1};0===e.length||!e[e.length-1].style||"div"!==e[e.length-1].style.tagName?e.push(g):e.splice(e.length-1,0,g);var v,k,h,A=f=0;if(b.isFirefox&&2E3<n.length){c&&(d.innerHTML="",c.lineWidth=void 0);c=u.createDocumentFragment();for(n=0;n<e.length;n++)g=e[n],t=g.text,v=g.style,v=this._createSpan(d,t,v,g.ignoreChars),c.appendChild(v);d.appendChild(c)}else{var l,F;if(c){if(k=c.modelChangedEvent)0===k.removedLineCount&&0===k.addedLineCount?
(F=k.start-t,l=k.addedCharCount-k.removedCharCount):F=-1,c.modelChangedEvent=void 0;k=c.firstChild}for(n=0;n<e.length;n++){g=e[n];t=g.text;f+=t.length;v=g.style;if(k)if(h=k.firstChild.data,u=k.viewStyle,h===t&&s(v,u)){A+=h.length;k._rectsCache=void 0;v=k=k.nextSibling;continue}else for(;k;){if(-1!==F){u=f;u>=F&&(u-=l);h=(h=k.firstChild.data)?h.length:0;if(A+h>u)break;A+=h}u=k.nextSibling;d.removeChild(k);k=u}v=this._createSpan(d,t,v,g.ignoreChars);k?d.insertBefore(v,k):d.appendChild(v);c&&(c.lineWidth=
void 0)}if(c)for(l=v?v.nextSibling:null;l;)u=l.nextSibling,c.removeChild(l),l=u}d.parentNode||a.appendChild(d);return d},_createRanges:function(a,c,b,e,g,d){if(!(b>e)){if(a)for(var n=0;n<a.length;n++){var t=a[n];if(!(t.end<g+b)){var f=Math.max(g+b,t.start)-g;if(f>e)break;var u=Math.min(g+e,t.end)-g;if(f<=u){f=Math.max(b,f);u=Math.min(e,u);b<f&&this._createRange(c,b,f,null,d);if(!t.style||!t.style.unmergeable)for(;n+1<a.length&&a[n+1].start-g===u&&s(t.style,a[n+1].style);)t=a[n+1],u=Math.min(g+e,t.end)-
g,n++;this._createRange(c,f,u,t.style,d);b=u}}}b<e&&this._createRange(c,b,e,null,d)}},_createRange:function(a,c,b,e,g){if(!(c>b)){var d=this.view._customTabSize;if(d&&8!==d)for(var n=a.indexOf("\t",c);-1!==n&&n<b;){c<n&&(c={text:a.substring(c,n),style:e},g.ranges.push(c),g.tabOffset+=c.text.length);c=d-g.tabOffset%d;if(0<c){for(var t="\u00a0",f=1;f<c;f++)t+=" ";c={text:t,style:e,ignoreChars:c-1};g.ranges.push(c);g.tabOffset+=c.text.length}c=n+1;if(c===b)return;n=a.indexOf("\t",c)}c<=b&&(c={text:a.substring(c,
b),style:e},g.ranges.push(c),g.tabOffset+=c.text.length)}},_createSpan:function(a,c,e,g){var d=this.view,n="span";e&&e.tagName&&(n=e.tagName.toLowerCase());var t="a"===n;t&&(this.hasLink=!0);t&&!d._linksVisible&&(n="span");t=a.ownerDocument;a=b.createElement(a.ownerDocument,n);a.appendChild(t.createTextNode(e&&e.text?e.text:c));e&&e.html?(a.innerHTML=e.html,a.ignore=!0):e&&e.node&&(a.appendChild(e.node),a.ignore=!0);m(e,a);if("a"===n){var f=d._getWindow();D(a,"click",function(a){return d._handleLinkClick(a?
a:f.event)},!1)}a.viewStyle=e;g&&(a.ignoreChars=g);return a},_ensureCreated:function(){return this._lineDiv?this._lineDiv:this._createdDiv=this.create(this.view._clientDiv,null)},getBoundingClientRect:function(a,c){var e=this._ensureCreated(),g=this.view;if(void 0===a)return this._getLineBoundingClientRect(e,!0);var d=g._model,n=e.ownerDocument,t=this.lineIndex,f=null;if(a<d.getLineEnd(t)){var u=d.getLineStart(t);this.forEach(function(c){var d=c.firstChild,w=this._nodeLength(c);if(u+w>a){var t=a-
...
b=Array(e.length);for(d=0;d<e.length;d++)g=b[d]=new A(e[d]),g.left-=c.left,g.top-=c.top,g.right-=c.left,g.bottom-=c.top;a._rectsCache=b}e=a._rectsCache;b=[e.length];for(d=0;d<e.length;d++)b[d]=new A(e[d]);return b},getClientRects:function(a){if(!this.view._wrapMode)return[this.getBoundingClientRect()];var c=[],e=this._ensureCreated().getBoundingClientRect();this.forEach(function(a){a=this._getClientRects(a,e);for(var b=0;b<a.length;b++){var q=a[b],g,d;if(q.top!==q.bottom){var n=q.top+(q.bottom-q.top)/
2;for(g=0;g<c.length&&!(d=c[g],d.top<=n&&n<d.bottom);g++);g===c.length?c.push(q):(q.left<d.left&&(d.left=q.left),q.top<d.top&&(d.top=q.top),q.right>d.right&&(d.right=q.right),q.bottom>d.bottom&&(d.bottom=q.bottom))}}return!0});return void 0!==a?c[a]:c},_getLineBoundingClientRect:function(a,e){var b=new A(a.getBoundingClientRect());if(!this.view._wrapMode){b.right=b.left;for(var g=a.lastChild;g&&g.ignoreChars===g.firstChild.length;)g=g.previousSibling;g&&(g=g.getBoundingClientRect(),b.right=g.right+
c(a).right)}e&&(g=c(a),b.left+=g.left,b.right-=g.right);return b},getLineCount:function(){return!this.view._wrapMode?1:this.getClientRects().length},getLineIndex:function(a){if(!this.view._wrapMode)return 0;var c=this.getClientRects();a=this.getBoundingClientRect(a);a=a.top+(a.bottom-a.top)/2;for(var b=0;b<c.length;b++)if(c[b].top<=a&&a<c[b].bottom)return b;return c.length-1},getLineStart:function(a){if(!this.view._wrapMode||0===a)return this.view._model.getLineStart(this.lineIndex);var c=this.getClientRects();
return this.getOffset(c[a].left+1,c[a].top+1)},_nodeLength:function(a){if(!a||a.ignore)return 0;var c=a.firstChild.length;a.ignoreChars&&(c-=a.ignoreChars);return c},getModelOffset:function(a,c){if(!a)return 0;var b=0;this.forEach(function(e){var g=e.firstChild;if(g===a)return e.ignoreChars&&(b-=e.ignoreChars),b+=c,!1;e.ignoreChars&&(b-=e.ignoreChars);b+=g.data.length;return!0});return Math.max(0,b)+this.view._model.getLineStart(this.lineIndex)},getNodeOffset:function(a){var c=0,b,e,g=this.view._model,
d=g.getLineStart(this.lineIndex),n=a-d,t=g.getLineEnd(this.lineIndex)-d;this.forEach(function(a){var q=a.firstChild,g=this._nodeLength(a);if(g+c>n||c+g>=t)return b=q,e=n-c,a.ignoreChars&&(0<g&&e===g)&&(e+=a.ignoreChars),!1;c+=g;return!0});return{node:b,offset:e}},getText:function(a){var c="",b=0;this.forEach(function(e){var g;if(e.ignoreChars){g=e.lastChild;for(var d=0,n=[],t=-1;g;){var f=g.data;if(f)for(var u=f.length-1;0<=u;u--){var m=f.substring(u,u+1);d<e.ignoreChars&&(" "===m||"\ufeff"===m)?
d++:n.push("\u00a0"===m?"\t":m)}a===g&&(t=n.length);g=g.previousSibling}n=n.reverse().join("");-1!==t&&(b=c.length+n.length-t);c+=n}else for(g=e.firstChild;g;)a===g&&(b=c.length),c+=g.data,g=g.nextSibling;return!0});return{text:c,offset:b}},getOffset:function(a,c){function e(g,u,x){var k=g.firstChild,h=v._nodeLength(g),A=m.ownerDocument,l=A.defaultView||A.parentWindow,E=11>b.isIE?l.screen.logicalXDPI/l.screen.deviceXDPI:1,F=11>b.isIE?l.screen.logicalYDPI/l.screen.deviceYDPI:1,z,p,r,l=x.left+s.left,
D,B;if(b.isIE||d._isRangeRects){for(var A=d._isRangeRects?A.createRange():A.body.createTextRange(),C=h,S=-1;1<C-S;){var K=Math.floor((C+S)/2);x=S+1;z=K===h-1&&g.ignoreChars?k.length:K+1;D=0===x&&8===b.isIE;d._isRangeRects?(A.setStart(k,x),A.setEnd(k,z)):(D&&(x=1),A.moveToElementText(g),A.move("character",x),A.moveEnd("character",z-x));B=A.getClientRects();for(var H=!1,V=0;V<B.length;V++)if(x=B[V],z=(D?l:x.left)*E-s.left,r=x.right*E-s.left,p=x.top*F-s.top,x=x.bottom*F-s.top,z<=a&&a<r&&(!d._wrapMode||
p<=c&&c<=x)){H=!0;break}H?C=K:S=K}u+=C;x=C;z=C===h-1&&g.ignoreChars?k.length:Math.min(C+1,k.length);d._isRangeRects?(A.setStart(k,x),A.setEnd(k,z)):(A.moveToElementText(g),A.move("character",x),A.moveEnd("character",z-x));B=A.getClientRects();h=!1;0<B.length&&(x=B[0],z=(D?l:x.left)*E-s.left,r=x.right*E-s.left,h=a>z+(r-z)/2);g=u-f;k=n.getLine(t);E=k.charCodeAt(g);55296<=E&&56319>=E&&h?g<k.length&&(E=k.charCodeAt(g+1),56320<=E&&57343>=E&&(u+=1)):56320<=E&&(57343>=E&&!h)&&0<g&&(E=k.charCodeAt(g-1),55296<=
E&&56319>=E&&(u-=1));h&&u++}else{E=[];for(D=0;D<h;D++)E.push("\x3cspan\x3e"),D===h-1?E.push(k.data.substring(D)):E.push(k.data.substring(D,D+1)),E.push("\x3c/span\x3e");g.innerHTML=E.join("");for(E=g.firstChild;E;){x=E.getBoundingClientRect();z=x.left-s.left;r=x.right-s.left;if(z<=a&&a<r){a>z+(r-z)/2&&u++;break}u++;E=E.nextSibling}v._createdDiv||(g.innerHTML="",g.appendChild(k),g=d._getSelections()[0],(u<=g.start&&g.start<u+h||u<=g.end&&g.end<u+h)&&d._updateDOMSelection())}return u}function g(b){if(b.ignore)return null;
b=v._getClientRects(b,s);for(var e=0;e<b.length;e++){var n=b[e];if(n.left<=a&&a<n.right&&(!d._wrapMode||n.top<=c&&c<=n.bottom))return n}return null}var d=this.view,n=d._model,t=this.lineIndex,f=n.getLineStart(t),u=n.getLineEnd(t);if(f===u)return f;var m=this._ensureCreated(),s=this.getBoundingClientRect(),v=this,k,h;if(d._wrapMode){k=this.getClientRects();c<k[0].top&&(c=k[0].top);for(var A=0;A<k.length&&!(h=k[A],h.top<=c&&c<h.bottom);A++);a<h.left&&(a=h.left);a>h.right&&(a=h.right-1)}else 0>a&&(a=
...
F,this._lastHitOffset=l,l=e(F,l,h));return Math.min(u,Math.max(f,l))},getNextOffset:function(a,c){if("line"===c.unit){var e=this.view._model,g=e.getLineAtOffset(a);if(0<c.count)return c.count--,e.getLineEnd(g);c.count++;return e.getLineStart(g)}return"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit?this._getNextOffset_W3C(a,c):b.isIE?this._getNextOffset_IE(a,c):this._getNextOffset_W3C(a,c)},_getNextOffset_W3C:function(a,c){function b(a){return 33<=a&&47>=a||58<=a&&64>=a||91<=a&&94>=a||
96===a||123<=a&&126>=a}function e(a){return 32===a||9===a}var g=this.view._model,d=g.getLineAtOffset(a),n=g.getLine(d),t=g.getLineStart(d),g=g.getLineEnd(d),d=n.length,f=a-t,u,m=0>c.count?-1:1;if("word"===c.unit||"wordend"===c.unit||"wordWS"===c.unit||"wordendWS"===c.unit)for(var s,v,k;0!==c.count;){if(0<c.count){if(f===d)return g;u=n.charCodeAt(f);s=b(u);v=!s&&!e(u);for(f++;f<d;){u=n.charCodeAt(f);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){k=b(u);if("wordend"===c.unit){if(!k&&s)break}else if(k&&
!s)break;u=!k&&!e(u)}else u=!e(u);if("wordend"===c.unit||"wordendWS"===c.unit){if(!u&&v)break}else if(u&&!v)break;v=u;s=k;f++}}else{if(0===f)return t;f--;u=n.charCodeAt(f);s=b(u);for(v=!s&&!e(u);0<f;){u=n.charCodeAt(f-1);if("wordWS"!==c.unit&&"wordendWS"!==c.unit){k=b(u);if("wordend"===c.unit){if(k&&!s)break}else if(!k&&s)break;u=!k&&!e(u)}else u=!e(u);if("wordend"===c.unit||"wordendWS"===c.unit){if(u&&!v)break}else if(!u&&v)break;v=u;s=k;f--}}c.count-=m}else for(;0!==c.count&&0<=f+m&&f+m<=d;)f+=
m,u=n.charCodeAt(f),56320<=u&&57343>=u&&0<f&&(u=n.charCodeAt(f-1),55296<=u&&56319>=u&&(f+=m)),c.count-=m;return t+f},_getNextOffset_IE:function(a,c){var b=this._ensureCreated(),e=this.view._model,g=this.lineIndex,d=0,n;n=e.getLineStart(g);var f=e.getLine(g),t=e.getLineStart(g),u=b.ownerDocument,m=0>c.count?-1:1;if(a===e.getLineEnd(g)){for(b=b.lastChild;b&&b.ignoreChars===b.firstChild.length;)b=b.previousSibling;if(!b)return n;d=u.body.createTextRange();d.moveToElementText(b);n=d.text.length;d.moveEnd(c.unit,
m);d=a+d.text.length-n}else if(a===n&&0>c.count)d=n;else for(b=b.firstChild;b;){e=this._nodeLength(b);if(n+e>a){d=u.body.createTextRange();if(a===n&&0>c.count){for(n=b.previousSibling;n&&(!n.firstChild||!n.firstChild.length);)n=n.previousSibling;d.moveToElementText(n?n:b.previousSibling)}else d.moveToElementText(b),d.collapse(),d.moveEnd("character",a-n);n=d.text.length;d.moveEnd(c.unit,m);d=a+d.text.length-n;break}n=e+n;b=b.nextSibling}n=d-t;d=f.charCodeAt(n);56320<=d&&57343>=d&&0<n&&(d=f.charCodeAt(n-
1),55296<=d&&56319>=d&&(n+=m));c.count-=m;return n+t},updateLinks:function(){var a=this._ensureCreated();if(this.hasLink){var c=this;this.forEach(function(b){var e=b.viewStyle;e&&(e.tagName&&"a"===e.tagName.toLowerCase())&&a.replaceChild(c._createSpan(a,b.firstChild.data,e),b);return!0})}},destroy:function(){var a=this._createdDiv;a&&(a.parentNode.removeChild(a),this._createdDiv=null)}};z.prototype={addKeyMode:function(a,c){var b=this._keyModes;void 0!==c?b.splice(c,0,a):b.push(a);a._modeAdded&&a._modeAdded()},
addRuler:function(a,c){var b=this._rulers;if(void 0!==c){var e,g;for(g=e=0;e<b.length&&g<c;e++)a.getLocation()===b[e].getLocation()&&g++;b.splice(g,0,a);c=g}else b.push(a);this._createRuler(a,c);a.setView(this);this._update()},computeSize:function(){var a=0,c=0,e=this._model,g=this._clientDiv;if(!g)return{width:a,height:c};var d=g.style.width;b.isWebkit&&(g.style.width="0x7fffffffpx");for(var e=e.getLineCount(),n=0;n<e;n++){var f=this._getLine(n),t=f.getBoundingClientRect(),a=Math.max(a,t.right-t.left),
c=c+(t.bottom-t.top);f.destroy()}b.isWebkit&&(g.style.width=d);g=this._getViewPadding();a+=g.right+g.left+this._metrics.scrollWidth;c+=g.bottom+g.top+this._metrics.scrollWidth;return{width:a,height:c}},convert:function(a,c,b){if(!this._clientDiv)return a;var e=this._getScroll(),g=this._getViewPadding(),d=this._viewDiv.getBoundingClientRect();"document"===c&&(void 0!==a.x&&(a.x+=-e.x+d.left+g.left),void 0!==a.y&&(a.y+=-e.y+d.top+g.top));"document"===b&&(void 0!==a.x&&(a.x+=e.x-d.left-g.left),void 0!==
a.y&&(a.y+=e.y-d.top-g.top));return a},destroy:function(){for(var a=0;a<this._rulers.length;a++)this._rulers[a].setView(null);this.rulers=null;this._destroyView();this.onDestroy({type:"Destroy"});this._parent=null;this._model&&this._model.destroy&&this._model.destroy();this._actions=this._keyModes=this._doubleClickSelection=this._selection=this._theme=this._model=null},focus:function(){this._clientDiv&&(this._updateDOMSelection(),this._clientDiv.focus(),this._updateDOMSelection())},hasFocus:function(){return this._hasFocus},
getActionDescription:function(a){if(a=this._actions[a])return a.actionDescription},getActions:function(a){var c=[],b=this._actions,e;for(e in b)b.hasOwnProperty(e)&&(a||!b[e].defaultHandler)&&c.push(e);return c},getBottomIndex:function(a){return!this._clientDiv?0:this._getBottomIndex(a)},getBottomPixel:function(){return!this._clientDiv?0:this._getScroll().y+this._getClientHeight()},getCaretOffset:function(){return this._getSelection().getCaret()},getClientArea:function(){if(!this._clientDiv)return{x:0,
y:0,width:0,height:0};var a=this._getScroll();return{x:a.x,y:a.y,width:this._getClientWidth(),height:this._getClientHeight()}},getHorizontalPixel:function(){return!this._clientDiv?0:this._getScroll().x},getKeyBindings:function(a){for(var c=[],b=this._keyModes,e=0;e<b.length;e++)c=c.concat(b[e].getKeyBindings(a));return c},getKeyModes:function(){return this._keyModes.slice(0)},getLineHeight:function(a){return!this._clientDiv?0:this._getLineHeight(a)},getLineIndex:function(a){return!this._clientDiv?
0:this._getLineIndex(a)},isValidTextPosition:function(a,c){if(!this._clientDiv)return!1;var b=this._getLineIndex(c,!0);if(0>b)return!1;var b=this._getLine(b),e=this.getOffsetAtLocation(a,c),e=b.getBoundingClientRect(e);b.destroy();return a>e.right?!1:!0},getLinePixel:function(a){return!this._clientDiv?0:this._getLinePixel(a)},getLocationAtOffset:function(a){if(!this._clientDiv)return{x:0,y:0};var c=this._model;a=Math.min(Math.max(0,a),c.getCharCount());var c=c.getLineAtOffset(a),b=this._getLine(c);
...
e=0;e<b.length;e++)this.redrawLines(a,c,b[e])},redrawLines:function(a,c,b){if(!(0<this._redrawCount)&&(void 0===a&&(a=0),void 0===c&&(c=this._model.getLineCount()),a!==c)){var e=this._clientDiv;if(e){if(b)for(e=this._getRulerParent(b).firstChild;e&&e._ruler!==b;)e=e.nextSibling;b?e.rulerChanged=!0:this._lineHeight&&this._resetLineHeight(a,c);var g=-1;!b&&-1!==this._imeOffset&&(g=this._model.getLineAtOffset(this._imeOffset));if(!b||"page"===b.getOverview())for(e=e.firstChild;e;){var d=e.lineIndex;
a<=d&&(d<c&&d!==g)&&(e.lineChanged=!0);e=e.nextSibling}!b&&(!this._wrapMode&&a<=this._maxLineIndex&&this._maxLineIndex<c)&&(this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0);this.dispatchEvent({type:"Redraw",startLine:a,endLine:c,ruler:b});this._queueUpdate()}}},redrawRange:function(a,c){if(!(0<this._redrawCount)){var b=this._model;void 0===a&&(a=0);void 0===c&&(c=b.getCharCount());var e=b.getLineAtOffset(a),b=b.getLineAtOffset(Math.max(a,c-1))+1;this.redrawLines(e,
b)}},removeKeyMode:function(a){for(var c=this._keyModes,b=0;b<c.length;b++)if(c[b]===a){c.splice(b,1);break}a._modeRemoved&&a._modeRemoved()},removeRuler:function(a){for(var c=this._rulers,b=0;b<c.length;b++)if(c[b]===a){c.splice(b,1);a.setView(null);this._destroyRuler(a);this._update();break}},resize:function(){this._clientDiv&&this._handleResize(null)},setAction:function(a,c,b){if(a){var e=this._actions,g=e[a];g||(g=e[a]={});g.handler=c;void 0!==b&&(g.actionDescription=b)}},setKeyBinding:function(a,
c){this._keyModes[0].setKeyBinding(a,c)},setCaretOffset:function(a,c,b){var e=this._model.getCharCount();a=Math.max(0,Math.min(a,e));a=new t(a,a,!1);this._setSelection(a,void 0===c||c,!0,b)},setHorizontalPixel:function(a){this._clientDiv&&(a=Math.max(0,a),this._scrollView(a-this._getScroll().x,0))},setRedraw:function(a){a?0===--this._redrawCount&&this.redraw():this._redrawCount++},setModel:function(a){if(a!==this._model){a=a||new r.TextModel;this._model.removeEventListener("preChanging",this._modelListener.onChanging);
this._model.removeEventListener("postChanged",this._modelListener.onChanged);var c=this._model.getLineCount(),b=this._model.getCharCount(),e=a.getLineCount(),g=a.getCharCount(),d={type:"ModelChanging",text:a.getText(),start:0,removedCharCount:b,addedCharCount:g,removedLineCount:c,addedLineCount:e};this.onModelChanging(d);this._model=a;d={type:"ModelChanged",start:0,removedCharCount:b,addedCharCount:g,removedLineCount:c,addedLineCount:e};this.onModelChanged(d);this._model.addEventListener("preChanging",
this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._reset();this._update()}},setOptions:function(a){var c=this._defaultOptions(),b;for(b in a)if(a.hasOwnProperty(b)){var e=a[b];if(!s(this["_"+b],e)){var d=c[b]?c[b].update:null;d?d.call(this,e):this["_"+b]=g(e)}}this.onOptions({type:"Options",options:a})},setSelection:function(a,c,b,e){var g=a>c;if(g){var d=a;a=c;c=d}d=this._model.getCharCount();a=Math.max(0,Math.min(a,d));c=Math.max(0,Math.min(c,
...
c.defaultPrevented)){a.preventDefault();return}if(this._doAction(a))return a.preventDefault?(a.preventDefault(),a.stopPropagation()):(a.cancelBubble=!0,a.returnValue=!1,a.keyCode=0),!1;c=!1;if(b.isMac){if(a.ctrlKey||a.metaKey)c=!0}else if(b.isFirefox){if(a.ctrlKey||a.altKey)c=!0}else a.ctrlKey^a.altKey&&(c=!0);if(!c&&(c=b.isOpera?a.which:void 0!==a.charCode?a.charCode:a.keyCode,31<c))return this._doContent(String.fromCharCode(c)),a.preventDefault&&a.preventDefault(),!1}},_handleDocKeyUp:function(a){(b.isMac?
a.metaKey:a.ctrlKey)||this._setLinksVisible(!1)},_handleKeyUp:function(a){if(!this._ignoreEvent(a)){if(this.isListening("KeyUp")){var c=this._createKeyEvent("KeyUp",a);this.onKeyUp(c);if(c.defaultPrevented){a.preventDefault();return}}this._handleDocKeyUp(a);13===a.keyCode&&this._commitIME()}},_handleLinkClick:function(a){if(!(b.isMac?a.metaKey:a.ctrlKey))return a.preventDefault&&a.preventDefault(),!1},_handleMouse:function(a){var c=this._getWindow(),e=!0,g=c;if(b.isIE||b.isFirefox&&!this._overlayDiv)g=
this._clientDiv;if(this._overlayDiv){this._hasFocus&&(this._ignoreFocus=!0);var d=this;c.setTimeout(function(){d.focus();d._ignoreFocus=!1},0)}var c=a.shiftKey,n=a.altKey,f=b.isMac?a.metaKey:a.ctrlKey;this._blockSelection=this._doubleClickSelection=null;1===this._clickCount?(e=(!b.isOpera||12.16<=b.isOpera)&&this._hasFocus&&this.isListening("DragStart"),(e=this._setSelectionTo(a.clientX,a.clientY,!0,c,f,e))&&this._setGrab(g)):(this._isW3CEvents&&this._setGrab(g),this._setSelectionTo(a.clientX,a.clientY,
!0,c,f,!1),this._doubleClickSelection=t.editing(this._getSelections()));n&&(this._blockSelection=t.editing(this._getSelections()));return e},_handleMouseDown:function(a){if(!this._ignoreEvent(a)){if(this._linksVisible)if("A"!==(a.target||a.srcElement).tagName)this._setLinksVisible(!1);else return;this._commitIME();var c=a.which;c||(4===a.button&&(c=2),2===a.button&&(c=3),1===a.button&&(c=1));var e=2!==c&&a.timeStamp?a.timeStamp:(new Date).getTime(),g=e-this._lastMouseTime,d=Math.abs(this._lastMouseX-
a.clientX),n=Math.abs(this._lastMouseY-a.clientY),f=this._lastMouseButton===c;this._lastMouseX=a.clientX;this._lastMouseY=a.clientY;this._lastMouseTime=e;this._lastMouseButton=c;1===c&&(this._isMouseDown=!0,f&&g<=this._clickTime&&d<=this._clickDist&&n<=this._clickDist?this._clickCount++:this._clickCount=1);if(this.isListening("MouseDown")&&(e=this._createMouseEvent("MouseDown",a),this.onMouseDown(e),e.defaultPrevented)){a.preventDefault();return}if(1===c&&this._handleMouse(a)&&(9<=b.isIE||b.isOpera||
...
d=this._model.getLineCount(),n=this._getViewPadding(),e=this._viewDiv.getBoundingClientRect(),f=this._getLineHeight(),g=g+n.top+n.bottom-2*this._metrics.scrollWidth;f*d<g?n=n.top:(f=g/d,n=this._metrics.scrollWidth);e=Math.floor((a.clientY-e.top-n)/f);0<=e&&e<d||(e=void 0)}if(b)switch(a.type){case "click":if(b.onClick)b.onClick(e,a);break;case "dblclick":if(b.onDblClick)b.onDblClick(e,a);break;case "mousemove":if(b.onMouseMove)b.onMouseMove(e,a);break;case "mouseover":if(b.onMouseOver)b.onMouseOver(e,
a);break;case "mouseout":if(b.onMouseOut){for(d=a.relatedTarget;d&&d!==this._rootDiv;){if(d===c)return;d=d.parentNode}b.onMouseOut(e,a)}}},_handleScroll:function(){this._lastScrollTime=(new Date).getTime();var a=this._getScroll(!1),c=this._hScroll,e=this._vScroll;if(c!==a.x||e!==a.y)this._hScroll=a.x,this._vScroll=a.y,this._commitIME(),this._update(e===a.y),this.onScroll({type:"Scroll",oldValue:{x:c,y:e},newValue:a})},_handleSelectStart:function(a){var c=this._contextMenuOpen;this._contextMenuOpen=
!1;if(c)this._checkSelectionChange=!0;else if(this._ignoreSelect)return a&&a.preventDefault&&a.preventDefault(),!1},_getModelOffset:function(a,c){if(a){var e;e="DIV"===a.tagName?a:a.parentNode.parentNode;return!e._line?0:e._line.getModelOffset(a,c)}},_updateSelectionFromDOM:function(){if(!b.isIOS&&!b.isAndroid&&!this._checkSelectionChange)return!1;var a=this._getWindow().getSelection(),c=this._getModelOffset(a.anchorNode,a.anchorOffset),e=this._getModelOffset(a.focusNode,a.focusOffset),g=this._getSelections()[0];
if(void 0===c||void 0===e||g.start===c&&g.end===e)return!1;if(this._checkSelectionChange){var g=this._getLineNext(),d=this._getLinePrevious();if(a.anchorNode===g.firstChild.firstChild&&0===a.anchorOffset&&a.focusNode===d.firstChild.firstChild&&0===a.focusOffset)return!1;if(a.anchorNode===g.firstChild.firstChild&&0===a.anchorOffset&&a.focusNode===d.lastChild.firstChild||a.anchorNode===this._clientDiv&&a.focusNode===this._clientDiv)c=0,e=this.getModel().getCharCount()}this._setSelection(new t(c,e),
!1,!1);this._checkSelectionChange=!1;return!0},_cancelCheckSelection:function(){this._checkSelectionChange&&(this._checkSelectionChange=!1,this._cancelPollSelectionChange())},_cancelPollSelectionChange:function(){this._selPollTimer&&(this._getWindow().clearTimeout(this._selPollTimer),this._selPollTimer=null)},_pollSelectionChange:function(a){var c=this,e=this._getWindow();this._cancelPollSelectionChange();this._selPollTimer=e.setTimeout(function(){c._selPollTimer=null;c._clientDiv&&!c._updateSelectionFromDOM()&&
a&&c._pollSelectionChange(a)},100)},_handleSelectionChange:function(){-1===this._imeOffset&&(b.isAndroid?this._pollSelectionChange():this._updateSelectionFromDOM())},_handleTextInput:function(a){if(!this._ignoreEvent(a)&&-1===this._imeOffset){var c=this._getWindow().getSelection();if(c.anchorNode!==this._anchorNode||c.focusNode!==this._focusNode||c.anchorOffset!==this._anchorOffset||c.focusOffset!==this._focusOffset){for(var e=c.anchorNode;e&&void 0===e.lineIndex;)e=e.parentNode;if(e){var b=this._model,
g=e.lineIndex,d=b.getLine(g),n=d,f=0,b=b.getLineStart(g);0<c.rangeCount&&(c.getRangeAt(0).deleteContents(),g=e.ownerDocument.createTextNode(a.data),c.getRangeAt(0).insertNode(g),f=this._getDOMText(e,g),n=f.text,f=f.offset,g.parentNode.removeChild(g));e.lineRemoved=!0;for(e=0;d.charCodeAt(e)===n.charCodeAt(e)&&e<f;)e++;c=d.length-1;for(g=n.length-d.length;d.charCodeAt(c)===n.charCodeAt(c+g)&&c+g>=f+a.data.length;)c--;c++;d=n.substring(e,c+g);e+=b;c+=b;n=this._getSelections();f=n[0].start-e;b=n[0].end-
c;n[0].start=e;n[0].end=c;for(e=1;e<n.length;e++)n[e].start-=f,n[e].end-=b;this._modifyContent({text:d,selection:n,_ignoreDOMSelection:!0},!0)}}else this._doContent(a.data);a.preventDefault()}},_handleTouchStart:function(a){if(this.isListening("TouchStart")){var c=this._createTouchEvent("TouchStart",a);this.onTouchStart(c);if(c.defaultPrevented){a.preventDefault();return}if(this._noScroll)return}this._commitIME();c=this._getWindow();this._touchScrollTimer&&(this._vScrollDiv.style.display="none",this._hScrollDiv.style.display=
"none",c.clearInterval(this._touchScrollTimer),this._touchScrollTimer=null);var e=a.touches;if(1===e.length){var e=e[0],g=e.clientX,d=e.clientY;this._touchStartX=g;this._touchStartY=d;if(b.isAndroid&&(d<e.pageY-c.pageYOffset||g<e.pageX-c.pageXOffset))g=e.pageX-c.pageXOffset,d=e.pageY-c.pageYOffset;c=this.convert({x:g,y:d},"page","document");this._lastTouchOffset=this.getOffsetAtLocation(c.x,c.y);this._touchStartTime=a.timeStamp;this._touching=!0}},_handleTouchMove:function(a){if(this.isListening("TouchMove")){var c=
this._createTouchEvent("TouchMove",a);this.onTouchMove(c);if(c.defaultPrevented){a.preventDefault();return}if(this._noScroll)return}c=a.touches;if(1===c.length){c=c[0];this._touchCurrentX=c.clientX;this._touchCurrentY=c.clientY;if(!this._touchScrollTimer&&200>a.timeStamp-this._touchStartTime){this._vScrollDiv.style.display="block";this._wrapMode||(this._hScrollDiv.style.display="block");var e=this,b=this._getWindow();this._touchScrollTimer=b.setInterval(function(){var a=0,c=0;if(e._touching)a=e._touchStartX-
...
(a.count=1);for(;0!==a.count;){var d=e.getLineStart(g);if(0>a.count&&b===d)if(0<g)"character"===a.unit&&a.count++,g--,c.extend(e.getLineEnd(g));else break;else if(0<a.count&&b===e.getLineEnd(g))if(g+1<e.getLineCount())"character"===a.unit&&a.count--,g++,c.extend(e.getLineStart(g));else break;else{var n=!1;a.expandTab&&("character"===a.unit&&0===(b-d)%this._tabSize)&&(d=e.getText(d,b),n=!/[^ ]/.test(d));n?(c.extend(b-this._tabSize),a.count+=0>a.count?1:-1):(d=this._getLine(g),c.extend(d.getNextOffset(b,
...
break;case "reverse":for(var g="",d=0;d<e.length;d++)var n=e[d],f=n.toLowerCase(),n=f!==n?f:n.toUpperCase(),g=g+n;e=g;break;default:e=e.toUpperCase()}b.push(e)});return this._modifyContent({text:b,selection:e,_ignoreDOMSelection:!0},!0)},_doContent:function(a){var c=this,e=this._getSelections();e.forEach(function(a){if(c._overwriteMode&&a.isEmpty()){var e=c._model,b=e.getLineAtOffset(a.end);a.end<e.getLineEnd(b)&&(e=c._getLine(b),a.extend(e.getNextOffset(a.getCaret(),{unit:"character",count:1})),
e.destroy())}});return this._modifyContent({text:a,selection:e,_ignoreDOMSelection:!0},!0)},_doCopy:function(a){var c=this.getSelectionText();return c?this._setClipboardText(c,a):!0},_doCursorNext:function(a){var c=this,e=this._getSelections();e.forEach(function(e){!e.isEmpty()&&!a.select?e.start=e.end:c._doMove(a,e);a.select||e.collapse()});this._setSelection(e,!0);return!0},_doCursorPrevious:function(a){var c=this,e=this._getSelections();e.forEach(function(e){!e.isEmpty()&&!a.select?e.end=e.start:
(a.count||(a.count=1),a.count*=-1,c._doMove(a,e));a.select||e.collapse()});this._setSelection(e,!0);return!0},_doCut:function(a){var c=this.getSelectionText();return c?(this._doContent(""),this._setClipboardText(c,a)):!0},_doDelete:function(a){var c=this,e=this._getSelections();e.forEach(function(e){e.isEmpty()&&c._doMove(a,e)});this._modifyContent({text:"",selection:e},!0);return!0},_doEnd:function(a){var c=this._model,e=this,b=this._getSelections();b.forEach(function(b){if(a.ctrl)b.extend(c.getCharCount());
else{var g=b.getCaret(),d=c.getLineAtOffset(g);if(e._wrapMode){var n=e._getLine(d),g=n.getLineIndex(g),g=g===n.getLineCount()-1?c.getLineEnd(d):n.getLineStart(g+1)-1;n.destroy()}else a.count&&0<a.count&&(d=Math.min(d+a.count-1,c.getLineCount()-1)),g=c.getLineEnd(d);b.extend(g)}a.select||b.collapse()});this._setSelection(b,!0,!0,a.ctrl?function(){}:null);return!0},_doEnter:function(a){if(this._singleMode)return!0;var c=this._model,e=this._getSelections();this._doContent(c.getLineDelimiter());a&&a.noCursor&&
(e.forEach(function(a){a.end=a.start}),this._setSelection(e,!0));return!0},_doEscape:function(){var a=this._getSelections();1<a.length&&this._setSelection(a[0],!0);return!0},_doHome:function(a){var c=this._model,e=this,b=this._getSelections();b.forEach(function(b){if(a.ctrl)b.extend(0);else{var g=b.getCaret(),d=c.getLineAtOffset(g);e._wrapMode?(d=e._getLine(d),g=d.getLineIndex(g),g=d.getLineStart(g),d.destroy()):g=c.getLineStart(d);b.extend(g)}a.select||b.collapse()});this._setSelection(b,!0,!0,a.ctrl?
function(){}:null);return!0},_doLineDown:function(a){var c=this._model,e=this,g=this._getSelections();g.forEach(function(g){var d=g.getCaret(),n=c.getLineAtOffset(d),f=e._getLine(n),t=g._columnX,u=1,m=!1;if(-1===t||a.wholeLine||a.select&&b.isIE)t=a.wholeLine?c.getLineEnd(n+1):d,t=g._columnX=f.getBoundingClientRect(t).left;(d=f.getLineIndex(d))<f.getLineCount()-1?u=f.getClientRects(d+1).top+1:(d=c.getLineCount()-1,m=n===d,a.count&&0<a.count?n=Math.min(n+a.count,d):n++);d=!1;if(m){if(a.select||b.isMac||
b.isLinux)g.extend(c.getCharCount()),d=!0}else f.lineIndex!==n&&(f.destroy(),f=e._getLine(n)),g.extend(f.getOffset(t,u)),d=!0;d&&(a.select||g.collapse());f.destroy()});e._setSelection(g,!0,!0,null,0,!1,!0);return!0},_doLineUp:function(a){var c=this._model,e=this,g=this._getSelections();g.forEach(function(g){var d=g.getCaret(),n=c.getLineAtOffset(d),f=e._getLine(n),t=g._columnX,u=!1,m;if(-1===t||a.wholeLine||a.select&&b.isIE)t=a.wholeLine?c.getLineStart(n-1):d,t=g._columnX=f.getBoundingClientRect(t).left;
0<(d=f.getLineIndex(d))?m=f.getClientRects(d-1).top+1:(u=0===n,u||(a.count&&0<a.count?n=Math.max(n-a.count,0):n--,m=e._getLineHeight(n)-1));d=!1;if(u){if(a.select||b.isMac||b.isLinux)g.extend(0),d=!0}else f.lineIndex!==n&&(f.destroy(),f=e._getLine(n)),g.extend(f.getOffset(t,m)),d=!0;d&&(a.select||g.collapse());f.destroy()});e._setSelection(g,!0,!0,null,0,!1,!0);return!0},_doNoop:function(){return!0},_doPageDown:function(a){var c=this,e=this._model,g=this._getSelections(),d=e.getLineCount(),n=this._getScroll(),
f=this._getClientHeight(),t=this._getLineHeight(),u=Math.floor(f/t),m,s,v;g.forEach(function(g){var k=g.getCaret(),h=e.getLineAtOffset(k);if(c._lineHeight){m=g._columnX;var A=c._getBoundsAtOffset(k);if(-1===m||a.select&&b.isIE)m=g._columnX=A.left;k=c._getLineIndex(A.top+f);s=c._getLine(k);var h=c._getLinePixel(k),k=s.getOffset(m,A.top+f-h),l=s.getBoundingClientRect(k);s.destroy();g.extend(k);a.select||g.collapse();v=void 0!==v?Math.min(v,l.top+h-A.top):l.top+h-A.top}else if(h<d-1){A=Math.min(d-h-
1,u);A=Math.max(1,A);m=g._columnX;if(-1===m||a.select&&b.isIE)s=c._getLine(h),m=g._columnX=s.getBoundingClientRect(k).left,s.destroy();s=c._getLine(h+A);g.extend(s.getOffset(m,0));s.destroy();a.select||g.collapse();g=d*t;k=n.y+A*t;k+f>g&&(k=g-f);v=void 0!==v?Math.min(v,k-n.y):k-n.y}});this._setSelection(g,!0,!0,function(){},v,!1,!0);return!0},_doPageUp:function(a){var c=this,e=this._model,g=this._getSelections(),d=this._getScroll(),n=this._getClientHeight(),f=this._getLineHeight(),t=Math.floor(n/
f),u,m,s;g.forEach(function(g){var v=g.getCaret(),k=e.getLineAtOffset(v);if(c._lineHeight){u=g._columnX;k=c._getBoundsAtOffset(v);if(-1===u||a.select&&b.isIE)u=g._columnX=k.left;v=c._getLineIndex(k.bottom-n);m=c._getLine(v);var h=c._getLinePixel(v),v=m.getOffset(u,k.bottom-n-h),A=m.getBoundingClientRect(v);m.destroy();g.extend(v);a.select||g.collapse();s=void 0!==s?Math.max(s,A.top+h-k.top):A.top+h-k.top}else if(0<k){h=Math.max(1,Math.min(k,t));u=g._columnX;if(-1===u||a.select&&b.isIE)m=c._getLine(k),
u=g._columnX=m.getBoundingClientRect(v).left,m.destroy();m=c._getLine(k-h);g.extend(m.getOffset(u,c._getLineHeight(k-h)-1));m.destroy();a.select||g.collapse();g=Math.max(0,d.y-h*f);s=void 0!==s?Math.max(s,g-d.y):g-d.y}});this._setSelection(g,!0,!0,function(){},s,!1,!0);return!0},_doPaste:function(a){var c=this;return null!==this._getClipboardText(a,function(a){if(a.length){b.isLinux&&2===c._lastMouseButton&&(new Date).getTime()-c._lastMouseTime<=c._clickTime&&c._setSelectionTo(c._lastMouseX,c._lastMouseY,
!0);var e=c._getSelections(),g=c._singleMode?"":c._model.getLineDelimiter();c._doContent(1<e.length&&e.length===a.length?a:a.join(g))}})},_doScroll:function(a){var c=a.type,e=this._model,b=e.getLineCount();a=this._getClientHeight();var g=this._getLineHeight(),b=this._lineHeight?this._scrollHeight:b*g,d=this._getScroll().y,n;switch(c){case "textStart":n=0;break;case "textEnd":n=b-a;break;case "pageDown":n=d+a;break;case "pageUp":n=d-a;break;case "lineDown":n=d+g;break;case "lineUp":n=d-g;break;case "centerLine":c=
this._getSelections()[0],n=e.getLineAtOffset(c.start),e=(e.getLineAtOffset(c.end)-n+1)*g,n=n*g-a/2+e/2}void 0!==n&&(n=Math.min(Math.max(0,n),b-a),this._scrollViewAnimated(0,n-d,function(){}));return!0},_doSelectAll:function(){this._setSelection(new t(0,this._model.getCharCount()),!1);return!0},_doTab:function(){if(this._tabMode&&!this._readonly){var a="\t",c=this._getSelections();if(this._expandTab){var a=[],e=this._model,b=this._tabSize;c.forEach(function(c){c=c.getCaret();var g=e.getLineAtOffset(c),
g=e.getLineStart(g);a.push(Array(b-(c-g)%b+1).join(" "))})}return this._modifyContent({text:a,selection:c,_ignoreDOMSelection:!0},!0)}},_doShiftTab:function(){if(this._tabMode&&!this._readonly)return!0},_doOverwriteMode:function(){if(!this._readonly)return this.setOptions({overwriteMode:!this.getOptions("overwriteMode")}),!0},_doTabMode:function(){this._tabMode=!this._tabMode;return!0},_doWrapMode:function(){this.setOptions({wrapMode:!this.getOptions("wrapMode")});return!0},_autoScroll:function(){var a=
this._model,c=this._getSelections(),e=t.editing(c,"down"===this._autoScrollDir),g=this.convert({x:this._autoScrollX,y:this._autoScrollY},"page","document"),d=e.getCaret(),n=a.getLineCount(),f=a.getLineAtOffset(d),u;if("up"===this._autoScrollDir||"down"===this._autoScrollDir)d=this._autoScrollY/this._getLineHeight(),d=0>d?Math.floor(d):Math.ceil(d),u=Math.max(0,Math.min(n-1,f+d));else if("left"===this._autoScrollDir||"right"===this._autoScrollDir)u=this._getLineIndex(g.y),f=this._getLine(f),g.x+=f.getBoundingClientRect(d,
...
!this._calculateLHTimer){var c=this._model.getLineCount(),e=0;if(a){a=0;for(var b=(new Date).getTime(),g=0;e<c&&!(this._lineHeight[e]||(a++,g||(g=e),this._lineHeight[e]=this._calculateLineHeight(e)),e++,100<(new Date).getTime()-b););this.redrawRulers(0,c);this._queueUpdate()}a=this._getWindow();if(e!==c){var d=this;this._calculateLHTimer=a.setTimeout(function(){d._calculateLHTimer=null;d._calculateLineHeightTimer(!0)},0)}else this._calculateLHTimer&&(a.clearTimeout(this._calculateLHTimer),this._calculateLHTimer=
void 0)}},_calculateLineHeight:function(a){a=this._getLine(a);var c=a.getBoundingClientRect();a.destroy();return Math.max(1,c.bottom-c.top)},_calculateMetrics:function(){var a=this._clientDiv,e=a.ownerDocument,g=b.createElement(e,"div");g.style.lineHeight="normal";var d={type:"LineStyle",textView:this,0:0,lineText:this._model.getLine(0),lineStart:0};this.onLineStyle(d);m(d.style,g);g.style.position="fixed";g.style.left="-1000px";var f=b.createElement(e,"span");f.appendChild(e.createTextNode(" "));
g.appendChild(f);var t=b.createElement(e,"span");t.style.fontStyle="italic";t.appendChild(e.createTextNode(" "));g.appendChild(t);var u=b.createElement(e,"span");u.style.fontWeight="bold";u.appendChild(e.createTextNode(" "));g.appendChild(u);d=b.createElement(e,"span");d.style.fontWeight="bold";d.style.fontStyle="italic";d.appendChild(e.createTextNode(" "));g.appendChild(d);a.appendChild(g);var s=g.getBoundingClientRect(),f=f.getBoundingClientRect(),t=t.getBoundingClientRect(),u=u.getBoundingClientRect(),
d=d.getBoundingClientRect(),f=f.bottom-f.top,t=t.bottom-t.top,u=u.bottom-u.top,v=d.bottom-d.top,k=0,d=0>=s.bottom-s.top,s=Math.max(1,s.bottom-s.top);t>f&&(k=1);u>t&&(k=2);v>u&&(k=3);var h;0!==k&&(h={style:{}},0!==(k&1)&&(h.style.fontStyle="italic"),0!==(k&2)&&(h.style.fontWeight="bold"));f=c(g);a.removeChild(g);k=n(this._viewDiv);g=b.createElement(e,"div");g.style.position="fixed";g.style.left="-1000px";g.style.paddingLeft=k.left+"px";g.style.paddingTop=k.top+"px";g.style.paddingRight=k.right+"px";
...
else{for(var d=e.firstChild;d&&0<c--;)d=d.nextSibling;e.insertBefore(g,d)}}}},_createSelectionDiv:function(){var a=b.createElement(this._parent.ownerDocument,"div");a.className="textviewSelection";a.style.position="absolute";a.style.borderWidth="0px";a.style.margin="0px";a.style.padding="0px";a.style.outline="none";a.style.width="0px";a.style.height="0px";a.style.zIndex="0";return a},_createView:function(){function a(){n._rootDiv&&(n.update(!0),n._metrics.invalid&&n._getWindow().setTimeout(function(){a()},
100))}if(!this._clientDiv){for(var c=this._parent;c.hasChildNodes();)c.removeChild(c.lastChild);var e=c.ownerDocument,g=b.createElement(e,"div");this._rootDiv=g;g.tabIndex=-1;g.style.position="relative";g.style.overflow="hidden";g.style.width="100%";g.style.height="100%";g.style.overflow="hidden";g.style.WebkitTextSizeAdjust="100%";g.setAttribute("role","application");c.appendChild(g);this._leftDiv=this._createRulerParent(e,"textviewLeftRuler");c=b.createElement(e,"div");c.className="textviewScroll";
this._viewDiv=c;c.tabIndex=-1;c.style.position="absolute";c.style.top="0px";c.style.bottom="0px";c.style.borderWidth="0px";c.style.margin="0px";c.style.outline="none";c.style.background="transparent";g.appendChild(c);var d=this._createRulerParent(e,"textviewRightRuler");this._rightDiv=d;d.style.right="0px";this._innerRightDiv=d=this._createRulerParent(e,"textviewInnerRightRuler");d.style.zIndex="1";this._scrollDiv=d=b.createElement(e,"div");d.style.margin="0px";d.style.borderWidth="0px";d.style.padding=
"0px";c.appendChild(d);(this._marginDiv=this._createRulerParent(e,"textviewMarginRuler")).style.zIndex="4";!b.isIE&&!b.isIOS&&(this._clipDiv=c=b.createElement(e,"div"),c.style.position="absolute",c.style.overflow="hidden",c.style.margin="0px",c.style.borderWidth="0px",c.style.padding="0px",c.style.background="transparent",g.appendChild(c),this._clipScrollDiv=d=b.createElement(e,"div"),d.style.position="absolute",d.style.height="1px",d.style.top="-1000px",d.style.background="transparent",c.appendChild(d));
c=b.createElement(e,"div");c.className="textviewContent";this._clientDiv=c;c.tabIndex=0;c.style.position="absolute";c.style.borderWidth="0px";c.style.margin="0px";c.style.padding="0px";c.style.outline="none";c.style.zIndex="1";c.style.WebkitUserSelect="text";c.setAttribute("spellcheck","false");if(b.isIOS||b.isAndroid)c.style.WebkitTapHighlightColor="transparent";(this._clipDiv||g).appendChild(c);this._setFullSelection(this._fullSelection,!0);if(b.isIOS||b.isAndroid)this._vScrollDiv=d=b.createElement(e,
"div"),d.style.position="absolute",d.style.borderWidth="1px",d.style.borderColor="white",d.style.borderStyle="solid",d.style.borderRadius="4px",d.style.backgroundColor="black",d.style.opacity="0.5",d.style.margin="0px",d.style.padding="0px",d.style.outline="none",d.style.zIndex="3",d.style.width="8px",d.style.display="none",g.appendChild(d),this._hScrollDiv=d=b.createElement(e,"div"),d.style.position="absolute",d.style.borderWidth="1px",d.style.borderColor="white",d.style.borderStyle="solid",d.style.borderRadius=
"4px",d.style.backgroundColor="black",d.style.opacity="0.5",d.style.margin="0px",d.style.padding="0px",d.style.outline="none",d.style.zIndex="3",d.style.height="8px",d.style.display="none",g.appendChild(d);b.isFirefox&&!c.setCapture&&(this._overlayDiv=d=b.createElement(e,"div"),d.style.position=c.style.position,d.style.borderWidth=c.style.borderWidth,d.style.margin=c.style.margin,d.style.padding=c.style.padding,d.style.cursor="text",d.style.zIndex="2",(this._clipDiv||g).appendChild(d));c.contentEditable=
"true";c.setAttribute("role","textbox");c.setAttribute("aria-multiline","true");this._setWrapMode(this._wrapMode,!0);this._setReadOnly(this._readonly);this._setThemeClass(this._themeClass,!0);this._setTabSize(this._tabSize,!0);this._setMarginOffset(this._marginOffset,!0);this._hookEvents();c=this._rulers;for(d=0;d<c.length;d++)this._createRuler(c[d]);this._update();var n=this;u(e,g,"textview",a)}},_defaultOptions:function(){return{parent:{value:void 0,update:null},model:{value:void 0,update:this.setModel},
...
1);n.destroy();g===f&&g===b.getLineEnd(c)||(n=g<f,g=new t(n?g:f,n?f:g,n),g._editing=!0,a.push(g))}return a},_getBoundsAtOffset:function(a){var c=this._getLine(this._model.getLineAtOffset(a));a=c.getBoundingClientRect(a);var e=this._getLinePixel(c.lineIndex);a.top+=e;a.bottom+=e;c.destroy();return a},_getClientHeight:function(){var a=this._getViewPadding();return Math.max(0,this._viewDiv.clientHeight-a.top-a.bottom)},_getInnerRightWidth:function(){var a=this._innerRightDiv.rulerWidth;void 0===a&&(a=
this._innerRightDiv.getBoundingClientRect(),this._innerRightDiv.rulerWidth=a=a.right-a.left);return a},_getClientWidth:function(){var a=this._getViewPadding(),c=this._getInnerRightWidth();return Math.max(0,this._viewDiv.clientWidth-a.left-a.right-c)},_getClipboardText:function(a,c){function g(a){var b=[];e(a,function(a){b.push(a)},null);c&&c(b);return b}var d=this._getWindow(),n=d.clipboardData;!n&&a&&(n=a.clipboardData);if(n)return g(n.getData(b.isIE?"Text":"text/plain"));if(b.isFirefox){this._ignoreFocus=
!0;var f=this._clipboardDiv,n=this._rootDiv.ownerDocument;f||(this._clipboardDiv=f=b.createElement(n,"div"),f.style.position="fixed",f.style.whiteSpace="pre",f.style.left="-1000px",this._rootDiv.appendChild(f));f.innerHTML="\x3cpre contenteditable\x3d''\x3e\x3c/pre\x3e";f.firstChild.focus();var t=this,u=function(){var a=t._getTextFromElement(f);f.innerHTML="";return g(a)},m=!1;this._ignorePaste=!0;if(!b.isLinux||2!==this._lastMouseButton)try{m=n.execCommand("paste",!1,null)}catch(s){m=1<f.childNodes.length||
f.firstChild&&0<f.firstChild.childNodes.length}this._ignorePaste=!1;if(!m){if(a)return d.setTimeout(function(){t.focus();u();t._ignoreFocus=!1},0),null;this.focus();this._ignoreFocus=!1;return""}this.focus();this._ignoreFocus=!1;return u()}return""},_getDOMText:function(a,c){return a._line.getText(c)},_getTextFromElement:function(a){var c=a.ownerDocument,e=c.defaultView;if(!e.getSelection)return a.innerText||a.textContent;c=c.createRange();c.selectNode(a);a=e.getSelection();var e=[],b;for(b=0;b<a.rangeCount;b++)e.push(a.getRangeAt(b));
this._ignoreSelect=!0;a.removeAllRanges();a.addRange(c);c=a.toString();a.removeAllRanges();for(b=0;b<e.length;b++)a.addRange(e[b]);this._ignoreSelect=!1;return c},_getViewPadding:function(){return this._metrics.viewPadding},_getLine:function(a){var c=this._getLineNode(a);return c&&!c.lineChanged&&!c.lineRemoved?c._line:new F(this,a)},_getLineHeight:function(a,c){if(void 0!==a&&this._lineHeight){var e=this._lineHeight[a];if(e)return e;if(c||void 0===c)return this._lineHeight[a]=this._calculateLineHeight(a)}return this._metrics.lineHeight},
...
e=-this._topIndexY+this._getScroll().y;if(a>c)for(;c<a;c++)e+=this._getLineHeight(c);else for(c-=1;c>=a;c--)e-=this._getLineHeight(c);return e}return this._getLineHeight()*a},_getLineIndex:function(a,c){var e,b=0,g=this._model.getLineCount();if(this._lineHeight){var b=this._getTopIndex(),d=-this._topIndexY+this._getScroll().y;if(a!==d)if(a<d)for(;a<d&&0<b;)a+=this._getLineHeight(--b);else for(e=this._getLineHeight(b);a-e>=d&&b<g-1;)a-=e,e=this._getLineHeight(++b)}else e=this._getLineHeight(),b=Math.floor(a/
e);return c&&(0===g||0>b||b>g-1)?-1:Math.max(0,Math.min(g-1,b))},_getRulerParent:function(a){switch(a.getLocation()){case "left":return this._leftDiv;case "right":return this._rightDiv;case "innerRight":return this._innerRightDiv;case "margin":return this._marginDiv}return null},_getScroll:function(a){(void 0===a||a)&&this._cancelAnimation();a=this._viewDiv;return{x:a.scrollLeft,y:a.scrollTop}},_getSelection:function(){return(Array.isArray(this._selection)?this._selection[0]:this._selection).clone()},
_getSelections:function(){return(Array.isArray(this._selection)?this._selection:[this._selection]).map(function(a){return a.clone()})},_getTopIndex:function(a){var c=this._topChild;if(a&&this._getClientHeight()>this._getLineHeight()){a=c.getBoundingClientRect();var e=this._getViewPadding(),b=this._viewDiv.getBoundingClientRect();a.top<b.top+e.top&&(c=this._getLineNext(c)||c)}return c.lineIndex},_hookEvents:function(){var a=this;this._modelListener={onChanging:function(c){a._onModelChanging(c)},onChanged:function(c){a._onModelChanged(c)}};
this._model.addEventListener("preChanging",this._modelListener.onChanging);this._model.addEventListener("postChanged",this._modelListener.onChanged);this._themeListener={onChanged:function(){a._setThemeClass(a._themeClass)}};this._theme.addEventListener("ThemeChanged",this._themeListener.onChanged);var c=this._handlers=[],e=this._clientDiv,g=this._viewDiv,d=this._rootDiv,n=this._overlayDiv||e,f=e.ownerDocument,t=this._getWindow(),u=b.isIE?f:t;c.push({target:t,type:"resize",handler:function(c){return a._handleResize(c?
c:t.event)}});c.push({target:e,type:"blur",handler:function(c){return a._handleBlur(c?c:t.event)}});c.push({target:e,type:"focus",handler:function(c){return a._handleFocus(c?c:t.event)}});c.push({target:g,type:"focus",handler:function(){e.focus()}});c.push({target:g,type:"scroll",handler:function(c){return a._handleScroll(c?c:t.event)}});c.push({target:e,type:"textInput",handler:function(c){return a._handleTextInput(c?c:t.event)}});c.push({target:e,type:"keydown",handler:function(c){return a._handleKeyDown(c?
c:t.event)}});c.push({target:e,type:"keypress",handler:function(c){return a._handleKeyPress(c?c:t.event)}});c.push({target:e,type:"keyup",handler:function(c){return a._handleKeyUp(c?c:t.event)}});b.isIE&&c.push({target:f,type:"keyup",handler:function(c){return a._handleDocKeyUp(c?c:t.event)}});c.push({target:e,type:"contextmenu",handler:function(c){return a._handleContextMenu(c?c:t.event)}});c.push({target:e,type:"copy",handler:function(c){return a._handleCopy(c?c:t.event)}});c.push({target:e,type:"cut",
handler:function(c){return a._handleCut(c?c:t.event)}});c.push({target:e,type:"paste",handler:function(c){return a._handlePaste(c?c:t.event)}});c.push({target:f,type:"selectionchange",handler:function(c){return a._handleSelectionChange(c?c:t.event)}});if(b.isIOS||b.isAndroid)c.push({target:e,type:"touchstart",handler:function(c){return a._handleTouchStart(c?c:t.event)}}),c.push({target:e,type:"touchmove",handler:function(c){return a._handleTouchMove(c?c:t.event)}}),c.push({target:e,type:"touchend",
handler:function(c){return a._handleTouchEnd(c?c:t.event)}});else{c.push({target:e,type:"selectstart",handler:function(c){return a._handleSelectStart(c?c:t.event)}});c.push({target:e,type:"mousedown",handler:function(c){return a._handleMouseDown(c?c:t.event)}});c.push({target:e,type:"mouseover",handler:function(c){return a._handleMouseOver(c?c:t.event)}});c.push({target:e,type:"mouseout",handler:function(c){return a._handleMouseOut(c?c:t.event)}});c.push({target:u,type:"mouseup",handler:function(c){return a._handleMouseUp(c?
c:t.event)}});c.push({target:u,type:"mousemove",handler:function(c){return a._handleMouseMove(c?c:t.event)}});c.push({target:d,type:"mousedown",handler:function(c){return a._handleRootMouseDown(c?c:t.event)}});c.push({target:d,type:"mouseup",handler:function(c){return a._handleRootMouseUp(c?c:t.event)}});c.push({target:n,type:"dragstart",handler:function(c){return a._handleDragStart(c?c:t.event)}});c.push({target:n,type:"drag",handler:function(c){return a._handleDrag(c?c:t.event)}});c.push({target:n,
type:"dragend",handler:function(c){return a._handleDragEnd(c?c:t.event)}});c.push({target:n,type:"dragenter",handler:function(c){return a._handleDragEnter(c?c:t.event)}});c.push({target:n,type:"dragover",handler:function(c){return a._handleDragOver(c?c:t.event)}});c.push({target:n,type:"dragleave",handler:function(c){return a._handleDragLeave(c?c:t.event)}});c.push({target:n,type:"drop",handler:function(c){return a._handleDrop(c?c:t.event)}});c.push({target:this._clientDiv,type:26<b.isFirefox?"wheel":
b.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:t.event)}});this._clipDiv&&c.push({target:this._clipDiv,type:26<b.isFirefox?"wheel":b.isFirefox?"DOMMouseScroll":"mousewheel",handler:function(c){return a._handleMouseWheel(c?c:t.event)}});if(b.isFirefox&&(!b.isWindows||15<=b.isFirefox))(g=t.MutationObserver||t.MozMutationObserver)?(this._mutationObserver=new g(function(c){a._handleDataModified(c)}),this._mutationObserver.observe(e,{subtree:!0,characterData:!0})):
c.push({target:this._clientDiv,type:"DOMCharacterDataModified",handler:function(c){return a._handleDataModified(c?c:t.event)}});if(b.isFirefox&&(!b.isWindows||15<=b.isFirefox)||b.isIE||b.isWebkit)c.push({target:this._clientDiv,type:"compositionstart",handler:function(c){return a._handleCompositionStart(c?c:t.event)}}),c.push({target:this._clientDiv,type:"compositionend",handler:function(c){return a._handleCompositionEnd(c?c:t.event)}}),c.push({target:this._clientDiv,type:"compositionupdate",handler:function(c){return a._handleCompositionUpdate(c?
c:t.event)}});this._overlayDiv&&(c.push({target:this._overlayDiv,type:"mousedown",handler:function(c){return a._handleMouseDown(c?c:t.event)}}),c.push({target:this._overlayDiv,type:"mouseover",handler:function(c){return a._handleMouseOver(c?c:t.event)}}),c.push({target:this._overlayDiv,type:"mouseout",handler:function(c){return a._handleMouseOut(c?c:t.event)}}),c.push({target:this._overlayDiv,type:"contextmenu",handler:function(c){return a._handleContextMenu(c?c:t.event)}}));this._isW3CEvents||c.push({target:this._clientDiv,
type:"dblclick",handler:function(c){return a._handleDblclick(c?c:t.event)}})}this._hookRulerEvents(this._leftDiv,c);this._hookRulerEvents(this._rightDiv,c);this._hookRulerEvents(this._innerRightDiv,c);this._hookRulerEvents(this._marginDiv,c);for(g=0;g<c.length;g++)d=c[g],D(d.target,d.type,d.handler,d.capture)},_hookRulerEvents:function(a,c){if(a){var e=this,g=this._getWindow();b.isIE&&c.push({target:a,type:"selectstart",handler:function(){return!1}});c.push({target:a,type:26<b.isFirefox?"wheel":b.isFirefox?
"DOMMouseScroll":"mousewheel",handler:function(a){return e._handleMouseWheel(a?a:g.event)}});c.push({target:a,type:"click",handler:function(a){e._handleRulerEvent(a?a:g.event)}});c.push({target:a,type:"dblclick",handler:function(a){e._handleRulerEvent(a?a:g.event)}});c.push({target:a,type:"mousemove",handler:function(a){e._handleRulerEvent(a?a:g.event)}});c.push({target:a,type:"mouseover",handler:function(a){e._handleRulerEvent(a?a:g.event)}});c.push({target:a,type:"mouseout",handler:function(a){e._handleRulerEvent(a?
a:g.event)}})}},_getWindow:function(){return this._parent.ownerDocument.defaultView||this._parent.ownerDocument.parentWindow},_ignoreEvent:function(a){for(a=a.target;a&&a!==this._clientDiv;){if(a.ignore)return!0;a=a.parentNode}return!1},_init:function(a){var c=a.parent;"string"===typeof c&&(c=(a.document||document).getElementById(c));if(!c)throw Error("no parent");a.parent=c;a.model=a.model||new r.TextModel;var e=this._defaultOptions(),g;for(g in e)e.hasOwnProperty(g)&&(this["_"+g]=void 0!==a[g]?
a[g]:e[g].value);this._keyModes=[];this._rulers=[];this._selection=[new t(0,0,!1)];this._linksVisible=!1;this._maxLineWidth=this._redrawCount=0;this._maxLineIndex=-1;this._ignoreSelect=!0;this._hasFocus=this._ignoreFocus=!1;this._dragOffset=-1;this._isRangeRects=(!b.isIE||9<=b.isIE)&&"function"===typeof c.ownerDocument.createRange().getBoundingClientRect;this._isW3CEvents=c.addEventListener;this._autoScrollTimerID=this._autoScrollY=this._autoScrollX=null;this._AUTO_SCROLL_RATE=50;this._mouseUpClosure=
...
this._undoStack.endCompoundChange()},_modifyContent:function(a,c,e,b){if(this._readonly&&!a._code)return!1;a.type="Verify";var g=a.start=a.selection[0].start,d=a.end=a.selection[0].end;this.onVerify(a);g!==a.start&&(a.selection[0].start=a.start);d!==a.end&&(a.selection[0].end=a.end);if(null===a.text||void 0===a.text)return!1;1<a.selection.length&&this.setRedraw(!1);(g=this._compoundChange)?t.compare(this._getSelections(),g.owner.selection)||(this._endUndo(),1<a.selection.length&&this._startUndo()):
1<a.selection.length&&this._startUndo();var n=this._model;try{a._ignoreDOMSelection&&(this._ignoreDOMSelection=!0);var f=0,u=0;a.selection.forEach(function(e){e.start+=f;e.end+=f;var b=Array.isArray(a.text)?a.text[u]:a.text;n.setText(b,e.start,e.end);f+=e.start-e.end+b.length;e.setCaret(c?e.start+b.length:e.start);u++})}finally{a._ignoreDOMSelection&&(this._ignoreDOMSelection=!1)}this._setSelection(a.selection,e,!0,b);if(g=this._compoundChange)g.owner.selection=a.selection;1<a.selection.length&&this.setRedraw(!0);
this.onModify({type:"Modify"});return!0},_onModelChanged:function(a){a.type="ModelChanged";this.onModelChanged(a);a.type="Changed";var c=a.start,e=a.addedCharCount,b=a.removedCharCount,g=a.addedLineCount,d=a.removedLineCount,n=this._getSelections();n.forEach(function(a){a.end>c&&(a.end>c&&a.start<c+b?a.setCaret(c+e):(a.start+=e-b,a.end+=e-b))});this._setSelection(n,!1,!1);for(var n=this._model.getLineAtOffset(c),f=this._getLineNext();f;){var t=f.lineIndex;n<=t&&t<=n+d&&(n===t&&!f.modelChangedEvent&&
!f.lineRemoved?(f.modelChangedEvent=a,f.lineChanged=!0):(f.lineRemoved=!0,f.lineChanged=!1,f.modelChangedEvent=null));t>n+d&&(f.lineIndex=t+g-d,f._line.lineIndex=f.lineIndex);f=this._getLineNext(f)}this._lineHeight&&(a=[n,d].concat(Array(g)),Array.prototype.splice.apply(this._lineHeight,a));!this._wrapMode&&(n<=this._maxLineIndex&&this._maxLineIndex<=n+d)&&(this._checkMaxLineIndex=this._maxLineIndex,this._maxLineIndex=-1,this._maxLineWidth=0);this._update()},_onModelChanging:function(a){a.type="ModelChanging";
...
!a&&c.focus();this._overlayDiv&&(this._overlayDiv.style.zIndex=a?"-1":"1");for(a=this._getLineNext();a;)a._line.updateLinks(),a=this._getLineNext(a);this._updateDOMSelection()}},_setSelection:function(a,c,e,b,g,d,n){if(a){void 0===e&&(e=!0);var f=this._getSelections();a=Array.isArray(a)?a:d?f.concat([a]):[a];this._selection=t.merge(a);n||a.forEach(function(a){a._columnX=-1});!1!==c&&this._showCaret(!1,b,c,g);e&&this._updateDOMSelection();t.compare(f,a)||(c={type:"Selection",oldValue:t.convert(f),
newValue:t.convert(a)},this.onSelection(c))}},_setSelectionTo:function(a,c,e,b,g,d){var n=this._model,f=this._getSelections(),u=this.convert({x:a,y:c},"page","document");c=this._getLineIndex(u.y);a=this._getLine(c);var m=a.getOffset(u.x,u.y-this._getLinePixel(c));if(d&&!b&&t.contains(f,m))return this._dragOffset=m,a.destroy(),!1;this._blockSelection?f=this._getBlockSelections(f,c,u):(e?b?(e=f[f.length-1],e._editing=!0):(e=new t(0,0),e._editing=!0,g?f.push(e):f=[e],e._docX=u.x):e=t.editing(f),1===
this._clickCount?(e.extend(m),b||e.collapse()):(0===(this._clickCount&1)?this._doubleClickSelection?m>=this._doubleClickSelection.start?(b=this._doubleClickSelection.start,n=a.getNextOffset(m,{unit:"wordend",count:1})):(b=a.getNextOffset(m,{unit:"word",count:-1}),n=this._doubleClickSelection.end):(b=a.getNextOffset(m,{unit:"word",count:-1}),n=a.getNextOffset(b,{unit:"wordend",count:1})):this._doubleClickSelection?(g=n.getLineAtOffset(this._doubleClickSelection.start),c>=g?(b=n.getLineStart(g),n=n.getLineEnd(c)):
...
this._getSelections(),c=this._domSelection,e;if(c.length<a.length)for(e=c.length;e<a.length;e++)c.push(new v(this));else c.length>a.length&&c.splice(a.length).forEach(function(a){a.destroy()});for(e=0;e<c.length;e++)c[e].setPrimary(0===e),c[e].setSelection(a[e]);var a=this._getWindow(),b=this;1<c.length?this._cursorTimer||(this._cursorTimer=a.setInterval(function(){b._cursorVisible=!b._cursorVisible;b._domSelection.forEach(function(a){a.update()})},500)):this._cursorTimer&&(a.clearInterval(this._cursorTimer),
this._cursorTimer=null)}},_update:function(a){if(!(0<this._redrawCount)){this._updateTimer&&(this._getWindow().clearTimeout(this._updateTimer),this._updateTimer=null,a=!1);var c=this._clientDiv,e=this._viewDiv;if(c){this._metrics.invalid&&(this._ignoreQueueUpdate=!0,this._updateStyle(),this._ignoreQueueUpdate=!1);var g=this._model,d=this._getScroll(!1),n=this._getViewPadding(),f=g.getLineCount(),t=this._getLineHeight(),u=!1,m=!1,s=!1,k=this._metrics.scrollWidth;this._wrapMode&&(c.style.width=(this._metrics.wrapWidth||
this._getClientWidth())+"px");var v,h,A,l,z=0,p=0,r;if(this._lineHeight){for(;p<f;){r=this._getLineHeight(p);if(z+r>d.y)break;z+=r;p++}v=p;h=Math.max(0,v-1);A=g=d.y-z;0<v&&(g+=this._getLineHeight(v-1))}else l=Math.max(0,d.y)/t,v=Math.floor(l),h=Math.max(0,v-1),g=Math.round((l-h)*t),A=Math.round((l-v)*t);this._topIndexY=A;l=this._rootDiv;var D=l.clientWidth,B=l.clientHeight;if(a){t=0;this._leftDiv&&(v=this._leftDiv.getBoundingClientRect(),t=v.right-v.left);v=this._getClientWidth();l=this._getClientHeight();
m=v;this._wrapMode?this._metrics.wrapWidth&&(m=this._metrics.wrapWidth):m=Math.max(this._maxLineWidth,m);for(;p<f;)r=this._getLineHeight(p,!1),z+=r,p++;f=z}else{l=this._getClientHeight();A=Math.min(v+Math.floor((l+A)/t),f-1);var d=Math.min(A+1,f-1),C;for(r=c.firstChild;r;){C=r.lineIndex;var y=r.nextSibling;if(!(h<=C&&C<=d)||r.lineRemoved||-1===r.lineIndex)this._mouseWheelLine===r?(r.style.display="none",r.lineIndex=-1):c.removeChild(r);r=y}r=this._getLineNext();var y=e.ownerDocument,R=y.createDocumentFragment();
for(C=h;C<=d;C++)!r||r.lineIndex>C?(new F(this,C)).create(R,null):(R.firstChild&&(c.insertBefore(R,r),R=y.createDocumentFragment()),r&&r.lineChanged&&(r=(new F(this,C)).create(R,r),r.lineChanged=!1),r=this._getLineNext(r));R.firstChild&&c.insertBefore(R,r);b.isWebkit&&!this._wrapMode&&(c.style.width="0x7fffffffpx");r=this._getLineNext();C=l+g;for(R=!1;r;)h=r.lineWidth,void 0===h&&(y=r._line.getBoundingClientRect(),h=r.lineWidth=Math.ceil(y.right-y.left),y=y.bottom-y.top,this._lineHeight?this._lineHeight[r.lineIndex]=
...
(C=this._checkMaxLineIndex,this._checkMaxLineIndex=-1,0<=C&&C<f&&(t=new F(this,C),y=t.getBoundingClientRect(),h=y.right-y.left,h>=this._maxLineWidth&&(this._maxLineWidth=h,this._maxLineIndex=C),t.destroy()));for(;p<f;)r=this._getLineHeight(p,p<=A),z+=r,p++;f=z;this._updateRuler(this._leftDiv,v,d,B);this._updateRuler(this._rightDiv,v,d,B);this._updateRuler(this._innerRightDiv,v,d,B);this._updateRuler(this._marginDiv,v,d,B);t=0;this._leftDiv&&(v=this._leftDiv.getBoundingClientRect(),t=v.right-v.left);
z=0;this._rightDiv&&(d=this._rightDiv.getBoundingClientRect(),z=d.right-d.left);e.style.left=t+"px";e.style.right=z+"px";d=this._scrollDiv;d.style.height=f+(b.isWebkit?0:n.bottom)+"px";v=this._getClientWidth();!this._singleMode&&(!this._wrapMode&&!this._noScroll)&&(p=u=l,(A="scroll"===e.style.overflowX)?u+=k:p-=k,h=r=v,(C="scroll"===e.style.overflowY)?r+=k:h-=k,l=u,v=r,f>l&&(s=!0,v=h),this._maxLineWidth>v&&(m=!0,l=p,f>l&&(s=!0,v=h)),A!==m&&(e.style.overflowX=m?"scroll":"hidden"),C!==s&&(e.style.overflowY=
...
t.insertBefore(z,h)}else{A=this._getClientHeight();v=this._model.getLineCount();h=A+f.top+f.bottom-2*this._metrics.scrollWidth;n*v<h?(s=n,k=f.top):(s=h/v,k=this._metrics.scrollWidth);if(t.rulerChanged){for(A=t.childNodes.length;1<A;)t.removeChild(t.lastChild),A--;u=u.getAnnotations(0,v);z=d.createDocumentFragment();for(var F in u)v=F>>>0,0>v||(l=b.createElement(d,"div"),A=u[F],m(A.style,l),l.style.position="absolute",l.style.top=k+n+Math.floor(v*s)+"px",A.html&&(l.innerHTML=A.html),l.annotation=A,
l.lineIndex=v,z.appendChild(l));t.appendChild(z)}else if(t._oldTrackHeight!==h)for(l=t.firstChild?t.firstChild.nextSibling:null;l;)l.style.top=this._metrics.scrollWidth+n+Math.floor(l.lineIndex*s)+"px",l=l.nextSibling;t._oldTrackHeight=h}}t.rulerChanged=!1;t=t.nextSibling}},_updateStyleSheet:function(){var a="";b.isWebkit&&0<this._metrics.scrollWidth&&(a+="\n.textview ::-webkit-scrollbar-corner {background: #eeeeee;}");if(a){var c=this._clientDiv.ownerDocument,e=c.getElementById("_textviewStyle");
if(e)e.removeChild(e.firstChild),e.appendChild(c.createTextNode(a));else{e=b.createElement(c,"style");e.id="_textviewStyle";var g=c.getElementsByTagName("head")[0]||c.documentElement;e.appendChild(c.createTextNode(a));g.insertBefore(e,g.firstChild)}}},_updateStyle:function(a,c){!a&&b.isIE&&(this._rootDiv.style.lineHeight="normal");c=this._metrics=c||this._calculateMetrics();this._variableLineHeight&&(this._variableLineHeight=!1,this._resetLineHeight());this._rootDiv.style.lineHeight=b.isIE?c.lineHeight-
(c.lineTrim.top+c.lineTrim.bottom)+"px":"normal";this._updateStyleSheet();if(b.isMac&&b.isWebkit){var e=this._viewDiv;!c.invalid&&0===c.scrollWidth?(e.style.pointerEvents="none",e.style.zIndex="2"):(e.style.pointerEvents="",e.style.zIndex="")}a||(this.redraw(),this._resetLineWidth())}};h.EventTarget.addMixin(z.prototype);return{TextView:z}});y("orion/editor/projectionTextModel",["orion/editor/textModel","orion/editor/eventTarget"],function(l,r){function p(h){this._model=h;this._projections=[];var f=
this;this._listener={onChanged:function(d){f._onChanged(d)},onChanging:function(d){f._onChanging(d)}};h.addEventListener("postChanged",this._listener.onChanged);h.addEventListener("preChanging",this._listener.onChanging)}p.prototype={destroy:function(){this._model&&(this._model.removeEventListener("postChanged",this._listener.onChanged),this._model.removeEventListener("preChanging",this._listener.onChanging),this._model=null)},addProjection:function(h){if(h){var f=this._model,d=this._projections;
h._lineIndex=f.getLineAtOffset(h.start);h._lineCount=f.getLineAtOffset(h.end)-h._lineIndex;var b=h.text;b||(b="");h._model="string"===typeof b?new l.TextModel(b,f.getLineDelimiter()):b;var f=this.mapOffset(h.start,!0),b=h.end-h.start,k=h._lineCount,m=h._model.getCharCount(),g=h._model.getLineCount()-1,a={type:"Changing",text:h._model.getText(),start:f,removedCharCount:b,addedCharCount:m,removedLineCount:k,addedLineCount:g};this.onChanging(a);a=this._binarySearch(d,h.start);d.splice(a,0,h);this.onChanged({type:"Changed",
start:f,removedCharCount:b,addedCharCount:m,removedLineCount:k,addedLineCount:g})}},getProjections:function(){return this._projections.slice(0)},getBaseModel:function(){return this._model},mapOffset:function(h,f){var d=this._projections,b=0,k,m;if(f){for(k=0;k<d.length;k++){m=d[k];if(m.start>h)break;if(m.end>h)return-1;b+=m._model.getCharCount()-(m.end-m.start)}return h+b}for(k=0;k<d.length;k++){m=d[k];if(m.start>h-b)break;var g=m._model.getCharCount();if(m.start+g>h-b)return-1;b+=g-(m.end-m.start)}return h-
b},removeProjection:function(h){this._removeProjection(h)},_removeProjection:function(h,f){var d,b=0;for(d=0;d<this._projections.length;d++){var k=this._projections[d];if(k===h){h=k;break}b+=k._model.getCharCount()-(k.end-k.start)}if(d<this._projections.length){var k=this._model,b=h.start+b,m=h.end-h.start,g=h._lineCount,a=h._model.getCharCount(),s=h._model.getLineCount()-1;f||(k={type:"Changing",text:k.getText(h.start,h.end),start:b,removedCharCount:a,addedCharCount:m,removedLineCount:s,addedLineCount:g},
this.onChanging(k));this._projections.splice(d,1);if(!f)this.onChanged({type:"Changed",start:b,removedCharCount:a,addedCharCount:m,removedLineCount:s,addedLineCount:g})}},_binarySearch:function(h,f){for(var d=h.length,b=-1,k;1<d-b;)k=Math.floor((d+b)/2),f<=h[k].start?d=k:b=k;return d},getCharCount:function(){for(var h=this._model.getCharCount(),f=this._projections,d=0;d<f.length;d++)var b=f[d],h=h+(b._model.getCharCount()-(b.end-b.start));return h},getLine:function(h,f){if(0>h)return null;var d=this._model,
b=this._projections,k=0,m=[],g=0,a,s,e;for(a=0;a<b.length;a++){e=b[a];if(e._lineIndex>=h-k)break;s=e._model.getLineCount()-1;if(e._lineIndex+s>=h-k){g=h-(e._lineIndex+k);if(g<s)return e._model.getLine(g,f);m.push(e._model.getLine(s))}g=e.end;k+=s-e._lineCount}for(g=Math.max(g,d.getLineStart(h-k));a<b.length;a++){e=b[a];if(e._lineIndex>h-k)break;m.push(d.getText(g,e.start));s=e._model.getLineCount()-1;if(e._lineIndex+s>h-k)return m.push(e._model.getLine(0,f)),m.join("");m.push(e._model.getText());
g=e.end;k+=s-e._lineCount}b=d.getLineEnd(h-k,f);g<b&&m.push(d.getText(g,b));return m.join("")},getLineAtOffset:function(h){for(var f=this._model,d=this._projections,b=0,k=0,m=0;m<d.length;m++){var g=d[m];if(g.start>h-b)break;var a=g._model.getCharCount();if(g.start+a>h-b){d=h-(g.start+b);k+=g._model.getLineAtOffset(d);b+=d;break}k+=g._model.getLineCount()-1-g._lineCount;b+=a-(g.end-g.start)}return f.getLineAtOffset(h-b)+k},getLineCount:function(){for(var h=this._projections,f=this._model.getLineCount(),
d=0;d<h.length;d++)var b=h[d],f=f+(b._model.getLineCount()-1-b._lineCount);return f},getLineDelimiter:function(){return this._model.getLineDelimiter()},getLineEnd:function(h,f){if(0>h)return-1;for(var d=this._model,b=this._projections,k=0,m=0,g=0;g<b.length;g++){var a=b[g];if(a._lineIndex>h-k)break;var s=a._model.getLineCount()-1;if(a._lineIndex+s>h-k)return a._model.getLineEnd(h-(a._lineIndex+k),f)+a.start+m;m+=a._model.getCharCount()-(a.end-a.start);k+=s-a._lineCount}return d.getLineEnd(h-k,f)+
m},getLineStart:function(h){if(0>h)return-1;for(var f=this._model,d=this._projections,b=0,k=0,m=0;m<d.length;m++){var g=d[m];if(g._lineIndex>=h-b)break;var a=g._model.getLineCount()-1;if(g._lineIndex+a>=h-b)return g._model.getLineStart(h-(g._lineIndex+b))+g.start+k;k+=g._model.getCharCount()-(g.end-g.start);b+=a-g._lineCount}return f.getLineStart(h-b)+k},getText:function(h,f){void 0===h&&(h=0);var d=this._model,b=this._projections,k=0,m=[],g,a,s;for(g=0;g<b.length;g++){a=b[g];if(a.start>h-k)break;
s=a._model.getCharCount();if(a.start+s>h-k){if(void 0!==f&&a.start+s>f-k)return a._model.getText(h-(a.start+k),f-(a.start+k));m.push(a._model.getText(h-(a.start+k)));h=a.end+k+s-(a.end-a.start)}k+=s-(a.end-a.start)}var e=h-k;if(void 0!==f){for(;g<b.length;g++){a=b[g];if(a.start>f-k)break;m.push(d.getText(e,a.start));s=a._model.getCharCount();if(a.start+s>f-k)return m.push(a._model.getText(0,f-(a.start+k))),m.join("");m.push(a._model.getText());e=a.end;k+=s-(a.end-a.start)}m.push(d.getText(e,f-k))}else{for(;g<
b.length;g++)a=b[g],m.push(d.getText(e,a.start)),m.push(a._model.getText()),e=a.end;m.push(d.getText(e))}return m.join("")},_onChanged:function(h){h=this._change;var f=h.baseStart,d=h.baseEnd,b,k,m=this._projections;for(b=0;b<m.length&&!(k=m[b],k.end>f);b++);var g=b;for(b=0;b<m.length&&!(k=m[b],k.start>=d);b++);var a=b,s=this._model,f=h.baseText.length-(d-f);for(b=a;b<m.length;b++)k=m[b],k.start+=f,k.end+=f,k._lineIndex=s.getLineAtOffset(k.start);k=m.splice(g,a-g);for(b=0;b<k.length;b++)k[b].annotation&&
k[b].annotation._expand();this.onChanged({type:"Changed",start:h.start,removedCharCount:h.removedCharCount,addedCharCount:h.addedCharCount,removedLineCount:h.removedLineCount,addedLineCount:h.addedLineCount});this._change=void 0},_onChanging:function(h){var f=!!this._change,d=this._change||{},b=h.start,k=b+h.removedCharCount;d.baseStart=b;d.baseEnd=k;d.baseText=h.text;d.addedLineCount=h.addedLineCount;if(!f){this._change=d;d.text=h.text;var m=this._projections,g,a,s;h=function(e){for(g=a=0;a<m.length;a++){s=
m[a];if(s.start>e)break;if(s.end>e)return-1;g+=s._model.getCharCount()-(s.end-s.start)}return e+g};d.start=h(b);-1===d.start&&(d.text=this._model.getText(s.start,b)+d.text,d.addedLineCount+=this._model.getLineAtOffset(b)-this._model.getLineAtOffset(s.start),d.start=s.start+g);d.end=h(k);-1===d.end&&(d.text+=this._model.getText(k,s.end),d.addedLineCount+=this._model.getLineAtOffset(s.end)-this._model.getLineAtOffset(k),d.end=s.start+g)}d.addedCharCount=d.text.length;d.removedCharCount=d.end-d.start;
d.removedLineCount=this.getLineAtOffset(d.end)-this.getLineAtOffset(d.start);this.onChanging({type:"Changing",text:d.text,start:d.start,removedCharCount:d.removedCharCount,addedCharCount:d.addedCharCount,removedLineCount:d.removedLineCount,addedLineCount:d.addedLineCount})},onChanging:function(h){return this.dispatchEvent(h)},onChanged:function(h){return this.dispatchEvent(h)},setLineDelimiter:function(h){this._model.setLineDelimiter(h)},setText:function(h,f,d){function b(e){for(m=g=0;g<k.length;g++){a=
...
d=c;if(0===d.length)return null;var t=this._tooltipDiv.ownerDocument,v=this._view,k=v.getModel(),h=k.getBaseModel?k.getBaseModel():k;if(1===d.length&&"orion.annotation.folding"===d[0].type)return e=new p.ProjectionTextModel(h),n=h.getLineStart(h.getLineAtOffset(d[0].start)),c=h.getCharCount(),d[0].end!==c&&e.addProjection({start:d[0].end,end:c}),0<n&&e.addProjection({start:0,end:n}),e;if(1===d.length){if((n=a(d[0],e))&&n.firstChild)(e=n.firstChild.className)&&(e+=" "),n.firstChild.className=e+"single";
return n}c=b.createElement(t,"div");n=b.createElement(t,"em");n.appendChild(t.createTextNode(l.multipleAnnotations));c.appendChild(n);for(u=0;u<d.length;u++)(n=a(d[u],e))&&c.appendChild(n);return c}};return{Tooltip:k}});y("orion/editor/annotations",["i18n!orion/editor/nls/messages","orion/editor/eventTarget"],function(l,r){function p(){}function h(a,b,e){this.start=a;this.end=b;this._projectionModel=e;this.html=this._expandedHTML;this.style=this._expandedStyle;this.expanded=!0}function f(a,b){var e=
a.lastIndexOf("."),e=a.substring(e+1),g={title:l[e],style:{styleClass:"annotation "+e},html:"\x3cdiv class\x3d'annotationHTML "+e+"'\x3e\x3c/div\x3e",overviewStyle:{styleClass:"annotationOverview "+e}};b?g.lineStyle={styleClass:"annotationLine "+e}:g.rangeStyle={styleClass:"annotationRange "+e};p.registerType(a,g)}function d(){}function b(a,b,e,g,c){var d;void 0===g&&(g=-1);void 0===c&&(c=a.length);for(;1<c-g;)if(d=Math.floor((c+g)/2),b<=a[d].start)c=d;else if(e&&b<a[d].end){c=d;break}else g=d;return c}
function k(a){this._annotations=[];var b=this;this._listener={onChanged:function(a){b._onChanged(a)}};this.setTextModel(a)}function m(a,b){this._view=a;this._annotationModel=b;var e=this;this._listener={onDestroy:function(a){e._onDestroy(a)},onLineStyle:function(a){e._onLineStyle(a)},onChanged:function(a){e._onAnnotationModelChanged(a)}};a.addEventListener("Destroy",this._listener.onDestroy);a.addEventListener("postLineStyle",this._listener.onLineStyle);b.addEventListener("Changed",this._listener.onChanged)}
h.prototype={_expandedHTML:"\x3cdiv class\x3d'annotationHTML expanded'\x3e\x3c/div\x3e",_expandedStyle:{styleClass:"annotation expanded"},_collapsedHTML:"\x3cdiv class\x3d'annotationHTML collapsed'\x3e\x3c/div\x3e",_collapsedStyle:{styleClass:"annotation collapsed"},_collapse:function(){if(!this.expanded)return!1;this.expanded=!1;this.html=this._collapsedHTML;this.style=this._collapsedStyle;this._annotationModel&&this._annotationModel.modifyAnnotation(this);return!0},_expand:function(){if(this.expanded)return!1;
this.expanded=!0;this.html=this._expandedHTML;this.style=this._expandedStyle;this._annotationModel&&this._annotationModel.modifyAnnotation(this);return!0},_collapseImpl:function(a){if(this._collapse()){a&&this._forEachOverlaping(function(a){a.expanded||(a._expandImpl(!1),a._recollapse=!0)});a=this._projectionModel;var b=a.getBaseModel();this._projection={annotation:this,start:b.getLineStart(b.getLineAtOffset(this.start)+1),end:b.getLineEnd(b.getLineAtOffset(this.end),!0)};a.addProjection(this._projection)}},
_expandImpl:function(a){this._expand()&&(this._projectionModel._removeProjection(this._projection,!this._annotationModel),a&&this._forEachOverlaping(function(a){a._recollapse&&(a._collapseImpl(!1),a._recollapse=!1)}))},_forEachOverlaping:function(a){if(this._annotationModel)for(var b=this._annotationModel.getAnnotations(this.start,this.end);b.hasNext();){var e=b.next();e!==this&&e.type===p.ANNOTATION_FOLDING&&a.call(this,e)}},collapse:function(){this._recollapse=!1;this._collapseImpl(!0)},expand:function(){this._recollapse=
!1;this._expandImpl(!0)}};p.ANNOTATION_ERROR="orion.annotation.error";p.ANNOTATION_WARNING="orion.annotation.warning";p.ANNOTATION_TASK="orion.annotation.task";p.ANNOTATION_BREAKPOINT="orion.annotation.breakpoint";p.ANNOTATION_BOOKMARK="orion.annotation.bookmark";p.ANNOTATION_FOLDING="orion.annotation.folding";p.ANNOTATION_CURRENT_BRACKET="orion.annotation.currentBracket";p.ANNOTATION_MATCHING_BRACKET="orion.annotation.matchingBracket";p.ANNOTATION_CURRENT_LINE="orion.annotation.currentLine";p.ANNOTATION_CURRENT_SEARCH=
"orion.annotation.currentSearch";p.ANNOTATION_MATCHING_SEARCH="orion.annotation.matchingSearch";p.ANNOTATION_READ_OCCURRENCE="orion.annotation.readOccurrence";p.ANNOTATION_WRITE_OCCURRENCE="orion.annotation.writeOccurrence";p.ANNOTATION_SELECTED_LINKED_GROUP="orion.annotation.selectedLinkedGroup";p.ANNOTATION_CURRENT_LINKED_GROUP="orion.annotation.currentLinkedGroup";p.ANNOTATION_LINKED_GROUP="orion.annotation.linkedGroup";p.ANNOTATION_BLAME="orion.annotation.blame";p.ANNOTATION_CURRENT_BLAME="orion.annotation.currentBlame";
p.ANNOTATION_DIFF_ADDED="orion.annotation.diffAdded";p.ANNOTATION_DIFF_DELETED="orion.annotation.diffDeleted";p.ANNOTATION_DIFF_MODIFIED="orion.annotation.diffModified";var g={};p.registerType=function(a,b){var e=b;"function"!==typeof e&&(e=function(a,c,e){this.start=a;this.end=c;void 0!==e&&(this.title=e)},e.prototype=b);e.prototype.type=a;g[a]=e;return a};p.createAnnotation=function(a,b,e,g){return new (this.getType(a))(b,e,g)};p.getType=function(a){return g[a]};f(p.ANNOTATION_ERROR);f(p.ANNOTATION_WARNING);
f(p.ANNOTATION_TASK);f(p.ANNOTATION_BREAKPOINT);f(p.ANNOTATION_BOOKMARK);f(p.ANNOTATION_CURRENT_BRACKET);f(p.ANNOTATION_MATCHING_BRACKET);f(p.ANNOTATION_CURRENT_SEARCH);f(p.ANNOTATION_MATCHING_SEARCH);f(p.ANNOTATION_READ_OCCURRENCE);f(p.ANNOTATION_WRITE_OCCURRENCE);f(p.ANNOTATION_SELECTED_LINKED_GROUP);f(p.ANNOTATION_CURRENT_LINKED_GROUP);f(p.ANNOTATION_LINKED_GROUP);f(p.ANNOTATION_CURRENT_LINE,!0);f(p.ANNOTATION_BLAME,!0);f(p.ANNOTATION_CURRENT_BLAME,!0);f(p.ANNOTATION_DIFF_ADDED);f(p.ANNOTATION_DIFF_DELETED);
f(p.ANNOTATION_DIFF_MODIFIED);p.registerType(p.ANNOTATION_FOLDING,h);d.addMixin=function(a){var b=d.prototype,e;for(e in b)b.hasOwnProperty(e)&&(a[e]=b[e])};d.prototype={addAnnotationType:function(a,b){this._annotationTypes||(this._annotationTypes=[]);var e=b-1;void 0==b||!(0<=e&&e<this._annotationTypes.length)?this._annotationTypes.push(a):this._annotationTypes.splice(e,0,a)},getAnnotationTypePriority:function(a){if(this._annotationTypes)for(var b=0;b<this._annotationTypes.length;b++)if(this._annotationTypes[b]===
a)return b+1;return 0},getAnnotationsByType:function(a,b,e){a=a.getAnnotations(b,e);for(e=[];a.hasNext();)b=a.next(),0!==this.getAnnotationTypePriority(b.type)&&e.push(b);var g=this;e.sort(function(a,e){return g.getAnnotationTypePriority(a.type)-g.getAnnotationTypePriority(e.type)});return e},isAnnotationTypeVisible:function(a){return 0!==this.getAnnotationTypePriority(a)},removeAnnotationType:function(a){if(this._annotationTypes)for(var b=0;b<this._annotationTypes.length;b++)if(this._annotationTypes[b]===
a){this._annotationTypes.splice(b,1);break}}};k.prototype={addAnnotation:function(a){if(a){var g=this._annotations,e=b(g,a.start);g.splice(e,0,a);a._annotationModel=this;this.onChanged({type:"Changed",added:[a],removed:[],changed:[]})}},getTextModel:function(){return this._model},getAnnotations:function(a,b){var e=this._annotations,g,c=0,d;d=void 0===a&&void 0===b?function(){return c<e.length?e[c++]:null}:function(){for(;c<e.length;){var g=e[c++];if(a===g.start||(a>g.start?a<g.end:g.start<b))return g;
...
removed:e,added:[],changed:[]})},removeAnnotation:function(a){if(a){var b=this._getAnnotationIndex(a);0>b||(a._annotationModel=null,a={type:"Changed",removed:this._annotations.splice(b,1),added:[],changed:[]},this.onChanged(a))}},replaceAnnotations:function(a,g){var e=this._annotations,d,c,f,t=[];if(a)for(d=a.length-1;0<=d;d--)f=a[d],c=this._getAnnotationIndex(f),0>c||(f._annotationModel=null,e.splice(c,1),t.splice(0,0,f));g||(g=[]);for(d=0;d<g.length;d++)f=g[d],c=b(e,f.start),f._annotationModel=
this,e.splice(c,0,f);this.onChanged({type:"Changed",removed:t,added:g,changed:[]})},setTextModel:function(a){this._model&&this._model.removeEventListener("Changed",this._listener.onChanged);(this._model=a)&&this._model.addEventListener("Changed",this._listener.onChanged)},_getAnnotationIndex:function(a){for(var g=this._annotations,e=b(g,a.start);e<g.length&&g[e].start===a.start;){if(g[e]===a)return e;e++}return-1},_onChanged:function(a){var b=a.start,e=a.addedCharCount,g=a.removedCharCount,c=this._annotations,
d=b+g;if(0<c.length){a={type:"Changed",added:[],removed:[],changed:[],textModelChangedEvent:a};e-=g;for(g=0;g<c.length;g++){var f=c[g];f.start>=d?(f._oldStart=f.start,f._oldEnd=f.end,f.start+=e,f.end+=e,a.changed.push(f)):f.end<=b||(f.start<b&&d<f.end?(f._oldStart=f.start,f._oldEnd=f.end,f.end+=e,a.changed.push(f)):(c.splice(g,1),a.removed.push(f),f._annotationModel=null,f.expand&&f.expand(),g--))}if(0<a.added.length||0<a.removed.length||0<a.changed.length)this.onChanged(a)}}};r.EventTarget.addMixin(k.prototype);
m.prototype={destroy:function(){var a=this._view;a&&(a.removeEventListener("Destroy",this._listener.onDestroy),a.removeEventListener("LineStyle",this._listener.onLineStyle),this.view=null);(a=this._annotationModel)&&a.removeEventListener("Changed",this._listener.onChanged)},_mergeStyle:function(a,b){if(b){a||(a={});a.styleClass=a.styleClass&&b.styleClass&&a.styleClass!==b.styleClass?a.styleClass+(" "+b.styleClass):b.styleClass;var e;b.tagName&&!a.tagName&&(a.tagName=b.tagName);if(b.style)for(e in a.style||
(a.style={}),b.style)a.style[e]||(a.style[e]=b.style[e]);if(b.attributes)for(e in a.attributes||(a.attributes={}),b.attributes)a.attributes[e]||(a.attributes[e]=b.attributes[e])}return a},_mergeStyleRanges:function(a,g){a||(a=[]);for(var e,d=b(a,g.start,!0);d<a.length&&g;d++){var c=a[d];if(g.end<=c.start)break;if(!(g.start>=c.end)){e=this._mergeStyle({},c.style);e=this._mergeStyle(e,g.style);var f=[];f.push(d,1);g.start<c.start&&f.push({start:g.start,end:c.start,style:g.style});g.start>c.start&&f.push({start:c.start,
end:g.start,style:c.style});f.push({start:Math.max(c.start,g.start),end:Math.min(c.end,g.end),style:e});g.end<c.end&&f.push({start:g.end,end:c.end,style:c.style});g=g.end>c.end?{start:c.end,end:g.end,style:g.style}:null;Array.prototype.splice.apply(a,f)}}g&&(e=this._mergeStyle({},g.style),a.splice(d,0,{start:g.start,end:g.end,style:e}));return a},_onAnnotationModelChanged:function(a){function b(a,c){d.getBaseModel&&(a=d.mapOffset(a,!0),c=d.mapOffset(c,!0));-1!==a&&-1!==c&&g.redrawRange(a,c)}function e(a,
e){for(var g=0;g<a.length;g++)if(c.isAnnotationTypeVisible(a[g].type)){var d=a[g];b(d.start,d.end);e&&(void 0!==d._oldStart&&d._oldEnd)&&b(d._oldStart,d._oldEnd)}}var g=this._view;if(g){var c=this,d=g.getModel();e(a.added);e(a.removed);e(a.changed,!0)}},_onDestroy:function(a){this.destroy()},_onLineStyle:function(a){var b=this._annotationModel,e=a.textView.getModel(),g=b.getTextModel(),c=a.lineStart,d=a.lineStart+a.lineText.length;g!==e&&(c=e.mapOffset(c),d=e.mapOffset(d));for(b=b.getAnnotations(c,
d);b.hasNext();)if(c=b.next(),this.isAnnotationTypeVisible(c.type)){if(c.rangeStyle){var d=c.start,f=c.end;g!==e&&(d=e.mapOffset(d,!0),f=e.mapOffset(f,!0));a.ranges=this._mergeStyleRanges(a.ranges,{start:d,end:f,style:c.rangeStyle})}c.lineStyle&&(a.style=this._mergeStyle({},a.style),a.style=this._mergeStyle(a.style,c.lineStyle))}}};d.addMixin(m.prototype);return{FoldingAnnotation:h,AnnotationType:p,AnnotationTypeList:d,AnnotationModel:k,AnnotationStyler:m}});y("orion/editor/editor","i18n!orion/editor/nls/messages orion/editor/eventTarget orion/editor/tooltip orion/editor/annotations orion/objects orion/util".split(" "),
function(l,r,p,h,f,d){function b(b){b=b||{};this._domNode=b.domNode;this._model=b.model;this._undoStack=b.undoStack;this._statusReporter=b.statusReporter;this._title=null;var a=this;this._listener={onChanged:function(b){a.onChanged(b)}};this._model&&this._model.addEventListener("Changed",this._listener.onChanged);this.checkDirty()}function k(g){g=g||{};b.call(this,g);this._textViewFactory=g.textViewFactory;this._undoStackFactory=g.undoStackFactory;this._textDNDFactory=g.textDNDFactory;this._annotationFactory=
g.annotationFactory;this._zoomRulerFactory=g.zoomRulerFactory;this._foldingRulerFactory=g.foldingRulerFactory;this._lineNumberRulerFactory=g.lineNumberRulerFactory;this._contentAssistFactory=g.contentAssistFactory;this._keyBindingFactory=g.keyBindingFactory;this._hoverFactory=g.hoverFactory;this._contentAssist=this._foldingRuler=this._zoomRuler=this._overviewRuler=this._lineNumberRuler=this._annotationRuler=this._annotationModel=this._annotationStyler=null}var m=h.AnnotationType;b.prototype={destroy:function(){this.uninstall();
this._statusReporter=this._domNode=null;this._model&&this._model.removeEventListener("Changed",this._listener.onChanged)},checkDirty:function(){this.setDirty(this._undoStack&&!this._undoStack.isClean())},focus:function(){},getModel:function(){return this._model},getText:function(b,a){return this.getModel().getText(b,a)},getTitle:function(){return this._title},getUndoStack:function(){return this._undoStack},install:function(){this.installed=!0},isDirty:function(){return this._undoStack?!this._undoStack.isClean():
...
f.end-1:f.end);if(k!==h||1<g.length){var m=[];m.push("");for(var s=k;s<=h;s++)m.push(c.getLine(s,!0));var s=c.getLineStart(k),l=c.getLineEnd(h,!0),p=b.getOptions("tabSize","expandTab"),p=p.expandTab?Array(p.tabSize+1).join(" "):"\t",m=m.join(p);a.setText(m,s,l);var q=s===f.start?f.start:f.start+p.length,k=f.end+(h-k+1)*p.length;d+=s-l+m.length;f.start=q;f.end=k}else return!0;return!1}))return!1;a.setSelections(g);1<g.length&&this.endUndo();return!0}},gotoLastEdit:function(){"number"===typeof this._lastEditLocation&&
...
9===y);)p++;var k=n.substring(0,p),G=n.substring(0,r),I=n.substring(r),H;if(l.smartIndentation&&123===n.charCodeAt(H=G.trimRight().length-1))return e=r-H-1,I=I.length-I.trimLeft().length,n=125===n.charCodeAt(r+I)?f+k+g+f+k:f+k+g,b(n,c.start-e,c.end+I),c.start=c.end=c.start+f.length+k.length+g.length-e,!0;if(l.autoCompleteComments&&!s.test(G)&&(h.test(G)||m.test(G))){if(p=h.exec(G)){n=f+k+" * ";n=s.test(I)?n+I.substring(0,I.length-2).trim():n+I.trim();if(d.getLineCount()===e+1||!m.test(d.getLine(e+
1)))n+=f+k+" */";b(n,c.start,c.end+I.length);c.start=c.end=c.start+f.length+k.length+3;return!0}if(p=m.exec(G))for(e-=1;0<=e;e--){p=d.getLine(e,!1);if(h.test(p))return s.test(I)||47===n.charCodeAt(r)?(n=f+k+"*"+I,k=c.start+f.length+k.length+1):(n=f+k+"* "+I,k=c.start+f.length+k.length+2),b(n,c.start,c.end+I.length),c.start=c.end=k,!0;if(!m.test(p))break}}else{if(s.test(G)&&32===k.charCodeAt(k.length-1))return n=f+k.substring(0,k.length-1),b(n,c.start,c.end),c.start=c.end=c.start+n.length,!0;if(0<
p){for(p=r;p<n.length&&(32===(y=n.charCodeAt(p++))||9===y);)c.end++;n=d.getLineDelimiter()+k;b(n,c.start,c.end);c.start=c.end=c.start+n.length;return!0}}}return!1}var b=this.editor,c=b.getTextView();if(c.getOptions("readonly")||c.getOptions("singleMode"))return!1;var d=b.getModel(),b=c.getOptions("tabSize","expandTab"),g=b.expandTab?Array(b.tabSize+1).join(" "):"\t",f=d.getLineDelimiter(),h=/^[\s]*\/\*[\*]*[\s]*$/,m=/^[\s]*\*/,s=/\*\/[\s]*$/,l=this;k(this,!0,function(c,b){a(c,b)||(b(f,c.start,c.end),
...
1,a.start),g=a.start===b.getCharCount()?"":b.getText(a.start,a.start+1);("("===d&&")"===g||"["===d&&"]"===g||"{"===d&&"}"===g||"\x3c"===d&&"\x3e"===g||'"'===d&&'"'===g||"'"===d&&"'"===g)&&e("",a.start,a.start+1)}},!0);return!1},_findEnclosingComment:function(a,b,c){var d=a.getLineAtOffset(b),g=a.getLineAtOffset(c),f,k,h,m,s,l;for(f=d;0<=f&&!(k=a.getLine(f),h=f===d?b-a.getLineStart(d):k.length,m=k.lastIndexOf("/*",h),k=k.lastIndexOf("*/",h),k>m);f--)if(-1!==m){s=a.getLineStart(f)+m;break}for(f=g;f<
a.getLineCount()&&!(k=a.getLine(f),h=f===g?c-a.getLineStart(g):0,m=k.indexOf("/*",h),k=k.indexOf("*/",h),-1!==m&&m<k);f++)if(-1!==k){l=a.getLineStart(f)+k;break}return{commentStart:s,commentEnd:l}},lineStart:function(){var a=this.editor.getModel();k(this,!1,function(b){var c=b.getCaret(),d=a.getLineAtOffset(c),g=a.getLineStart(d),d=a.getLine(d),f;for(f=0;f<d.length;f++){var k=d.charCodeAt(f);if(!(32===k||9===k))break}f+=g;c!==f?b.setCaret(f):b.setCaret(g)});return!0},removeBlockComment:function(){var a=
...
this._setCurrentGroup(-1);this._hoverTimeout&&(window.clearTimeout(this._hoverTimeout),this._hoverTimeout=null)},_findNextAnnotation:function(a,c,b,e,d,g){var f=null,k,h=c;if(0<=e&&0<=d&&e>=c&&e<b)for(var h=e,m=a.getAnnotations(e,d);!k&&m.hasNext();)if(c=m.next(),!g||g(c.type))c.start===e&&c.end===d&&(k=c);a=a.getAnnotations(h,b);for(var s;a.hasNext();)if(c=a.next(),!g||g(c.type)){f||(f=c);if(!k){f=c;break}if(s&&(k.start!==c.start||k.end!==c.end)){s=!1;f=c;break}k&&k===c&&(s=!0)}s&&(f=null);return f},
...
b[f])}}};p=function(a,c){k.call(this,a,"fixed",c)};p.prototype=f.mixin(new k,{setView:function(a){this._destroy();k.prototype.setView.call(this,a);this._create()},_create:function(){function a(c){var b=c.themeClass;b?((b=b.replace("textviewZoom",""))&&(b=" "+b),b="textviewZoom"+b):b="textviewZoom";c.themeClass=b;c.noScroll=!0;c.readonly=!0;return c}function c(){var a=h._metrics.viewPadding,c=h._metrics.viewPadding,b=h.getLineHeight(),e=s.getLineHeight(),d=h.getModel().getLineCount(),b=h._lineHeight?
h._scrollHeight:d*b,e=s._lineHeight?s._scrollHeight:d*e,d=e/b,g=h.getClientArea().height+a.top+a.bottom,c=s.getClientArea().height+c.top+c.bottom;return{zoomFactor:d,documentHeight:b,zoomDocumentHeight:e,clientHeight:g,zoomClientHeight:c,scrollWidth:h._metrics.scrollWidth,windowHeight:g*d,padding:a}}function e(a){a=a||{y:h.getTopPixel()};var b=c();s.setTopPixel(a.y*(b.zoomFactor+(b.windowHeight-b.clientHeight-b.scrollWidth)/b.documentHeight));a=a.y*b.zoomFactor;b=b.clientHeight*b.zoomFactor;w.top=
a;w.bottom=a+b;a=s.convert({y:a},"document","page").y;a-=w.node.getBoundingClientRect().top;p.style.top=a+"px";p.style.height=b-q+"px"}function g(a){a.wrapMode&&!a.wrapOffset&&h._metrics.charWidth?(a=b.createElement(l,"div"),a.style.position="fixed",a.style.left="-1000px",s._clientDiv.appendChild(a),a.innerHTML=Array(Math.ceil(h.getClientArea().width/h._metrics.charWidth)+1).join("a"),a=a.getBoundingClientRect(),a=Math.min(150,Math.ceil(a.right-a.left))+"px"):a="";var c=w.node.style.width;w.node.style.width=
a;return c!==a}function f(a,c,b){b||w.top<=a.y&&a.y<=w.bottom?(w.mouseDown=!0,w.delta=c-p.getBoundingClientRect().top+w.node.getBoundingClientRect().top):(a=s.getOffsetAtLocation(a.x,a.y),h.setSelection(a,a,0.5,function(){}))}function k(a){if(w.mouseDown){var b=c();a=Math.min(b.zoomClientHeight-b.windowHeight,Math.max(0,a-w.delta));h.setTopPixel(a*(b.documentHeight-b.clientHeight)/Math.min(b.zoomDocumentHeight,b.zoomClientHeight-b.windowHeight))}}var h=this.getView();if(h){var m=a(h.getOptions());
m.parent=this.node;var s=this._zoomView=new r.TextView(m);s._clientDiv.contentEditable=!1;s.setModel(h.getModel());var l=h.getOptions("parent").ownerDocument,p=this._windowDiv=b.createElement(l,"div");p.className="rulerZoomWindow";this.node.appendChild(p);var q=parseInt(d.getNodeStyle(p,"border-top-width",0))+parseInt(d.getNodeStyle(p,"border-bottom-width",0)),w=this;h.addEventListener("Scroll",this._scrollListener=function(a){e(a.newValue)});h.addEventListener("Resize",this._resizeListener=function(){g(s.getOptions());
e()});h.addEventListener("Redraw",this._redrawListener=function(a){a.ruler||s.redrawLines(a.startLine,a.endLine)});h.addEventListener("Options",this._optionsListener=function(c){c=a(c.options);s.setOptions(c);g(s.getOptions())});s.addEventListener("LineStyle",this._lineListener=function(a){h.onLineStyle(a)});b.isIOS||b.isAndroid?(p.addEventListener("touchstart",function(a){1===a.touches.length&&(f(a,a.touches[0].clientY,!0),a.preventDefault())}),p.addEventListener("touchend",function(a){0===a.touches.length&&
(w.mouseDown=!1)}),p.addEventListener("touchmove",function(a){1===a.touches.length&&k(a.touches[0].clientY)}),s.addEventListener("TouchStart",function(a){1===a.touchCount&&(f(a,a.event.touches[0].clientY),a.preventDefault())})):(p.style.pointerEvents="none",s.addEventListener("MouseDown",function(a){var c=a.event;(c.which?0===c.button:1===c.button)&&f(a,c.clientY);a.preventDefault()}),s.addEventListener("MouseUp",function(a){w.mouseDown=!1;a.preventDefault()}),s.addEventListener("MouseMove",function(a){k(a.event.clientY);
...
function(l,r,p,h,f,d,b,k,m,g,a){function s(a,b){this.textView=a;b&&(this.pageMessage=b.getService("orion.page.message"));this.state=c.INACTIVE;this.clearProviders();var e=this;this._textViewListeners={onModelChanging:function(a){(this._latestModelChangingEvent=a)&&this._updateFilterText(a)}.bind(this),onSelection:function(a){this.isDeactivatingChange(this._latestModelChangingEvent,a)?this.setState(c.INACTIVE):this.isActive()&&(this.state===c.ACTIVE&&this.setState(c.FILTERING),this.filterProposals());
this._latestModelChangingEvent=null}.bind(this),onScroll:function(a){this.setState(c.INACTIVE)}.bind(this)};a.setKeyBinding(m.isMac?new r.KeyBinding(" ",!1,!1,!1,!0):new r.KeyBinding(" ",!0),"contentAssist");a.setKeyBinding(m.isMac?new r.KeyBinding(" ",!1,!1,!0,!0):new r.KeyBinding(" ",!0,!1,!0),"contentAssist");a.setAction("contentAssist",function(){a.getOptions("readonly")||e.activate();return!0},{name:l.contentAssist})}function e(a,c){var b=a.textView;p.KeyMode.call(this,b);this.contentAssist=
a;this.widget=c;this.proposals=[];var e=this;this.contentAssist.addEventListener("ProposalsComputed",function(a){e.proposals=a.data.proposals;if(0===e.proposals.length)e.selectedIndex=-1,e.cancel();else{for(e.selectedIndex=0;e.proposals[e.selectedIndex]&&e.proposals[e.selectedIndex].unselectable;)e.selectedIndex++;if(e.proposals[e.selectedIndex]){if(e.widget){var b=!0;if(a.autoApply){for(a=e.selectedIndex+1;e.proposals[a]&&e.proposals[a].unselectable;)a++;e.proposals[a]||(b=!1,e.contentAssist.apply(e.proposals[e.selectedIndex]))}b&&
(e.widget.show(),e.widget.selectNode(e.selectedIndex))}}else e.selectedIndex=-1,e.cancel()}});b.setAction("contentAssistApply",function(){return this.enter()}.bind(this));b.setAction("contentAssistCancel",function(){return this.cancel()}.bind(this));b.setAction("contentAssistNextProposal",function(){return this.lineDown()}.bind(this));b.setAction("contentAssistPreviousProposal",function(){return this.lineUp()}.bind(this));b.setAction("contentAssistNextPage",function(){return this.pageDown()}.bind(this));
b.setAction("contentAssistPreviousPage",function(){return this.pageUp()}.bind(this));b.setAction("contentAssistHome",function(){this.widget&&this.widget.scrollIndex(0,!0);return this.lineDown(0)}.bind(this));b.setAction("contentAssistEnd",function(){return this.lineUp(this.proposals.length-1)}.bind(this));b.setAction("contentAssistTab",function(){return this.tab()}.bind(this));this.widget&&(this.widget.setContentAssistMode(this),this.widget.createAccessible())}function n(a,b){this.contentAssist=a;
this.textView=this.contentAssist.getTextView();this.isShowing=this.textViewListenerAdded=!1;var c=this.textView.getOptions("parent").ownerDocument;this.parentNode="string"===typeof b?c.getElementById(b):b;if(!this.parentNode){this.parentNode=m.createElement(c,"div");this.parentNode.className="contentassist";var e=c.getElementsByTagName("body")[0];if(e)e.appendChild(this.parentNode);else throw Error("parentNode is required");}k.addEventListener(this.parentNode,"scroll",this.onScroll.bind(this));var d=
this;this.textViewListener={onMouseDown:function(a){(a.event.target||a.event.srcElement).parentElement!==d.parentNode&&d.contentAssist.deactivate()}};this.contentAssist.addEventListener("Deactivating",function(a){d.hide()});this.scrollListener=function(a){d.isShowing&&d.position()};k.addEventListener(c,"scroll",this.scrollListener)}var c={INACTIVE:1,ACTIVE:2,FILTERING:3},u={selected:"selected",hr:"proposal-hr",emphasis:"proposal-emphasis",noemphasis:"proposal-noemphasis",noemphasis_keyword:"proposal-noemphasis-keyword",
noemphasis_title:"proposal-noemphasis-title",noemphasis_title_keywords:"proposal-noemphasis-title-keywords",dfault:"proposal-default"};s.prototype={apply:function(b){if(!b)return!1;var e=this.textView,d=e.getSelection(),g=this._initialCaretOffset,f=g,k=d=Math.max(d.start,d.end),n=e.getModel();n.getBaseModel&&(f=n.mapOffset(f),k=n.mapOffset(k),n=n.getBaseModel());b.overwrite&&(g="string"===typeof b.prefix?f-b.prefix.length:this.getPrefixStart(n,f));f={proposal:b,start:f,end:k};this.setState(c.INACTIVE);
e.setText("string"===typeof b?b:b.proposal,g,d);if(b.additionalEdits)for(d=0;d<b.additionalEdits.length;d++)g=b.additionalEdits[d],e.setText(g.text,g.offset,g.offset+g.length);this.dispatchEvent({type:"ProposalApplied",data:f});a.logEvent("contentAssist","apply");return!0},activate:function(b,e){this.state===c.INACTIVE&&(a.logEvent("contentAssist","activate",void 0,e?0:1),this._autoTriggered=e?!0:!1,this.setState(c.ACTIVE,b))},deactivate:function(){this.setState(c.INACTIVE)},getTextView:function(){return this.textView},
isActive:function(){return this.state===c.ACTIVE||this.state===c.FILTERING},isDeactivatingChange:function(a,b){var c=!1;(Array.isArray(b.newValue)?b.newValue:[b.newValue])[0].start<this._initialCaretOffset||!a?c=!0:a&&(c=0<a.removedLineCount||0<a.addedLineCount);return c},setState:function(a,b){var e;a===c.ACTIVE?(e="Activating",this._mode&&this._mode.setActive(!0)):a===c.INACTIVE&&(e="Deactivating",this._mode&&this._mode.setActive(!1));e&&this.dispatchEvent({type:e,providers:b});this.state=a;this.onStateChange(a)},
setMode:function(a){this._mode=a},onStateChange:function(a){a===c.INACTIVE?(this._removeTextViewListeners(),this._filterText="",this._initialCaretOffset=-1,this._computedProposals=null):a===c.ACTIVE&&(this._filterText="",this._addTextViewListeners(),this.computeProposals())},computeProposals:function(){var a=this.textView.getCaretOffset(),b=this.textView.getSelection(),b=Math.min(b.start,b.end);this._initialCaretOffset=Math.min(a,b);this._computedProposals=null;this._computeProposals(this._initialCaretOffset).then(function(a){if(this.isActive()){var b=
this._flatten(a);b&&(Array.isArray(b)&&0<b.length)&&(this._computedProposals=a);this.dispatchEvent({type:"ProposalsComputed",data:{proposals:b},autoApply:!this._autoTriggered});this._computedProposals&&this._filterText&&this.filterProposals(!0)}}.bind(this))},getPrefixStart:function(a,b){for(var c=b;0<c&&/[A-Za-z0-9_]/.test(a.getText(c-1,c));)c--;return c},handleError:function(a){"undefined"!==typeof console&&(console.log("Error retrieving content assist proposals"),console.log(a&&a.stack))},initialize:function(){this._providers.forEach(function(a){a=
a.provider;"function"===typeof a.initialize&&a.initialize()})},_computeProposals:function(a){var b=this._providers,c=this.textView,e=c.getSelection(),g=c.getModel(),k=a;g.getBaseModel&&(k=g.mapOffset(k),e.start=g.mapOffset(e.start),e.end=g.mapOffset(e.end),g=g.getBaseModel());a=g.getLine(g.getLineAtOffset(k));for(var n=0;n<a.length&&/\s/.test(a.charAt(n));)n++;var n=a.substring(0,n),c=c.getOptions("tabSize","expandTab"),c=c.expandTab?Array(c.tabSize+1).join(" "):"\t",h={line:a,offset:k,prefix:g.getText(this.getPrefixStart(g,
k),k),selection:e,delimiter:g.getLineDelimiter(),tab:c,indentation:n},m=this,b=b.map(function(a){a=a.provider;var b;try{var c,e;if(c=a.computeContentAssist){var n=m.editorContextProvider,t=n.getEditorContext();h=d.mixin(h,n.getOptions());e=c.apply(a,[t,h])}else if(c=a.getProposals||a.computeProposals)e=c.apply(a,[g.getText(),k,h]);b=m.progress?m.progress.progress(e,"Generating content assist proposal"):e}catch(l){return(new f).reject(l)}return f.when(b)}),b=f.all(b,this.handleError);this.pageMessage&&
(b=f.when(b,function(a){m.pageMessage.close();var b=!1;if(a&&0<a.length)for(var c=0;c<a.length;c++)if(0<a[c].length){b=!0;break}b||m.pageMessage.setErrorMessage(l.noProposals);return a}),m.pageMessage.showWhile(b,l.computingProposals));return b},filterProposals:function(a){if(this._computedProposals&&(this._latestModelChangingEvent||a)){a=this.textView.getModel();a.getBaseModel&&(a=a.getBaseModel());a=this.getPrefixStart(a,this._initialCaretOffset);var b=this.textView.getText(a,this._initialCaretOffset),
c=b,e=[];this._computedProposals.forEach(function(a){a&&Array.isArray(a)&&(a=a.filter(function(a){if(!a)return!1;c="string"===typeof a.prefix?a.prefix:b;if(u[a.style]===u.hr||u[a.style]===u.noemphasis_title)return!0;var e="";if(a.overwrite){if(a.name)e=a.name;else if(a.proposal)e=a.proposal;else return!1;return 0===e.indexOf(c+this._filterText)}return a.name||a.proposal?(e=!1,a.name&&(e=0===a.name.indexOf(c+this._filterText)),!e&&a.proposal&&(e=0===a.proposal.indexOf(this._filterText)),e):"string"===
typeof a?0===a.indexOf(this._filterText):!1},this),0<a.length&&e.push(a))},this);a=[];e&&(e=this._removeExtraUnselectableElements(e),a=this._flatten(e));this.dispatchEvent({type:"ProposalsComputed",data:{proposals:a},autoApply:!1})}},_removeExtraUnselectableElements:function(a){return a.map(function(a){return a.filter(function(b,c){var e=!0;if(u[b.style]===u.hr)0===c||a.length-1===c?e=!1:u.hr===u[a[c-1].style]&&(e=!1);else if(u[b.style]===u.noemphasis_title){var d=a[c+1];d?u[d.style]===u.noemphasis_title&&
(e=!1):e=!1}return e})})},setEditorContextProvider:function(a){this.editorContextProvider=a},_generateProviderId:function(){this._idcount?this._idcount++:this._idcount=0;return"ContentAssistGeneratedID_"+this._idcount},setAutoTriggerEnabled:function(a){this._autoTriggerEnabled=a;this._updateAutoTriggerListenerState()},setProviders:function(a){var b=this;this.setProviderInfoArray(a.map(function(a){return a.id?a:{provider:a,id:b._generateProviderId()}}))},setProviderInfoArray:function(a){this.clearProviders();
this._providers=a;this._charTriggersInstalled=a.some(function(a){return a.charTriggers});this._updateAutoTriggerListenerState()},getProviders:function(){return this._providers.slice()},clearProviders:function(){this._providers=[];this._charTriggersInstalled=!1;this._updateAutoTriggerListenerState()},setProgress:function(a){this.progress=a},setStyleAccessor:function(a){this._styleAccessor=a},_flatten:function(a){return a.reduce(function(a,b){var c=a,e=null;b&&Array.isArray(b)&&(e=b.filter(function(a){return a}));
if(e&&Array.isArray(e)&&0<e.length){var c=e,d=a,g=e[0].style;g&&(u[g]&&0===u[g].indexOf(u.noemphasis))&&(c=a,d=e);0<c.length&&(e=c[c.length-1].style)&&u.hr!==u[e]&&(c=c.concat({proposal:"",name:"",description:"---------------------------------",style:"hr",unselectable:!0}));c=c.concat(d)}return c},[])},_triggerListener:function(){var a=this.textView.getCaretOffset(),b=null,c=[];if(this._charTriggersInstalled){var e=this.textView.getText(a-1,a);this._providers.forEach(function(d){var g=d.charTriggers;
if(g&&g.test(e)){var g=!1,f=d.excludedStyles;this._styleAccessor&&f&&(b||(b=this._styleAccessor.getStyles(a-1)),g=b.some(function(a){return f.test(a.style)}));g||c.push(d)}},this);0<c.length&&this.activate(c,!0)}},_updateAutoTriggerListenerState:function(){this._boundTriggerListener||(this._boundTriggerListener=this._triggerListener.bind(this));if(this._triggerListenerInstalled){if(!this._autoTriggerEnabled||!this._charTriggersInstalled)this.textView.removeEventListener("Modify",this._boundTriggerListener),
...
a=window.getComputedStyle(this.parentNode);var d=window.getComputedStyle(b),d=parseInt(a.paddingLeft)+parseInt(a.paddingRight)+parseInt(d.paddingLeft)+parseInt(d.paddingRight);if(c.width>=e-d){d=parseInt(a.top);e=b.cloneNode(!0);e.classList.add("cloneProposal");e.style.top=d+b.offsetTop-this.parentNode.scrollTop+"px";e.style.left=a.left;e.setAttribute("id",e.id+"_clone");c=c.left+c.width-parseInt(document.documentElement.clientWidth);0<c&&(a=parseInt(a.left)-c,0>a&&(a=0),e.style.left=a+"px");var g=
document.createElement("div");g.id="clone_contentassist";g.classList.add("contentassist");g.classList.add("cloneWrapper");g.appendChild(e);g.onclick=this.parentNode.onclick;this.parentNode.parentNode.insertBefore(g,this.parentNode);var f=function(a){a.contentAssistProposalIndex=b.contentAssistProposalIndex;if(a.hasChildNodes())for(var c=0;c<a.childNodes.length;c++)f(a.childNodes[c])};f(g);var k=this;this._hideTimeout=window.setTimeout(function(){k._hideTimeout=null;b.classList.add(u.selected);var a=
1;k._fadeTimer=window.setInterval(function(){!k.previousCloneNode||0.01>=a?(k._removeCloneNode(),window.clearInterval(k._fadeTimer),k._fadeTimer=null):(g.style.opacity=a,g.style.filter="alpha(opacity\x3d"+100*a+")",a-=0.1*a)},50)},1500);b.classList.remove(u.selected);this.previousCloneNode=g}}this.previousSelectedNode=b},setContentAssistMode:function(a){this._contentAssistMode=a},show:function(){var a=this._contentAssistMode.getProposals();if(0===a.length)this.hide();else{this.parentNode.innerHTML=
...
!1,!1,!1,!1,"keypress"),predefined:!0});return a},getKeyBindings:function(a){var e=r.KeyMode.prototype.getKeyBindings.call(this,a),e=e||[],g=this.changeMode.getKeyBindings(a),f;if(!this.changeMode.isActive())for(f=0;f<g.length;f++)g[f]=b([d("c",!1,!1,!1,!1,"keypress"),g[f]]);e=e.concat(g);g=this.deleteMode.getKeyBindings(a);if(!this.deleteMode.isActive())for(f=0;f<g.length;f++)g[f]=b([d("d",!1,!1,!1,!1,"keypress"),g[f]]);e=e.concat(g);g=this.yankMode.getKeyBindings(a);if(!this.yankMode.isActive())for(f=
0;f<g.length;f++)g[f]=b([d("y",!1,!1,!1,!1,"keypress"),g[f]]);return e=e.concat(g)},match:function(a){var b=r.KeyMode.prototype.match.call(this,a);!b&&"keypress"===a.type&&(b="noop");return b},_createActions:function(a){k.prototype._createActions.call(this,a);var b=this;a.setAction("vi-ctrl-f",function(){return b._invoke("pageDown")},{name:l.pageDown});a.setAction("vi-ctrl-b",function(){return b._invoke("pageUp")},{name:l.pageUp});a.setAction("vi-ctrl-e",function(){return b._invoke("scrollLineDown")},
{name:l.scrollLineDown});a.setAction("vi-ctrl-y",function(){return b._invoke("scrollLineUp")},{name:l.scrollLineUp});a.setAction("vi-a",function(){return b._toInsertMode("charNext")},{name:l.via});a.setAction("vi-A",function(){return b._toInsertMode("lineEnd")},{name:l.viA});a.setAction("vi-i",function(){return b._toInsertMode("noop")},{name:l.vii});a.setAction("vi-I",function(){return b._toInsertMode("lineStart")},{name:l.viI});a.setAction("vi-O",function(){b._invoke("lineUp");b._invoke("lineEnd");
b._toInsertMode("enter");return!0},{name:l.viO});a.setAction("vi-o",function(){b._invoke("lineEnd");b._toInsertMode("enter");return!0},{name:l.vio});a.setAction("vi-R",function(){return b._toInsertMode("toggleOverwriteMode")},{name:l.viR});a.setAction("vi-s",function(){return b._toInsertMode("deleteNext",{unit:"char"})},{name:l.vis});a.setAction("vi-S",function(){return b._toInsertMode("deleteLines",{unit:"line"})},{name:l.viS});a.setAction("vi-p",function(){return b._invoke(function(){var a=b.getView(),
c=a.getSelection();if(c.start===c.end){var d=a.getModel(),g=a.getCaretOffset();n?c.start=c.end=d.getLineEnd(d.getLineAtOffset(g),!0):(c.start++,c.end++)}a.setText(e,c.start,c.end)})},{name:l.vip});a.setAction("vi-P",function(){return b._invoke(function(){var a=b.getView(),c=a.getSelection();if(c.start===c.end){var d=a.getModel(),g=a.getCaretOffset();n&&(c.start=c.end=d.getLineStart(d.getLineAtOffset(g)))}a.setText(e,c.start,c.end)})},{name:l.viP});a.setAction("vi-u",function(){return b._invoke("undo")},
{name:l.Undo});a.setAction("vi-c",function(){a.removeKeyMode(b);a.addKeyMode(b.changeMode);b.changeMode.storeNumber(b.number);b.number="";return!0});a.setAction("vi-d",function(){a.removeKeyMode(b);a.addKeyMode(b.deleteMode);b.deleteMode.storeNumber(b.number);b.number="";return!0});a.setAction("vi-y",function(){a.removeKeyMode(b);a.addKeyMode(b.yankMode);b.yankMode.storeNumber(b.number);b.number="";return!0});a.setAction("vi-~",function(){return b._invoke("reversecase")},{name:l.reversecase});a.setAction("vi-x",
function(){return b._invoke("deleteNext")},{name:l.deleteNext});a.setAction("vi-X",function(){return b._invoke("deletePrevious")},{name:l.deletePrevious});a.setAction("vi-C",function(){return b._toInsertMode("deleteLineEnd")},{name:l.viC});a.setAction("vi-D",function(){return b._invoke("deleteLineEnd")},{name:l.deleteLineEnd});a.setAction("vi-*",function(){var a=b.getView(),c=a.getCaretOffset(),c=a.getNextOffset(c+1,{count:-1,unit:"word"}),e=a.getNextOffset(c,{count:1,unit:"wordend"}),a=a.getText(c,
e);b._searchFwd=!0;return b._invoke("find",{hideAfterFind:!0,incremental:!1,reverse:!1,findString:a})},{name:l.viStar})},_reportStatus:function(a){this.statusReporter&&this.statusReporter(a)},_toInsertMode:function(a,b){b=b||{};var e=1;""!==this.number&&(e=this.number>>0);b.count=e;e=this.getView();this.insertMode.storeNumber(this.number);e.invokeAction(a,!1,b);e.removeKeyMode(this);e.addKeyMode(this.insertMode);this.number="";return!0},_modeAdded:function(){this.getView().setOptions({blockCursorVisible:!0})},
...
b);}function h(a,b,e){for(var d=[],c=0;c<a.length;c++)"undefined"!==typeof a[c]&&d.push(p(a[c],b));return d.join(e)}function f(a,b,e,d){for(var c=Object.keys(a),g=[],f=0;f<c.length;f++)"undefined"!==typeof a[c[f]]&&g.push(p(c[f],b)+e+p(a[c[f]],b));return g.join(d)}function d(a){if(0===a.length)throw Error("Invalid Expression: 0 length expression");(this._operator=k[a[0]])?a=a.substring(1):this._operator=k.NUL;for(var b=[],e=a.split(","),d=0;d<e.length;d++){var c=e[d].match(m);if(null===c)throw Error("Bad VarSpec: "+
a);b.push({name:c[1],explode:!!c[2],prefix:c[3]?parseInt(c[3],10):-1})}this._varSpecList=b}function b(a){for(var b=[],e=0,g=a.indexOf("{",e);-1!==g;){b.push(new l(a.substring(e,g)));e=a.indexOf("}",g+1);if(-1===e)throw Error("Invalid template: "+a);b.push(new d(a.substring(g+1,e)));e+=1;g=a.indexOf("{",e)}b.push(new l(a.substring(e)));this._templateComponents=b}var k={NUL:{first:"",sep:",",named:!1,ifemp:"",allow:"U"},"+":{first:"",sep:",",named:!1,ifemp:"",allow:"U+R"},".":{first:".",sep:",",named:!1,
ifemp:"",allow:"U"},"/":{first:"/",sep:"/",named:!1,ifemp:"",allow:"U"},";":{first:";",sep:";",named:!0,ifemp:"",allow:"U"},"?":{first:"?",sep:"\x26",named:!0,ifemp:"\x3d",allow:"U"},"\x26":{first:"\x26",sep:"\x26",named:!0,ifemp:"\x3d",allow:"U"},"#":{first:"#",sep:",",named:!1,ifemp:"",allow:"U+R"},",":{first:"",sep:",",named:!1,ifemp:"",allow:"U+R-,"}},m=/^((?:(?:[a-zA-Z0-9_])|(?:%[0-9A-F][0-9A-F]))(?:(?:[a-zA-Z0-9_.])|(?:%[0-9A-F][0-9A-F]))*)(?:(\*)|:([0-9]+))?$/,g=/%25[0-9A-F][0-9A-F]/g;l.prototype=
{expand:function(a){return encodeURI(this._text)}};d.prototype={expand:function(a){for(var b=[],e=0;e<this._varSpecList.length;e++){var d=this._varSpecList[e],c=d.name,g=a[c],k=typeof g;if("undefined"!==k&&null!==g){var m=0===b.length?this._operator.first:this._operator.sep;if("string"===k)this._operator.named&&(m+=p(c,"U+R"),m+=0===g.length?this._operator.ifemp:"\x3d"),-1!==d.prefix&&d.prefix<g.length&&(g=g.substring(0,d.prefix)),m+=p(g,this._operator.allow);else if(Array.isArray(g)){if(0===g.length)continue;
d.explode?m+=h(g,this._operator.allow,this._operator.sep):(d=h(g,this._operator.allow,","),this._operator.named&&(m+=p(c,"U+R"),m+=0===d.length?this._operator.ifemp:"\x3d"),m+=d)}else if("object"===k){if(0===Object.keys(g).length)continue;d.explode?m+=f(g,this._operator.allow,"\x3d",this._operator.sep):(d=f(g,this._operator.allow,",",","),this._operator.named&&(m+=p(c,"U+R"),m+=0===d.length?this._operator.ifemp:"\x3d"),m+=d)}else throw Error("bad param type: "+c+" : "+k);b.push(m)}}return b.join("")}};
b.prototype={expand:function(a){for(var b=[],e=0;e<this._templateComponents.length;e++)b.push(this._templateComponents[e].expand(a));return b.join("")}};return b});y("orion/PageLinks","require orion/Deferred orion/PageUtil orion/URITemplate orion/i18nUtil orion/objects orion/URL-shim".split(" "),function(l,r,p,h,f,d){function b(){if(l.toUrl){var a=new URL(l.toUrl("orion/"),self.location.href);return(new URL("../",a)).href.slice(0,-1)}return(new URL("/",self.location.href)).href.slice(0,-1)}function k(a){var b=
{};a.getPropertyKeys().forEach(function(e){"objectClass"!==e&&("service.names"!==e&&"service.id"!==e&&"__plugin__"!==e)&&(b[e]=a.getProperty(e))});return b}function m(a,c){var e=a.getServiceReferences(c||"orion.page.link"),d=p.matchResourceParameters(window.location.href),g={OrionHome:b(),Location:d.resource},f=[];e.forEach(function(a){a=k(a);if(a.uriTemplate&&(a.nls||a.name)){var b=(new h(a.uriTemplate)).expand(g),b=p.validateURLScheme(b);a.href=b;a.textContent=a.name||a.nameKey;f.push((new r).resolve(a))}});
return r.all(f)}function g(a){var b=this.categories=Object.create(null);a.forEach(function(a){b[a.id]=a})}function a(a){this.allPageLinks=a;this.allPageLinks.sort(s)}function s(a,b){var e=a.textContent&&a.textContent.toLowerCase(),d=b.textContent&&b.textContent.toLowerCase();return e<d?-1:e>d?1:0}var e;d.mixin(g.prototype,{getCategoryIDs:function(){return Object.keys(this.categories)},getCategory:function(a){return this.categories[a]||null}});d.mixin(a.prototype,{createLinkElements:function(){return this.allPageLinks.map(function(a){var b=
...
var b=a.constructor(),d;for(d in a)"children"!==d&&"Children"!==d&&(b[d]=n(a[d]));return b};m._getOpenWithNavCommandExtensions=function(a,b){function d(a,b){for(var c=a.getServiceReferences("orion.navigate.openWith"),g=[],f=[],k=0;k<c.length;k++){var h=c[k];if(h.getProperty("editor")===b.id){var n=h.getProperty("contentType");n instanceof Array?g=g.concat(n):g.push(n||"*/*");h=h.getProperty("excludedContentTypes");h instanceof Array?f=f.concat(h):null!==h&&"undefined"!==typeof h&&f.push(h)}}0===g.length&&
(g=null);0===f.length&&(f=null);return{contentTypes:g,excludedContentTypes:f}}for(var g=function(){for(var b=a.getServiceReferences("orion.edit.editor"),c=[],d=0;d<b.length;d++){var g=b[d],f=g.getProperty("id");c.push({id:f,"default":g.getProperty("default")||!1,name:g.getProperty("name"),nameKey:g.getProperty("nameKey"),nls:g.getProperty("nls"),uriTemplate:g.getProperty("orionTemplate")||g.getProperty("uriTemplate"),validationProperties:g.getProperty("validationProperties")||[]})}return c}(),f=[],
k,h=0;h<g.length;h++){var m=g[h],l=d(a,m),l={properties:{name:m.name||m.id,nameKey:m.nameKey,id:"eclipse.openWithCommand."+m.id,contentType:l.contentTypes,excludedContentTypes:l.excludedContentTypes,uriTemplate:m.uriTemplate,nls:m.nls,forceSingleItem:!0,isEditor:m["default"]?"default":"editor",validationProperties:m.validationProperties},service:{}};"orion.editor"===m.id?k=l:f.push(l)}k&&f.push(k);return f};m._makeValidator=function(a,b,d,f){function k(a,b,c,d,g){var f=!1,h;if("!"===b.charAt(0))return"undefined"===
typeof a[b.substring(1)];if("undefined"!==typeof a[b]){if("undefined"===typeof c)h=a[b],f=!0;else if("string"===typeof c){if(!typeof("string"===a[b]))return!1;if(d.variableName){if(c=RegExp(c).exec(a[b]))f=c[0],h="before"===d.variableMatchPosition?a[b].substring(0,c.index):"after"===d.variableMatchPosition?a[b].substring(c.index+f.length):"only"===d.variableMatchPosition?f:a[b],f=!0}else return RegExp(c).test(a[b])}else a[b]===c&&(h=a[b],f=!0);b=d.variableName;d=d.replacements;if(f&&b&&(g[b]=h,g.itemCached=
a,d)){if("string"!==typeof h)return window.console.log("Cannot replace "+b+", value is not a string: "+h),f;for(a=0;a<d.length;a++){h=!1;if(d[a].pattern){c=d[a].pattern;var n=d[a].replacement||"";g[b]=g[b].replace(RegExp(c),n).replace(RegExp(c),n)}else h=!0;h&&window.console.log("Invalid replacements specified in validation property.  "+d[a])}}return f}return!1}function m(a,b,c,d){var g=c.match,f,h;if(0<=(f=b.indexOf("["))){if(0>(h=b.indexOf("]")))return!1;var n=b.substring(0,f),l;if(!(l=a[n])||!Array.isArray(l))return!1;
...
typeof f.source){if(!m(b,f.source,f,d))return!1}else return window.console.log("Invalid validationProperties in "+a.id+".  No source property specified."),!1}if(!d.info.contentType&&!d.info.excludedContentTypes)return!0;if(b.Directory)return d.info.contentType&&0<=d.info.contentType.indexOf("*/*")?!0:!1;var g=!0,k=c?p.getFilenameContentType(b.Name,c):null,k=k||{id:"application/octet-stream"};d.info.excludedContentTypes&&c&&(g=d.info.excludedContentTypes.every(function(a){a=a.replace(/([*?])/g,".$1");
return-1!==k.id.search(a)?!1:!0}));g&&(d.info.contentType&&c)&&(g=d.info.contentType.some(function(a){a=a.replace(/([*?])/g,".$1");return-1!==k.id.search(a)?!0:!1}));return g}return{info:a,validationFunction:function(a){"function"===typeof f&&(a=f.call(this,a));if(a){if(Array.isArray(a)){if((this.info.forceSingleItem||this.info.uriTemplate)&&1!==a.length||1>a.length)return!1}else a=[a];for(var b=0;b<a.length;b++)if(!l(a[b],d,this))return!1;return!0}return!1},generatesURI:function(){return!!this.info.uriTemplate},
getURI:function(a){if(this.info.uriTemplate){var b={},c;for(c in a)Object.prototype.hasOwnProperty.call(a,c)&&(b[c]=a[c]);if(this.info.validationProperties)for(c=0;c<this.info.validationProperties.length;c++){var d=this.info.validationProperties[c];d.source&&d.variableName&&(this.itemCached===a&&this[d.variableName]||m(a,d.source,d,this),a[d.variableName]?window.console.log("Variable name "+d.variableName+" in the extension "+this.info.id+" conflicts with an existing property in the item metadata."):
b[d.variableName]=this[d.variableName])}b.OrionHome=g;return(new h(this.info.uriTemplate)).expand(b)}return null}}};var a=b.UnnamedCommand;m._createCommandOptions=function(b,c,d,g,f,k){var h=new l;(function(a,h){var l=m._makeValidator(b,d,g,k);a.visibleWhen=l.validationFunction.bind(l);f&&(l.generatesURI.bind(l)()?a.hrefCallback=function(a){a=Array.isArray(a.items)?a.items[0]:a.items;return l.getURI.bind(l)(a)}:a.callback=function(g){var f;if(b.forceSingleItem)g=Array.isArray(g.items)?g.items[0]:
g.items,f=m._cloneItemWithoutChildren(g);else if(Array.isArray(g.items)){f=[];for(var k=0;k<g.items.length;k++)f.push(m._cloneItemWithoutChildren(g.items[k]))}else f=m._cloneItemWithoutChildren(g.items);if(d)var h=d.getService("orion.page.progress");c.run?h?h.progress(c.run(f),"Running command: "+a.name):c.run(f):d&&(h?h.progress(d.getService(c).run(f),"Running command: "+a.name):d.getService(c).run(f))});h.resolve(a)})({name:b.name||b.nameKey||a,image:b.image,id:b.id||b.name,tooltip:b.tooltip||b.tooltipKey||
"",isEditor:b.isEditor,showGlobally:b.showGlobally},h);return h};m.getOpenWithCommand=function(a,b,d){var g;a=d||m.getOpenWithCommands(a);for(d=0;d<a.length;d++)if(a[d].visibleWhen(b)){var f="default"===a[d].isEditor;if(!g||f)if(g=a[d],f)break}return g};m.getOpenWithCommands=function(a){var b=[],d;for(d in a._commandList){var g=a._commandList[d];g.isEditor&&b.push(g)}return b};var s;m.createAndPlaceFileCommandsExtension=function(a,c,d,g,f,k){return m.createFileCommands(a,null,k?"all":void 0,!!k,c).then(function(a){f&&
0<a.length&&(c.addCommandGroup(d,"eclipse.openWith",1E3,b.OpenWith,f,null,null,null,"dropdownSelection"),c.addCommandGroup(d,"eclipse.fileCommandExtensions",1E3,b.OpenRelated,f));a.forEach(function(a){var b=null;f&&(b=a.isEditor?f+"/eclipse.openWith":f+"/eclipse.fileCommandExtensions");c.registerCommandContribution(d,a.id,g,b)});return{}})};m.createFileCommands=function(a,b,d,g,f){d=void 0===d?"global":d;g=void 0===g?!0:g;var k=[];m._cachedFileCommands||m._createCachedFileCommands(a);("all"===d||
"global"===d)&&m._cachedFileCommands.forEach(function(a){var b=a.properties;("all"===d||b.forceSingleItem&&b.showGlobally)&&k.push(a)});return l.when(function(){var d=a.getService("orion.core.contentTypeRegistry")||b;return s||l.when(d.getContentTypes(),function(a){return s=a})}(),function(){g&&(m._cachedOpenWithExtensions||(m._cachedOpenWithExtensions=m._getOpenWithNavCommandExtensions(a,s)),k=k.concat(m._cachedOpenWithExtensions),f._addedOpenWithCommands=g);var b=k.map(function(b){var c=b.properties;
b=b.service;var d=f.findCommand(c.id||c.name);return d?(new l).resolve(d):m._createCommandOptions(c,b,a,s,!0).then(function(a){a=new r.Command(a);f.addCommand(a);return a})});return l.all(b,function(a){return{_error:a}}).then(function(a){return a})})};m._createCachedFileCommands=function(a){var b=a.getServiceReferences("orion.navigate.command");m._cachedFileCommands=[];for(var d=0;d<b.length;d++)if("orion.navigateFromMetadata"!==b[d].getProperty("id")){var g=a.getService(b[d]),f=k(b[d]);m._cachedFileCommands.push({properties:f,
service:g})}};m.getFileCommandIds=function(){var a=[];if(m._cachedFileCommands)m._cachedFileCommands.length&&(a=m._cachedFileCommands.map(function(a){return a.properties.id}));else throw"extensionCommandUtils._cachedFileCommands is not initialized";return a};m.createOpenWithCommands=function(a,b,d){return d&&d._addedOpenWithCommands?(new l).resolve(m.getOpenWithCommands(d)):m.createFileCommands(a,b,"none",!0,d)};return m});y("orion/searchUtils",["i18n!orion/nls/messages","require","orion/regex","orion/URITemplate"],
function(l,r,p,h){function f(b,d,f){var g="";f&&(g="^");if(g=p.parse("/"+g+b.searchStr+"/"))f=g.pattern,g=g.flags,-1===g.indexOf("i")&&!d.caseSensitive&&(g+="i"),b.regExp={pattern:f,flags:g},b.wildCard=!0}var d={ALL_FILE_TYPE:"*.*",getSearchParams:function(b,f,h){if(b){var g=!0;"*"===f&&(f="");""===f&&(g=h&&h.type!==d.ALL_FILE_TYPE);if(g)return b.createSearchParams(f,!1,!1,h)}else window.alert(l.NoSearchAvailableErr);return null},generateSearchHelper:function(b,k){var h=b.keyword,g=h,a={};b.fileType&&
(b.fileType!==d.ALL_FILE_TYPE&&""===h)&&(g="*."+b.fileType);if(b.regEx)a.searchStr=h,f(a,b,k);else{var l=-1<h.indexOf("*"),e=-1<h.indexOf("?");l&&(h=h.split("*").join(".*"));e&&(h=h.split("?").join("."));!l&&!e&&!b.nameSearch?(a.searchStr=b.caseSensitive?h.split("\\").join(""):h.split("\\").join("").toLowerCase(),a.wildCard=!1):(a.searchStr=b.caseSensitive?h:h.toLowerCase(),f(a,b,k),a.wildCard=!0)}a.searchStrLength=a.searchStr.length;return{params:b,inFileQuery:a,displayedSearchTerm:g}},convertSearchParams:function(b){void 0!==
b.rows&&(b.rows=parseInt(b.rows,10));void 0!==b.start&&(b.start=parseInt(b.start,10));"string"===typeof b.regEx&&(b.regEx="true"===b.regEx.toLowerCase());"string"===typeof b.caseSensitive&&(b.caseSensitive="true"===b.caseSensitive.toLowerCase());"string"===typeof b.nameSearch&&(b.nameSearch="true"===b.nameSearch.toLowerCase());void 0!==b.fileNamePatterns&&(b.fileNamePatterns=d.getFileNamePatternsArray(b.fileNamePatterns))},getFileNamePatternsArray:function(b){var d=void 0;b&&(b=b.trim(),b=b.replace(/^(\s*,\s*)+/g,
""),b=b.replace(/([^\\]),(\s*,\s*)*/g,"$1/"),b=b.replace(/(\s*\/\s*)/g,"/"),b=b.replace(/\/\/+/g,"/"),b=b.replace(/\/+$/g,""),d=b.split("/"));return d},copySearchParams:function(b,d){var f={},g;for(g in b)if(void 0!==b[g]&&null!==b[g]&&(d||"replace"!==g))f[g]=b[g];return f},generateFindURLBinding:function(b,d,f,g,a){b={find:d.searchStr,regEx:d.wildCard?!0:void 0,caseSensitive:b.caseSensitive?!0:void 0,replaceWith:"string"===typeof g?g:void 0,atLine:"number"===typeof f?f:void 0};return a?b:","+(new h("{,params*}")).expand({params:b})},
convertFindURLBinding:function(b){"string"===typeof b.regEx&&(b.regEx="true"===b.regEx.toLowerCase());"string"===typeof b.caseSensitive&&(b.caseSensitive="true"===b.caseSensitive.toLowerCase());"string"===typeof b.atLine&&(b.atLine=parseInt(b.atLine,10))},replaceRegEx:function(b,d,f){return b.replace(RegExp(d.pattern,d.flags),f)},replaceStringLiteral:function(b,f,h){f=p.parse("/"+f+"/gim");return d.replaceRegEx(b,f,h)},searchOnelineLiteral:function(b,d,f){var g;g=0;for(var a=!1,h=[];!(g=d.indexOf(b.searchStr,
g),0>g);){h.push({startIndex:g,length:b.searchStrLength});a=!0;if(f)break;g+=b.searchStrLength}return a?h:null},findRegExp:function(b,d,f,g){if(!d)return null;f=f||"";f+=(-1===f.indexOf("g")?"g":"")+(-1===f.indexOf("m")?"m":"");var a=null;return(a=RegExp(d,f).exec(b.substring(g)))&&{startIndex:a.index+g,length:a[0].length}},searchOnelineRegEx:function(b,f,h){for(var g=0,a=!1,l=[];;)if(g=d.findRegExp(f,b.regExp.pattern,b.regExp.flags,g)){l.push(g);a=!0;if(h)break;g=g.startIndex+g.length}else break;
return a?l:null},generateNewContents:function(b,f,h,g,a,l){if(g&&f){b||(h.contents=[]);for(var e=0;e<f.length;e++){for(var n=f[e],c=!1,u=!1,t=[],p,r=0,F=0;F<g.children.length;F++)if(g.children[F].lineNumber-1===e){r=F;for(c=0;c<g.children[F].matches.length;c++)!1!==g.children[F+c].checked&&t.push(c);u=0<t.length;p=g.children[F].matches;c=!0;break}if(c){if(u){t=d.replaceCheckedMatches(n,a,p,t,l);n=t.replacedStr;for(c=0;c<g.children[r].matches.length;c++)g.children[r+c].newMatches=t.newMatches}else for(c=
0;c<g.children[r].matches.length;c++)g.children[r+c].newMatches=g.children[r+c].matches;b?h.contents[e]=n:h.contents.push(n)}else b||h.contents.push(n)}}},generateMatchContext:function(b,d,f){var g=[],a=2*b+1,h;d.length<=a?(h=0,b=d.length-1):(h=f-b,0>h?(h=0,b=h+a-1):(b=f+b,b>d.length-1&&(b=d.length-1,h=b-a+1)));for(a=h;a<=b;a++)g.push({context:d[a],current:a===f});return g},splitFile:function(b){for(var d=0,f=0,g=0,a=0,h=[];;){-1!==d&&d<=g&&(d=b.indexOf("\r",g));-1!==f&&f<=g&&(f=b.indexOf("\n",g));
if(-1===f&&-1===d){h.push(b.substring(a));break}var e=1;-1!==d&&-1!==f?d+1===f?(e=2,g=f+1):g=(d<f?d:f)+1:g=-1!==d?d+1:f+1;h.push(b.substring(a,g-e));a=g}return h},searchWithinFile:function(b,f,h,g,a,l){h=d.splitFile(h);a&&(f.contents=h);if(f){f.children=[];for(var e=g=0;e<h.length;e++){var n=h[e];if(n&&0<n.length){var c=l?n:n.toLowerCase();if(c=b.wildCard?d.searchOnelineRegEx(b,c):d.searchOnelineLiteral(b,c)){var u,t=e+1;if(a)for(var p=0;p<c.length;p++)u=p+1,u={parent:f,checked:f.checked,type:"detail",
matches:c,lineNumber:t,matchNumber:u,name:n,location:f.location+"-"+t+"-"+u},f.children.push(u);else u={parent:f,context:d.generateMatchContext(2,h,e),checked:f.checked,type:"detail",matches:c,lineNumber:t,name:n,location:f.location+"-"+t},f.children.push(u);g+=c.length}}}f.totalMatches=g}},replaceCheckedMatches:function(b,d,f,g,a){for(var h=0,e="",n=[],c=0;c<f.length;c++){h!==f[c].startIndex&&(e+=b.substring(h,f[c].startIndex));f[c].length&&(a=f[c].length);for(var h=!1,l=0;l<g.length;l++)if(g[l]===
c){h=!0;break}h?(n.push({startIndex:e.length,length:d.length}),e+=d):(n.push({startIndex:e.length,length:a}),e+=b.substring(f[c].startIndex,f[c].startIndex+a));h=f[c].startIndex+a}h<b.length&&(e+=b.substring(h));return{replacedStr:e,newMatches:n}},fullPathNameByMeta:function(b){var d=b.length,f="";if(0<d)for(d-=1;-1<d;d--)f=f+(""===f?"":"/")+b[d].Name;return f}};return d});y("orion/editorCommands","i18n!orion/edit/nls/messages orion/i18nUtil orion/webui/littlelib orion/webui/dialogs/OpenResourceDialog orion/widgets/input/DropDownMenu orion/Deferred orion/URITemplate orion/commands orion/keyBinding orion/commandRegistry orion/extensionCommands orion/contentTypes orion/searchUtils orion/objects orion/PageUtil orion/PageLinks orion/editor/annotations orion/regex orion/uiUtils orion/util".split(" "),
function(l,r,p,h,f,d,b,k,m,g,a,s,e,n,c,u,t,v,A,F){function z(a){var c=new b(a.uriTemplate),d=a.params||{};d.OrionHome=d.OrionHome||u.getOrionHome();var c=c.expand(d),e=document.createElement("div"),g=document.createElement("iframe");g.id=a.id;g.name=a.id;g.type="text/html";g.sandbox="allow-scripts allow-same-origin allow-forms allow-popups";g.frameborder=void 0!==a.border?a.border:1;g.src=c;g.className="delegatedUI";a.width&&(e.style.width=a.width,g.style.width=a.width);a.height&&(e.style.height=
a.height,g.style.height=a.height);g.style.visibility="hidden";null!==a.parent&&(a.parent||window.document.body).appendChild(e);e.appendChild(g);g.style.left=a.left||(window.innerWidth-parseInt(g.clientWidth,10))/2+"px";g.style.top=a.top||(window.innerHeight-parseInt(g.clientHeight,10))/2+"px";g.style.visibility="";window.addEventListener("message",function H(b){if(b.source===g.contentWindow&&"string"===typeof b.data&&(b=JSON.parse(b.data),"orion.page.delegatedUI"===b.pageService&&b.source===a.id)){if(b.cancelled)a.cancelled&&
a.cancelled();else if(b.result)a.done&&a.done(b.result);else if(b.Status||b.status)a.status&&a.status(b.Status||b.status);window.removeEventListener("message",H,!1);e.parentNode&&e.parentNode.removeChild(e)}},!1);return e}function y(a,b){b&&"undefined"!==typeof b.HTML&&delete b.HTML;var c=a.getService("orion.page.message");if(c)return c.setProgressResult(b).then(null,function(a){console.log(a);throw a;});console.log(b);return(new d).resolve(b)}function B(a){return{_error:a}}function C(a){this.serviceRegistry=
...
a;if(a.getTextView&&a.getTextView()){var c=a.getTextView();c.setKeyBinding(new m.KeyBinding("s",!0),"save");var d=b.commandService.findCommand("orion.edit.save");c.setAction("save",function(){d.callback.call({inputManager:b.inputManager});return!0},d);c.setAction("gotoLine",function(c){if(c)return a.onGotoLine(c.line-1,0,void 0,c.callback),!0;b.commandService.runCommand("orion.edit.gotoLine");return!0},b.commandService.findCommand("orion.edit.gotoLine"));this.textSearcher&&c.setAction("find",function(a){if(a)return b.textSearcher.show(a),
!0;b.commandService.runCommand("orion.edit.find",null,null,new g.ParametersDescription([new g.CommandParameter("useEditorSelection","text","","true")],{clientCollect:!0}));return!0},b.commandService.findCommand("orion.edit.find"))}},showKeyBindings:function(a){var b=this.editor;if(b&&b.getTextView&&b.getTextView()){var c=b.getTextView(),d=c.getActions(!0).filter(function(a){return(a=c.getActionDescription(a))&&a.name});d.sort(function(a,b){return c.getActionDescription(a).name.localeCompare(c.getActionDescription(b).name)});
a.createHeader(l.Editor);for(var e=function(a){return function(){c.focus();return c.invokeAction(a)}},b={},g,f=0;f<d.length;f++)for(var h=d[f],k=c.getActionDescription(h),n=c.getKeyBindings(h),m=0;m<n.length;m++){g=n[m];var s=A.getUserKeyString(g);g.scopeName?(b[g.scopeName]||(b[g.scopeName]=[]),b[g.scopeName].push({bindingString:s,name:k.name,execute:e(h)})):a.createItem(s,k.name,e(h))}for(var q in b)if(b[q].length){a.createHeader(q);for(d=0;d<b[q].length;d++)g=b[q][d],a.createItem(g.bindingString,
g.name,g.execute)}}},_createSettingsCommand:function(){var a=this,b=new k.Command({imageClass:"core-sprite-wrench",tooltip:l.LocalEditorSettings,id:"orion.edit.settings",visibleWhen:function(b,c){var d=c.handler.editor||a.editor;return d&&d.installed&&c.handler.localSettings},callback:function(c){var d=this.localSettings||a.localSettings,e=b.settingsDropDown;if(!e||e.isDestroyed())e=b.settingsDropDown=new f(c.domNode.parentNode,c.domNode,{noClick:!0,selectionClass:"dropdownSelection",onShow:function(){e.focus()},
onHide:function(){a.editor.focus()}}),e.updateContent=d.show.bind(d),c=e.getContentNode(),c.tabIndex=c.style.marginTop=0;e.click()}});this.commandService.addCommand(b)},_createUndoStackCommands:function(){var a=this,b=new k.Command({name:l.Undo,id:"orion.edit.undo",visibleWhen:function(b,c){var d=c.handler.editor||a.editor;return d&&d.installed},callback:function(){(this.editor||a.editor).getUndoStack().undo()}});this.commandService.addCommand(b);b=new k.Command({name:l.Redo,id:"orion.edit.redo",
visibleWhen:function(b,c){var d=c.handler.editor||a.editor;return d&&d.installed},callback:function(){(this.editor||a.editor).getUndoStack().redo()}});this.commandService.addCommand(b)},_createSearchFilesCommand:function(){var a=this,b=!1,c=new k.Command({name:l.searchFiles,tooltip:l.searchFiles,id:"orion.edit.searchFiles",visibleWhen:function(b,c){var d=c.handler.editor||a.editor,e=c.handler.searcher||a.searcher;return d&&d.installed&&e},callback:function(){var c=this.editor||a.editor;if(!b){var d=
c.getSelection(),d=c.getText(d.start,d.end),e=a.serviceRegistry.getService("orion.page.progress"),g=new h.OpenResourceDialog({searcher:a.searcher,progress:e,searchRenderer:a.searcher.defaultRenderer,nameSearch:!1,title:l.searchFiles,message:l.searchTerm,initialText:d,onHide:function(){b=!1;c.focus()}});window.setTimeout(function(){b=!0;g.show(p.node(a.toolbarId))},0)}}});this.commandService.addCommand(c)},_createSaveCommand:function(){var a=this,b=new k.Command({name:l.Save,tooltip:l.saveFile,imageClass:"core-sprite-save",
id:"orion.edit.save",visibleWhen:function(b,c){var d=c.handler.inputManager||a.inputManager,e=c.handler.editor||a.editor||d&&d.getEditor();return!e||!e.installed||!d||!d.isSaveEnabled()?!1:!0},callback:function(){(this.inputManager||a.inputManager).save()}});this.commandService.addCommand(b)},_createGotoLineCommnand:function(){var a=this,b=new g.ParametersDescription([new g.CommandParameter("line","number",l.gotoLinePrompt)],{hasOptionalParameters:!1},function(b){b=b.handler.editor||a.editor;b=b.getModel().getLineAtOffset(b.getCaretOffset())+
1;return[new g.CommandParameter("line","number",l.gotoLinePrompt,b.toString())]}),b=new k.Command({name:l.gotoLine,tooltip:l.gotoLineTooltip,id:"orion.edit.gotoLine",visibleWhen:function(b,c){var d=c.handler.editor||a.editor;return d&&d.installed},parameters:b,callback:function(b){var c=this.editor||a.editor,d=c.getModel();b.parameters&&b.parameters.valueFor("line")?b=b.parameters.valueFor("line"):(b=d.getLineAtOffset(c.getCaretOffset()),(b=prompt(l.gotoLinePrompt,b+1))&&(b=parseInt(b,10)));if(b)c.onGotoLine(b-
1,0)}});this.commandService.addCommand(b)},_createFindCommnand:function(){var a=this,b=new g.ParametersDescription([new g.CommandParameter("find","text","Find:")],{clientCollect:!0},function(b){var c=b.handler.editor||a.editor;b=b.handler.textSearcher||a.textSearcher;var d=c.getSelection(),e="";d.end>d.start&&(e=c.getModel().getText(d.start,d.end),b&&b.getOptions().regex&&(e=v.escape(e)));return[new g.CommandParameter("find","text","Find:",e)]}),d=new k.Command({name:l.Find,tooltip:l.Find,id:"orion.edit.find",
...
c=m[b];delete k[b];delete m[b];this.removedService(a,c)}this.serviceRegistry=h;var k={},m={},g=r,a,l;this.close=function(){if(g!==p)throw"Already closed";g=r;h.removeEventListener("registered",a);h.removeEventListener("unregistering",l);l=a=null;var d=this;this.getServiceReferences().forEach(function(a){b.call(d,a)});if("function"===typeof this.onClose)this.onClose()};this.getServiceReferences=function(){var a=Object.keys(k);return!a.length?null:a.map(function(a){return k[a]})};this.open=function(){if(g!==
...
f=0;f<e.length;f++){var c=b.enclosurePatterns[e[f]],h=this._findMatch(c.regex,a,0);if(h&&0===h.index){d=c;break}}if(!d)return null;f=!1;-1!==d.pattern.name.indexOf(this._PUNCTUATION_SECTION_BEGIN)?(f=!0,e=d.pattern.name.replace(this._PUNCTUATION_SECTION_BEGIN,this._PUNCTUATION_SECTION_END)):e=d.pattern.name.replace(this._PUNCTUATION_SECTION_END,this._PUNCTUATION_SECTION_BEGIN);return!b.enclosurePatterns[e]?null:{beginName:d.pattern.name,endName:e,atStart:f}},getContentType:function(){return this._contentType},
parse:function(b,a,d,e,f,c){if(b&&(e=e.linePatterns)){var h=[],k;e.forEach(function(a){var c=a.regex||a.regexBegin;c.oldLastIndex=c.lastIndex;(k=this._findMatch(c,b,d))&&h.push({result:k,pattern:a})}.bind(this));h.sort(function(a,b){return a.result.index<b.result.index?-1:a.result.index>b.result.index?1:a.pattern.pattern.index<b.pattern.pattern.index?-1:1});for(var m=d;0<h.length;){var l=h[0];h.splice(0,1);if(!(l.result.index<m)){var p=l.result.index,r,m=[];if(l.pattern.regex){k=l.result;r=p+k[0].length;
r={start:a+p,end:a+r,style:l.pattern.pattern.name};if(!c){l.pattern.pattern.captures&&this._getCaptureStyles(k,l.pattern.pattern.captures,a+p,m);m.sort(function(a,b){return a.start<b.start?-1:a.start>b.start?1:0});for(p=0;p<m.length-1;p++)if(m[p+1].start<m[p].end){var y={start:m[p+1].end,end:m[p].end,style:m[p].style};m[p].end=m[p+1].start;m.splice(p+2,0,y)}}this._mergeStyles(r,m,f)}else m=l.pattern.regexEnd,m=this._substituteCaptureValues(m,l.result),k=this._findMatch(m,b,l.result.index+l.result[0].length),
k||(this._eolRegex.lastIndex=0,k=this._eolRegex.exec(b)),r=k.index+k[0].length,f.push({start:a+p,end:a+r,style:l.pattern.pattern.name});m=k.index+k[0].length}this._updateMatch(l,b,h,m)}e.forEach(function(a){a=a.regex||a.regexBegin;a.lastIndex=a.oldLastIndex})}},setStyler:function(b){},verifyBlock:function(b,a,d,e){var f=null,c=[],h;d.parent.blockPatterns.forEach(function(b){(h=this._findMatch(b.regexBegin||b.regex,a,0))&&c.push({result:h,pattern:b})}.bind(this));c.sort(function(a,b){return!a.result.index&&
b.result.index?-1:a.result.index&&!b.result.index?1:!a.result.index&&!b.result.index?a.pattern.pattern.index<b.pattern.pattern.index?-1:1:0});if(!c.length||0!==c[0].result.index||c[0].pattern.pattern.id!==d.pattern.pattern.id)f=!1;else{h=c[0];var k=h.pattern.regexEnd;if(k){for(var k=this._substituteCaptureValues(k,h.result),m=h.result[0].length,l=this._findMatch(k,a,m);null===f&&l&&d.start+l.index!==d.contentEnd+e;){var p=this.computeBlocks(b,a,d,d.start,m,l.index+1,null);!p.length||p[p.length-1].end<=
d.start+l.index?f=!1:p.length?(m=p[p.length-1].end-d.start,l=this._findMatch(k,a,m)):l=null}l||(this._eolRegex.lastIndex=0,l=this._eolRegex.exec(a),f=d.start+l.index===d.end+e)}else f=d.start+h.result[0].length===d.end+e}return null!==f?f:!0},_findMatch:function(b,a,d,e){var f=d,c=b.lastIndex;this._linebreakRegex.lastIndex=d;d=this._linebreakRegex.exec(a);var h,k;b.lastIndex=0;if(d){for(k=d.index;0<=--k&&!(h=a.charAt(k),h===this._NEWLINE||h===this._CR););h=a.substring(k+1,d.index+d[1].length);b.lastIndex=
k=d.index-k-1}for(;d&&d.index<a.length;){var m;if(e){var l=b.lastIndex;b.test(h)&&(b.lastIndex=l,m=b.exec(h))}else m=b.exec(h);if(m)return m.index+=f,m.index-=k,b.lastIndex=c,m;k=0;f+=d[0].length;if(d=this._linebreakRegex.exec(a))h=d[1],b.lastIndex=0}b.lastIndex=c;return null},_getCaptureStyles:function(b,a,d,e){if(a[0])e.push({start:d,end:d+b[0].length,style:a[0].name});else for(var f=0,c=1;c<b.length;c++)if(b[c]){var h=a[c];if(h){var k=d+f;e.push({start:k,end:k+b[c].length,style:h.name})}f+=b[c].length}},
...
b.end;if(b.start<=f&&e<=b.end&&this._annotationModel){var c=l.AnnotationType.ANNOTATION_TASK;if(b.name&&0===b.name.indexOf("comment")){var h=[],k=a.getLineAtOffset(b.contentStart),k=a.getLineStart(k);this._stylerAdapter.parse(a.getText(k,b.end),k,b.contentStart-k,b,h,!0);for(k=0;k<h.length;k++)"meta.annotation.task.todo"===h[k].style&&(e<=h[k].start&&h[k].end<=f)&&d.push(l.AnnotationType.createAnnotation(c,h[k].start,h[k].end,a.getText(h[k].start,h[k].end)))}b.getBlocks().forEach(function(b){this._computeTasks(b,
a,d,e,f)}.bind(this))}},_createFoldingAnnotation:function(b,a,d,e){var f=a.getLineAtOffset(d),c=a.getLineAtOffset(e);return f===c||f+1===c&&a.getLineStart(c)===a.getLineEnd(c)?null:new (l.AnnotationType.getType(l.AnnotationType.ANNOTATION_FOLDING))(d,e,b)},_findBlock:function(b,a){var d=b.getBlocks();if(!d.length)return b;var e=m(d,a,!0);return e<d.length&&d[e].start<=a&&a<d[e].end?this._findBlock(d[e],a):b},_findBrackets:function(b,a,d,e,f,c){for(var h=[],k=[],l=f,p=d.getBlocks(),r=m(p,f,!0);r<p.length&&
!(p[r].start>=c);r++){var z=p[r].start,y=p[r].end;if(l<z){var B=b.getLineAtOffset(l),B=b.getLineStart(B);this._stylerAdapter.parse(e.substring(B-f,z-f),B,l-B,d,k);k.forEach(function(b){b.style&&(0===b.style.indexOf(a.beginName)?h.push(b.start+1):0===b.style.indexOf(a.endName)&&h.push(-(b.start+1)))});k=[]}l=y}l<c&&(B=b.getLineAtOffset(l),B=b.getLineStart(B),this._stylerAdapter.parse(e.substring(B-f,c-f),B,l-B,d,k),k.forEach(function(b){b.style&&(0===b.style.indexOf(a.beginName)?h.push(b.start+1):
0===b.style.indexOf(a.endName)&&h.push(-(b.start+1)))}));return h},_findMatchingBracket:function(b,a,d){var e=b.getLineAtOffset(d),f=b.getLineEnd(e),c=b.getText(d,f),c=this._stylerAdapter.getBracketMatch(a,c);if(!c)return-1;for(var h=b.getLine(e),k=b.getLineStart(e),f=this._findBrackets(b,c,a,h,k,f),m=0;m<f.length;m++)if(h=0<=f[m]?1:-1,f[m]*h-1===d){d=1;if(c.atStart){for(m++;m<f.length;m++)if(h=0<=f[m]?1:-1,d+=h,0===d)return f[m]*h-1;e+=1;for(m=b.getLineCount();e<m;){h=b.getLine(e);k=b.getLineStart(e);
f=b.getLineEnd(e);f=this._findBrackets(b,c,a,h,k,f);for(k=0;k<f.length;k++)if(h=0<=f[k]?1:-1,d+=h,0===d)return f[k]*h-1;e++}}else{for(m--;0<=m;m--)if(h=0<=f[m]?1:-1,d+=h,0===d)return f[m]*h-1;for(e-=1;0<=e;){h=b.getLine(e);k=b.getLineStart(e);f=b.getLineEnd(e);f=this._findBrackets(b,c,a,h,k,f);for(m=f.length-1;0<=m;m--)if(h=0<=f[m]?1:-1,d+=h,0===d)return f[m]*h-1;e--}}break}return-1},_getLineStyle:function(b){if(this._highlightCaretLine){var a=this._view,d=a.getModel(),e=!1;if(!a.getSelections().some(function(a){return a.start===
a.end?(e=e||d.getLineAtOffset(a.start)===b,!1):!0})&&e)return this._caretLineStyle}return null},_getStyles:function(b,a,d,e,f){var c=e+d.length,h=[],k=e+f;f=b.getBlocks();for(var l=m(f,k,!0);l<f.length&&!(f[l].start>=c);l++){var p=f[l].start,r=f[l].end;if(k<p){var z=a.getLineAtOffset(k),z=a.getLineStart(z);this._stylerAdapter.parse(d.substring(z-e,p-e),z,k-z,b,h)}var y=Math.max(k,p);y===p&&(p=this._stylerAdapter.getBlockStartStyle(f[l],d.substring(y-e),y,h))&&(y+=p.length);var p=Math.min(c,r),B=[];
p===r&&(k=d.substring(p-k-(f[l].end-f[l].contentEnd)),(k=this._stylerAdapter.getBlockEndStyle(f[l],k,p,B))&&(p-=k.length));var z=a.getLineAtOffset(y),z=a.getLineStart(z),k=this._getStyles(f[l],a,d.substring(z-e,p-e),z,y-z),C=this._stylerAdapter.getBlockContentStyleName(f[l]);if(C){var q=y;k.forEach(function(a){a.start-q&&h.push({start:q,end:a.start,style:C});a.mergeable&&(a.style+=","+C);h.push(a);q=a.end});p-q&&h.push({start:q,end:p,style:C})}else h=h.concat(k);h=h.concat(B);k=r}k<c&&(z=a.getLineAtOffset(k),
z=a.getLineStart(z),this._stylerAdapter.parse(d.substring(z-e,c-e),z,k-z,b,h));return h},_isRenderingWhitespace:function(){return this._whitespacesVisible},_onDestroy:function(){this.destroy()},_onLineStyle:function(b){b.textView===this._view&&(b.style=this._getLineStyle(b.lineIndex));var a=b.lineStart,d=b.textView.getModel();if(d.getBaseModel)var a=d.mapOffset(a),e=d.getBaseModel();b.ranges=this._getStyles(this._rootBlock,e||d,b.lineText,a,0);for(a=b.ranges.length-1;0<=a;a--){var f=b.ranges[a];if(f.style){if(f.style=
{styleClass:f.style.replace(/\./g," ")},e){var c=f.end-f.start;f.start=d.mapOffset(f.start,!0);f.end=f.start+c}}else b.ranges.splice(a,1)}this._isRenderingWhitespace()&&(this._spliceStyles(this._spacePattern,b.ranges,b.lineText,b.lineStart),this._spliceStyles(this._tabPattern,b.ranges,b.lineText,b.lineStart))},_onModelChanged:function(b){var a=b.start,d=b.removedCharCount;b=b.addedCharCount-d;var e=this._view.getModel(),f=e.getBaseModel?e.getBaseModel():e,d=a+d,c=f.getCharCount(),h=f.getLineStart(f.getLineAtOffset(a)),
k=this._findBlock(this._rootBlock,a),p,r,y,z,D,B,C;do{y=k.parent;if(!p&&y){if(0>b&&k.end-a<=-b){k=y;continue}D=f.getText(k.start,Math.min(c,k.end+b+1));if(!this._stylerAdapter.verifyBlock(f,D,k,b)){k=y;continue}}r=k.getBlocks();var q=r.length,w=m(r,h,!0),x=m(r,d,!1,w-1,q);p=!1;if(w&&r.length&&r[w-1].end===a){D=f.getText(r[w-1].start,Math.min(c,a+1));var E=this.computeBlocks(f,D,k,r[w-1].start,null,null,null);E.length&&E[0].end!==r[w-1].end&&(w--,p=!0)}w<q&&r[w].start<=h&&(h<r[w].end||p)?(C=r[w].start,
C>a&&(C+=b)):w===q&&0<q&&k.end-b===r[q-1].end?(C=r[--w].start,C>a&&(C+=b)):C=Math.max(h,k.contentStart);B=x<q?r[x].end:k.contentEnd;a<=B&&(B+=b);B=Math.min(B,c-1);D=f.getText(C,B+1);E=this.computeBlocks(f,D,k,C,null,null,null);if(x<q){if(E.length&&E[E.length-1].end===B&&E[E.length-1].typeId===r[x].typeId)break;if(E.length&&this._stylerAdapter.blockSpansBeyondEnd(E[E.length-1])){x++;for(var J=E[E.length-1].getBlocks(),J=(J.length?J[J.length-1]:E[E.length-1]).typeId;x<q;){if(r[x].typeId===J){var M=
r[x].end+b,M=Math.min(M,c-1);D=f.getText(C,M+1);D=this.computeBlocks(f,D,k,C,null,null,null);if(D.length&&D[D.length-1].end===M){B=M;E=D;break}}x++}if(x<q)break}}else if(!E.length||E[E.length-1].end<=k.contentEnd+b)break;if(!y){B=c;x=q;D=f.getText(C,B);E=this.computeBlocks(f,D,k,C,null,null,null);break}k=y;z=!0}while(1);this._rootBlock.adjustBounds(a,b);x=Math.min(x+1,q);z||(z=x-w!==E.length);if(!z)for(q=0;q<E.length;q++)if(p=r[w+q],c=E[q],p.start!==c.start||p.end!==c.end||p.typeId!==c.typeId){z=
!0;break}!r.length&&!E.length?(p=[k],this.dispatchEvent({type:"BlocksChanged",oldBlocks:[k],newBlocks:p}),k=p[0]):this.dispatchEvent({type:"BlocksChanged",oldBlocks:r.slice(w,x),newBlocks:E});w=[w,x-w].concat(E);Array.prototype.splice.apply(r,w);z&&(r=C,z=B,e!==f&&(r=e.mapOffset(r,!0),z=e.mapOffset(z,!0)),this._view.redrawRange(r,z));if(this._annotationModel){var G=[],I=[],H=[];r=this._annotationModel.getAnnotations(C,B);z=this._foldingEnabled&&f!==e;for(w=k.parent||k;r.hasNext();)if(x=r.next(),z&&
x.type===l.AnnotationType.ANNOTATION_FOLDING){H.push(x);for(p=this._findBlock(w,x.start);p;){var P=this._stylerAdapter.getBlockFoldBounds(p,f);if(x.start===P.start&&x.end===P.end)break;p=p.parent}p&&x.start===P.start&&x.end===P.end?(E=x.start,p=x.end,E>a&&(E-=b),p>a&&(p-=b),E<=a&&(a<p&&E<=d&&d<p)&&(E=f.getLineAtOffset(x.start),p=f.getLineAtOffset(x.end),E!==p?x.expanded||x.expand():G.push(x))):(G.push(x),x.expand())}else x.type===l.AnnotationType.ANNOTATION_TASK&&k.start<=x.start&&x.end<=k.end&&G.push(x);
z&&w.getBlocks().forEach(function(a){this._updateFolding(a,f,e,H,I,C,B)}.bind(this));this._detectTasks&&this._computeTasks(k,f,I,C,B);this._annotationProviders.forEach(function(a){var b=[],c=[];a(this._annotationModel,f,k,C,B,b,c);G=G.concat(b);I=I.concat(c)}.bind(this));this._annotationModel.replaceAnnotations(G,I)}},_onMouseDown:function(b){if(2===b.clickCount){var a=this._view.getModel(),d=this._view.getOffsetAtLocation(b.x,b.y);if(0<d){var e=d-1,f=a;a.getBaseModel&&(e=a.mapOffset(e),f=a.getBaseModel());
...
m,m+1)]);this._bracketAnnotations=k;this._annotationModel.replaceAnnotations(a,k)}},_spliceStyles:function(b,a,d,e){for(var f=b.regex,c=f.lastIndex=0,h=f.exec(d);h;){for(h=e+h.index;c<a.length&&!(h<a[c].end);)c++;var k={start:h,end:h+1,style:JSON.parse(JSON.stringify(b.style))};if(c<a.length&&a[c].start<=h){var m={start:h+1,end:a[c].end,style:a[c].style};a[c].end=h;a.splice(c+1,0,m);a.splice(c+1,0,k);c+=2;k.style.styleClass+=" "+a[c].style.styleClass}else a.splice(c,0,k),c++;h=f.exec(d)}},_updateFolding:function(b,
a,d,e,f,c,h){c=c||b.start;h=h||b.end;var k=this._stylerAdapter.getBlockFoldBounds(b,a);if(!b.doNotFold&&k.start<=h&&c<=k.end){var l=m(e,k.start,!0);l<e.length&&e[l].start===k.start&&e[l].end===k.end||(k=this._createFoldingAnnotation(d,a,k.start,k.end))&&f.push(k);b.getBlocks().forEach(function(b){this._updateFolding(b,a,d,e,f,c,h)}.bind(this))}},_caretLineStyle:{styleClass:"meta annotation currentLine"},_spacePattern:{regex:/[ ]/g,style:{styleClass:"punctuation separator space",unmergeable:!0}},_tabPattern:{regex:/\t/g,
style:{styleClass:"punctuation separator tab",unmergeable:!0}}};r.EventTarget.addMixin(k.prototype);return{TextStyler:k,Block:d,createPatternBasedAdapter:function(b,a,d){return new h(b,a,d)}}});y("orion/editor/textMateStyler",["orion/regex"],function(l){function r(f){var d;if(f instanceof Array){d=Array(f.length);for(var b=0;b<f.length;b++)d[b]=r(f[b])}else for(b in d={},f)if(Object.prototype.hasOwnProperty.call(f,b)){var h=f[b];d[b]="object"===typeof h&&null!==h?r(h):h}return d}function p(f,d,b){this.initialize(f);
...
d(this.unsupported[k].func(m),m)}return RegExp(f,b)},processGlobalFlag:function(f,d,b){var h="(?"+f+")";f="(?"+f+":";if(d.substring(0,h.length)===h)return b(d.substring(h.length));if(d.substring(0,f.length)===f){for(var h=0,m=d.length,g=-1,a=0;a<m&&-1===g;a++)switch(d.charAt(a)){case "\\":a++;break;case "(":h++;break;case ")":h--,0===h&&(g=a)}h=g;if(h<d.length-1)throw Error("Only a "+f+") group that encloses the entire regex is supported in: "+d);return b(d.substring(f.length,h))}return d},hasBackReference:function(f){return/\\\d+/.test(f.source)},
getSubstitutedRegex:function(f,d,b){b="undefined"===typeof b?!0:!1;f=f.source.split(/(\\\d+)/g);for(var h=[],m=0;m<f.length;m++){var g=f[m],a=/\\(\d+)/.exec(g);a?(g=d[a[1]]||"",h.push(b?l.escape(g):g)):h.push(g)}return RegExp(h.join(""))},groupify:function(f,d){for(var b=f.source,h=b.length,m=[],g=0,a=[],l=1,e=1,n=[],c={},p={},r=0;r<h;r++){var v=m[m.length-1],A=b.charAt(r);switch(A){case "(":4===v&&(m.pop(),n.push(")"),a[a.length-1].end=r);var y=r+2<h?b.charAt(r+1)+""+b.charAt(r+2):null;if("?:"===
y||"?\x3d"===y||"?!"===y){var z;"?:"===y?z=1:(z=3,g++);m.push(z);a.push({start:r,end:-1,type:z});n.push(A);n.push(y);r+=y.length}else m.push(2),a.push({start:r,end:-1,type:2,oldNum:l,num:e}),n.push(A),0===g&&(p[e]=null),c[l]=e,l++,e++;break;case ")":v=m.pop();3===v&&g--;a[a.length-1].end=r;n.push(A);break;case "*":case "+":case "?":case "}":var D=A,B=b.charAt(r-1),y=r-1;if("}"===A){for(z=r-1;"{"!==b.charAt(z)&&0<=z;z--);B=b.charAt(z-1);y=z-1;D=b.substring(z,r+1)}z=a[a.length-1];if(")"===B&&(2===z.type||
4===z.type)){n.splice(z.start,0,"(");n.push(D);n.push(")");A={start:z.start,end:n.length-1,type:4,num:z.num};for(B=0;B<a.length;B++)if(v=a[B],(2===v.type||4===v.type)&&v.start>=z.start&&v.end<=y)v.start+=1,v.end+=1,v.num+=1,2===v.type&&(c[v.oldNum]=v.num);a.push(A);e++;break}default:"|"!==A&&(2!==v&&4!==v)&&0===g&&(m.push(4),a.push({start:r,end:-1,type:4,num:e}),n.push("("),p[e]=null,e++),n.push(A),"\\"===A&&(A=b.charAt(r+1),n.push(A),r+=1)}}for(;m.length;)m.pop(),n.push(")");b=RegExp(n.join(""));
...
d.rule.applyEndPatternLast,-1===l||b.index<a||!h&&b.index===a)return{isEnd:!0,rule:d.rule,match:b};return-1===l?null:{isSub:!0,rule:m[l],match:f[l]}},getInitialExpected:function(f,d){var b,h;if(f===this._tree)for(b=0;b<f.children.length;b++){if(h=f.children[b],h.start>=d)return h}else if(f instanceof this.BeginEndNode&&f.endMatch){var m=f.endMatch.index;for(b=0;b<f.children.length&&!(h=f.children[b],h.start>=d);b++);if(h&&h.start<m)return h}return f},getNextExpected:function(f,d){if("begin"===d){var b=
f.children[0];return b?b:f}if("end"===d&&(b=f.parent)){var h=b.children[b.children.indexOf(f)+1];return h?h:b}return null},prune:function(f,d){d.parent===f?f.children.length=d.getIndexInParent():f instanceof this.BeginEndNode&&(f.endMatch=null,f.end=null);f.parent&&(f.parent.children.length=f.getIndexInParent()+1)},onLineStyle:function(f){this._tree||this.initialParse();var d=f.lineStart,b=this.textView.getModel(),h=b.getLineEnd(f.lineIndex),m=b.getLineEnd(b.getLineAtOffset(d)-1),m=this.getFirstDamaged(m,
m),d=this.getLineScope(b,m,d,h);f.ranges=this.toStyleRanges(d);f.ranges.sort(function(b,a){return b.start-a.start})},getLineScope:function(f,d,b,h){for(var m=b,g=this.getInitialExpected(d,b),a=[],l=[];d&&m<h;){var e=this.getNextMatch(f,d,m);if(!e)break;var n=e&&e.match,c=e&&e.rule,p=e&&e.isSub,e=e&&e.isEnd;n.index!==m&&l.push({start:m,end:n.index,node:d});p?(m=this.afterMatch(n),c instanceof this.BeginEndRule?(this.addBeginScope(a,n,c),d=g,g=this.getNextExpected(g,"begin")):this.addMatchScope(a,n,
c)):e&&(m=this.afterMatch(n),this.addEndScope(a,n,c),g=this.getNextExpected(g,"end"),d=d.parent)}m<h&&l.push({start:m,end:h,node:d});f=this.getInheritedLineScope(l,b,h);return a.concat(f)},getInheritedLineScope:function(f,d,b){d=[];for(b=0;b<f.length;b++)for(var h=f[b],m=h.node;m;){var g=m.rule.rule,a=g.name;if(g=g.contentName||a){this.addScopeRange(d,h.start,h.end,g);break}m=m.parent}return d},addBeginScope:function(f,d,b){var h=b.rule;this.addCapturesScope(f,d,h.beginCaptures||h.captures,b.isComplex,
b.beginOld2New,b.beginConsuming)},addEndScope:function(f,d,b){var h=b.rule;this.addCapturesScope(f,d,h.endCaptures||h.captures,b.isComplex,b.endOld2New,b.endConsuming)},addMatchScope:function(f,d,b){var h=b.rule,m=h.name;(h=h.captures)?this.addCapturesScope(f,d,h,b.isComplex,b.matchOld2New,b.matchConsuming):this.addScope(f,d,m)},addScope:function(f,d,b){b&&f.push({start:d.index,end:this.afterMatch(d),scope:b})},addScopeRange:function(f,d,b,h){h&&f.push({start:d,end:b,scope:h})},addCapturesScope:function(f,
d,b,h,m,g){if(b)if(h){h={1:0};for(var a=0,l=1;void 0!==d[l];l++)void 0!==g[l]&&(a+=d[l].length),void 0!==d[l+1]&&(h[l+1]=a);g=d.index;for(a=1;b[a];a++){var l=b[a].name,e=m[a],n=g+h[e];"undefined"!==typeof d[e]&&this.addScopeRange(f,n,n+d[e].length,l)}}else this.addScope(f,d,b[0]&&b[0].name)},getIntersecting:function(f,d){for(var b=[],h=this._tree?[this._tree]:[];h.length;){var m=h.pop(),g=!1;m instanceof this.ContainerNode?g=!0:this.isDamaged(m,f,d)&&(g=!0,b.push(m));if(g)for(var g=m.children.length,
a=0;a<g;a++)h.push(m.children[a])}return b.reverse()},toStyleRanges:function(f){for(var d=[],b=0;b<f.length;b++){var h=f[b],m=this._styles[h.scope];if(!m)throw Error("styles not found for "+h.scope);m=m.join(" ");d.push({start:h.start,end:h.end,style:{styleClass:m}})}return d}};return{RegexUtil:h,TextMateStyler:p}});y("orion/editor/AsyncStyler",["i18n!orion/editor/nls/messages","orion/editor/annotations"],function(l,r){function p(b){return-1!==b.getProperty("objectClass").indexOf(f)&&"highlighter"===
...
p,a.editContextServiceID))});c.setEditorContextProvider(g);c.setProviders(d);c.setAutoTriggerEnabled(a.settings.contentAssistAutoTrigger);c.setProgress(z);c.setStyleAccessor(a.getStyleAccessor())},I=this.readonly?null:{createContentAssistMode:function(a){var b=new m.ContentAssist(a.getTextView(),p);b.addEventListener("Activating",H.bind(null,a,b));var c=new m.ContentAssistWidget(b,"contentassist"),c=new m.ContentAssistMode(b,c);b.setMode(c);H(a,b);b.initialize();return c}},G=this.editor=new r.Editor({textViewFactory:function(){var b=
...
domNode:this._parent});G.id="orion.editor";G.processParameters=function(a){for(var b=["start","end","line","offset","length"],c=0;c<b.length;c++){var d=b[c];a[d]&&(a[d]=parseInt(a[d],10))}return this.showSelection(a.start,a.end,a.line,a.offset,a.length)};G.getEditorContext=function(){return F.getEditorContext(p,a.editContextServiceID)};this.dispatcher=new N(this.serviceRegistry,this.contentTypeRegistry,G,y);this.themePreferences&&this.editorPreferences&&(this.localSettings=c?new c({local:!0,editor:G,
